...
DEVICE_LINK = """
<a href="{% url 'plugins:netbox_portmanager:device' pk=table.device_group_pk pk2=record.pk %}">
    {{ record.name|default:'<span class="badge bg-info">Unnamed device</span>' }}
</a>
"""
...
<div class="btn btn-warning btn-sm"> 
  <a href="{% url 'plugins:netbox_portmanager:interface_mac' pk=table.device_group.pk pk2=table.device.pk pk3=record.if_index pk4=record.if_vlan %}">
    show MACs
  </a> 
</div>
{% endif %}
