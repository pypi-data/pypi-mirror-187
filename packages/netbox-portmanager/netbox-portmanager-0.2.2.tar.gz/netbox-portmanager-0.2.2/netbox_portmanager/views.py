...
class InterfaceVlanMacView(View):
    ...
    template = "netbox-portmanager/mac.html"
...
class DeviceView(generic.ObjectView):
    queryset = Device.objects.all()
    queryset_device_group = DeviceGroup.objects.all()
    template_name = "netbox-portmanager/device.html"
    ...
    def post(self, request, pk, pk2, **kwargs):
        ...
        try:
            ...
            return redirect("plugins:netbox_portmanager:device", pk=pk, pk2=pk2)
...
class DeviceGroupView(generic.ObjectView):
    queryset = DeviceGroup.objects.all()
    template_name = 'netbox-portmanager/devicegroup.html'
...
class ChangeLogView(generic.ObjectView):
    queryset = ChangeLog.objects.all()
    template_name = "netbox-portmanager/changelog/changelog.html"
