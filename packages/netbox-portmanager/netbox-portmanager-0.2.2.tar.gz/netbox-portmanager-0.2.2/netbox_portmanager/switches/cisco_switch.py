...
from netbox_portmanager.switches.general_switch import GeneralSwitch
from netbox_portmanager.switches.interface import Interface
from netbox_portmanager.switches.vlan import Vlan
from netbox_portmanager.switches.utils import *
