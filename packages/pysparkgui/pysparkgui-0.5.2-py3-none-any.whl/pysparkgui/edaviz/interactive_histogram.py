...
from pysparkgui.edaviz.base import AsyncEmbeddable, css_spinner
from pysparkgui.helper import notification
from pysparkgui.widgets import CopyButton, Button
...
class InteractiveHistogram(AsyncEmbeddable):
    ...
    def _init_gui(self):
        ...
        self.min_value_input.add_class("pysparkgui-input")
        self.min_value_input.add_class("pysparkgui-float-text")
        self.min_value_input.add_class("pysparkgui-input-md")
        ...
        self.max_value_input.add_class("pysparkgui-input")
        self.max_value_input.add_class("pysparkgui-float-text")
        self.max_value_input.add_class("pysparkgui-input-md")
        ...
        self.bin_width_input.add_class("pysparkgui-input")
        self.bin_width_input.add_class("pysparkgui-float-text")
        self.bin_width_input.add_class("pysparkgui-input-md")
        ...
        self.bin_width_slider.add_class("pysparkgui-input-md")
        self.bin_width_slider.add_class("pysparkgui-hide-label")
        ...
        ).add_class("pysparkgui-interactive-histogram-top-buttons-group")
