...
from pysparkgui.helper import DF_OLD, PysparkguiError
...
class TempColumnsSelector(widgets.VBox):
    ...
    def __init__(
        ...
        self.show_first_and_last = show_first_and_last
        ...
        self.set_selection(selection, self.df)
    ...
    def _set_special_selector(
        ...
        self._main_selector = Singleselect(
            ...
            width=self.width,
            on_change=self._selection_changed,
            css_classes=["pysparkgui-columns-selector-special"] + css_classes,
        )
    ...
    def set_selection(self, selection, df):
        self.df = df
        self._setup_options()
