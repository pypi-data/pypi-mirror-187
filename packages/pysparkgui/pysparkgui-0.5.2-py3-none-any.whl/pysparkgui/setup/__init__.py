...
def test_setup():
    """
    Function to test the setup of pysparkgui.

    The output contains widgets that need to work for pysparkgui to work as a whole.
    ...
    from pysparkgui.widgets import Multiselect
    ...
    display(Multiselect(placeholder="pysparkgui widget works"))
