...
ERROR_LOG_FILE = pysparkgui_LIBRARY_CONFIG_PATH / "ERROR_LOGS"

file_logger = logging.getLogger("pysparkgui.file_logger")
...
def print_log_contents():
    ...
    If this does not work, then we can use a workaround which does not import pysparkgui:
    >>> from pathlib import Path
    >>> ERROR_LOG_FILE = Path.home() / ".pysparkgui" / "ERROR_LOGS"
