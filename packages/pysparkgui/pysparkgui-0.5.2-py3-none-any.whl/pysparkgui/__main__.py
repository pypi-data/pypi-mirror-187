...
"""Holds the logic for installing pysparkgui's lab-/nbextensions."""


from pysparkgui.setup._extensions import (
    install_extensions,
...
USAGE = """Usage: python -m pysparkgui COMMAND
Command options:
...
if __name__ == "__main__":
    ...
    # python -m pysparkgui install_extensions => sys.argv = ['path/to/pysparkgui/__main__.py', 'install_extensions']
