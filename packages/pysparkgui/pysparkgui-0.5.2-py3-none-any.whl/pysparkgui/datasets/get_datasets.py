...
titanic_csv = pysparkgui_LIBRARY_ROOT_PATH / "datasets" / "titanic.csv"
# the name 'sales_csv' is also exported to the user, thus it is not CAPITAL like a constant
sales_csv = pysparkgui_LIBRARY_ROOT_PATH / "datasets" / "sales.csv"
...
# We use this function to show that pysparkgui also works on 1 mio rows datasets
