...
from pysparkgui.helper import Transformation, DF_OLD
...
class OneHotEncoderTransformation(Transformation):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.drop_first_dummy_checkbox.add_class("pysparkgui-checkbox")

        self.create_na_dummy_checkbox = widgets.Checkbox(
            value=False, description="Create dummy for missing values"
        )
        self.create_na_dummy_checkbox.add_class("pysparkgui-checkbox")
