...
from pysparkgui.helper import Transformation, notification, DF_OLD, DF_NEW
from pysparkgui._path import pysparkgui_LIBRARY_ROOT_PATH

from pysparkgui.transformations.base_components import SingleColumnSelector
...
class PivotTransformation(Transformation):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.explanation_image = widgets.Image(
            value=open(
                pysparkgui_LIBRARY_ROOT_PATH / "assets" / "img" / "long_to_wide.png",
                "rb",
            ).read(),
            format="png",
        )
        self.explanation_image.add_class("pysparkgui-hint-img")
