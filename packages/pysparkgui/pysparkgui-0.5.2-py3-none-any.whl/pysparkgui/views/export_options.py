...
from pysparkgui.helper import Viewable
from pysparkgui.widgets import Button

from pysparkgui.views.export_code import ExportCodeView
from pysparkgui.views.export_to_variable import ExportToVariableView
from pysparkgui.views.export_to_csv import (
...
class ExportOptionsView(Viewable):
    ...
    def render(self, column=None):
        ...
        self.buttons.append(
            self._make_button("Export to name ('variable') in the notebook", ExportToVariableView)
        )
