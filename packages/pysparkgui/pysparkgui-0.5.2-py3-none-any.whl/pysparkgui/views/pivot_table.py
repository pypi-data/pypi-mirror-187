...
class SingleChoiceKwargsItem(ConfigItem):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.hbox.add_class("pysparkgui-overflow-visible")
...
class PivotTable(TabViewable):
    ...
    def initialize_view(self):
        ...
        self.df = self.df_manager.get_latest_df()
        ...
        self.pivot_outlet.add_class("pysparkgui-pivot-html")
        ...
        self.config_outlet_for_search.add_class("pysparkgui-overflow-visible")

        self.config_outlet_for_items = widgets.VBox()
        self.config_outlet_for_items.add_class("pysparkgui-overflow-visible")
    ...
    def _pivot_table_returns_a_series(self, df_name, kwargs_code):
        ...
        symbols["pd"] = pd
        symbols[df_name] = self.df_manager.get_latest_df()
        ...
        def evaluate_and_update(render_id):
            if self._current_render_id == render_id:
                try:
                    ...
                    symbols[
                        self.df_manager.get_latest_df_name()
                    ] = self.df_manager.get_latest_df()
    ...
    def _df_columns_did_change(self):
        current_columns = list(self.df_manager.get_latest_df().columns)
