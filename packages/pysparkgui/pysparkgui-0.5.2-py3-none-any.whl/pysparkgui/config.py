...
from pysparkgui._path import pysparkgui_LIBRARY_CONFIG_PATH
...
USER_CONFIG_PATH = pysparkgui_LIBRARY_CONFIG_PATH / "config.toml"
...
# code_format: string  - either "assignment" or "chain"
...
#
# plugins
# hide_search_options: list of class names e.g. [ "GroupbyWithMultiselect", "SparkGroupbyWithRename",]
#
# enterprise
...
def set_option(key: str, value) -> None:
    ...
    :param key: string. The key of the option, like "global.show_pysparkgui_ui".
...
def is_in_confidential_mode():
    """
    Return True if pysparkgui is in confidential mode.
    """
    try:
