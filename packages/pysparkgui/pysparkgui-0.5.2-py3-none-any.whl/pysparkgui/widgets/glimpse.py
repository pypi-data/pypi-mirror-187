...
class GlimpseRow(widgets.Box):
    """
    This widget provides a single content row for the pysparkgui glimpse which
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.add_class("pysparkgui-glimpse-row")
...
class GlimpseHeader(widgets.Box):
    """
    This widget provides the header row for the pysparkgui glimpse that shows the names of the columns
    """
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.add_class("pysparkgui-glimpse-header")
