...
class BaseButton(widgets.Button):
    """
    The pysparkgui BaseButton that can trigger an on_click event and that can be passed css_classes.
    """
...
class Button(BaseButton):
    ...
    def __init__(
        ...
        if (icon != "") and (description == ""):
            self.add_class("pysparkgui-icon-button")
        ...
        if style is None:
            ...
            self.add_class("pysparkgui-button-primary")
        elif style == "secondary":
            self.add_class("pysparkgui-button-secondary")
        else:
