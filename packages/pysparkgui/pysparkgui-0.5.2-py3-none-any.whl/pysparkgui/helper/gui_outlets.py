...
from pysparkgui.widgets import TracebackOutput
...
class Window(widgets.VBox):
    ...
    def _create_view_header(self):
        ...
        header.add_class("pysparkgui-window-header")
        return header
    ...
    def show(self):
        ...
        """
        self.add_class("pysparkgui-active-window")
    ...
    def hide(self):
        ...
        e.g. see FullParentModal
        """
        self.remove_class("pysparkgui-active-window")
        self._is_visible = False
...
class LoaderModal(widgets.VBox):
    ...
    def __init__(self):
        ...
        self.add_class("pysparkgui-loader-modal")

    def show(self):
        """Show the modal"""
        self.add_class("pysparkgui-active-modal")
        self.add_class("pysparkgui-active-window")

    def hide(self):
        """Hide the modal"""
        self.remove_class("pysparkgui-active-modal")
        self.remove_class("pysparkgui-active-window")
...
class ErrorModal(Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_class("pysparkgui-full-modal")
...
class WindowWithLoaderAndErrorModal(Window):
    ...
    def show_error_modal(self, embeddable):
        ...
        """
        self.add_class("pysparkgui-min-height-for-error-modal")
    ...
    def hide_error_modal(self):
        ...
        self.remove_class("pysparkgui-min-height-for-error-modal")
...
def show_loader_and_maybe_error_modal(execute_function):
    ...
    def create_notification_from_PysparkguiError(exception):
        """
        Create a notification object based on an pysparkgui error
        """
    ...
    def safe_execution(self, *args, **kwargs):
        ...
        try:
            ...
            if env.SHOW_RAW_EXCEPTIONS:
                ...
                elif isinstance(exception, PysparkguiError):
                    output = create_notification_from_PysparkguiError(exception)
                else:
                    output = create_stacktrace(self, exception)
...
class SideWindow(WindowWithLoaderAndErrorModal):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.add_class("pysparkgui-side-window")

    def show(self):
        self.add_class("pysparkgui-active-side-window")
        super().show()

    def hide(self):
        self.remove_class("pysparkgui-active-side-window")
        super().hide()
...
class TabWindow(WindowWithLoaderAndErrorModal):
    ...
    def show_error_modal(self, embeddable):
        self.outlet.add_class("pysparkgui-min-height-for-error-modal")
        super().show_error_modal(embeddable)

    def hide_error_modal(self):
        self.outlet.remove_class("pysparkgui-min-height-for-error-modal")
