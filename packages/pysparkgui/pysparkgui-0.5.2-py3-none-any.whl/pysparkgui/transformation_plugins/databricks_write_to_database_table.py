...
from pysparkgui.plugins import TransformationPlugin, DF_OLD, Text, PysparkguiError
...
class DatabricksWriteToDatabaseTable(TransformationPlugin):
    ...
    def __init__(self, **kwargs):
        ...
        self.overwrite_existing_table.add_class("pysparkgui-checkbox")

        self.overwrite_schema = widgets.Checkbox(
            value=False, description=OVERWRITE_SCHEMA_LABEL
        )
        self.overwrite_schema.add_class("pysparkgui-checkbox")
    ...
    def get_code(self):
        ...
        return f"""{DF_OLD}.write{overwrite}{merge_schema}.saveAsTable("{database_prefix}{self.table.value}")"""
