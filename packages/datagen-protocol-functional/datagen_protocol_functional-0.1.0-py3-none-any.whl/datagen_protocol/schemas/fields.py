...
from datagen_protocol.schemas.core import d3 as core_3d_schema
...
def rotation(field_config) -> Field:
    return Field(
        default_factory=lambda: core_3d_schema.Rotation(
            yaw=field_config.yaw.default,
            pitch=field_config.pitch.default,
            roll=field_config.roll.default,
        )
    )
