...
from algora.common.function import transform_one_or_many, no_transform, data_required_transform
...
@async_data_request(transformers=[
    data_required_transform,
    lambda d: transform_one_or_many(d, 'chart')
])
