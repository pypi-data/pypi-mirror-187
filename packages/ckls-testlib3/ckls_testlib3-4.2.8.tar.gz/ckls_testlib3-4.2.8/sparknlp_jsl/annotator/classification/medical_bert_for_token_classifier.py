...
class MedicalBertForTokenClassifier(AnnotatorModelInternal,
    ...
    def pretrained(name="bert_token_classifier_ner_bionlp", lang="en", remote_loc="clinical/models"):
        ...
        Args:
            name (str): Name of the pretrained model, by default "bert_token_classifier_ner_bionlp".
            lang (str): Language of the pretrained model, by default "en".
            remote_loc (str): Optional remote address of the resource, by default "clinical/models". Will use Spark NLPs repositories otherwise.
