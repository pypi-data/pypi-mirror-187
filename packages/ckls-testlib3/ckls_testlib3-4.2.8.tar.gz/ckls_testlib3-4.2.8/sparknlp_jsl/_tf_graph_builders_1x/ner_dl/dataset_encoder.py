...
class DatasetEncoder:
    ...
    @staticmethod
    def normalize(word):
        """Transform word to lower case and remove additional white spaces.
    ...
    def get_char_indexes(self, word):
        """Get character indexes for a word.
        
        Args:
            word (str): Word.

        Returns:
            list: List of character indexes.
        """
        result = []
        for c in word:
    ...
    def encode(self, sentences, output=False):
        ...
        Args:
            ...
            output (bool): If it is the outpu layer.
