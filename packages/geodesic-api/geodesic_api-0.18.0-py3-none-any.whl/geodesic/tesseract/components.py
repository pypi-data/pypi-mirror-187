...
class OutputTimeBins(_APIObject):
    ...
    reference = _StringDescr(doc="references the asset from which this asset should use the time bins.")
...
class StepOutput(_APIObject):
    ...
    output_bands = _ListDescr(item_type=(OutputBand, dict, str), coerce_items=False, doc="band names or STAC "
                              "eo:band objects")
