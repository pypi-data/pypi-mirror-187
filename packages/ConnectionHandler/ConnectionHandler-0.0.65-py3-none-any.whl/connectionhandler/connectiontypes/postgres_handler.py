...
class Postgres_Handler:
    ...
    def update_record(self, **kwargs):
        try:
            ...
            #Begining of the SQL query
            query_string= sql.SQL("UPDATE {table_name} SET").format(table_name = sql.Identifier(kwargs[self.table_name_key]))
            ...
            results = self.__run_query(query_string, values_dict)
