...
class V1CloudSpace(object):
    ...
    swagger_types = {
        ...
        'code_config': 'V1LightingappInstanceCodeConfig',
        'created_at': 'datetime',
        'id': 'str',
    ...
    def __init__(self,
                 ...
                 code_config: 'V1LightingappInstanceCodeConfig' = None,
