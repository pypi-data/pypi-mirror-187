...
from taming_transformers_hugf.taming.data.image_transforms import convert_pil_to_tensor
from torch import LongTensor, Tensor

from taming_transformers_hugf.taming.data.helper_types import BoundingBox, Annotation
...
from taming_transformers_hugf.taming.data.conditional_builder.utils import COLOR_PALETTE, WHITE, GRAY_75, BLACK, additional_parameters_string, \
