...
from web_app_template.api.http_status_codes import UNAUTHORISED, UNEXPECTED_ERROR
from web_app_template.authentication.authentication import validate_authentication
