...
class InlineQueryHandler(Handler):
    ...
    :meth:`~Octra.Client.on_inline_query` decorator.
    ...
    Parameters:
        ...
        Flows (:obj:`Flows`):
            Pass one or more Flows to allow only a subset of inline queries to be passed
            in your callback function.

    Other parameters:
        client (:obj:`~Octra.Client`):
            The Client itself, useful when you want to call other Ai methods inside the inline query handler.

        inline_query (:obj:`~Octra.types.InlineQuery`):
