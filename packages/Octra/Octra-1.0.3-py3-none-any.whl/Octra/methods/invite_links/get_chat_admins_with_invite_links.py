...
class ExtractChatAdminsWithInviteLinks:
    async def Extract_chat_admins_with_invite_links(
        self: "Octra.Client",
        chat_id: Union[int, str],
    ):
        """Extract the list of the administrators that have exported invite links in a chat.
        ...
        Returns:
            List of :obj:`~Octra.types.ChatAdminWithInviteLink`: On success, the list of admins that have exported
