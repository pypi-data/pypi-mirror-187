    ...
    async def update_profile(
        ...
        Example:
            .. code-block:: python
                ...
                # t.me/TheVenomXD Update your first name only
                await app.update_profile(first_name="Octra")

                # t.me/TheVenomXD Update first name and bio
                await app.update_profile(first_name="Octra", bio="https://docs.Octra.org/")

                # t.me/TheVenomXD Remove the last name
