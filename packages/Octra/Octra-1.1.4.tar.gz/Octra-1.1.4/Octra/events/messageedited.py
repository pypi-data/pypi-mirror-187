...
class MessageEdited(NewMessage):
    ...
    <Octra.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <Octra.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <Octra.tl.custom.message.Message>`
