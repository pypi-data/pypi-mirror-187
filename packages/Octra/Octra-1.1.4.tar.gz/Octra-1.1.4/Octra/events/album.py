...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <Octra.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <Octra.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `Octra.client.messages.MessageMethods.send_message`
