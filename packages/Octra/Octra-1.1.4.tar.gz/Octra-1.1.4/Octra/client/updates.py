...
class UpdateMethods:
    ...
    def run_until_disconnected(self: 'TelegramClient'):
        ...
        <Octra.client.telegrambaseclient.TelegramBaseClient.disconnect>`
    ...
    def add_event_handler(
        ...
        Arguments
            callback (`callable`):
                ...
                Note that if you have used `Octra.events.register` in
            ...
            event (`_EventBuilder` | `type`, optional):
                ...
                If left unspecified, `Octra.events.raw.Raw` (the
    ...
    async def _update_loop(self: 'TelegramClient'):
        ...
        try:
            ...
            self._log[__name__].exception('Fatal error handling updates (this is a bug in Octra, please report it)')
