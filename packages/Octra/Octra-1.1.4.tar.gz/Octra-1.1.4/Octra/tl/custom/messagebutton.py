...
class MessageButton:
    ...
    .. note::
        ...
        <Octra.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `Octra.client.telegramclient.TelegramClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None):
        ...
        sent, and the sent `Message <Octra.tl.custom.message.Message>` returned.
