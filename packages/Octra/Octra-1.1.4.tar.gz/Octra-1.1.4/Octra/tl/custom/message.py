...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <Octra.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <Octra.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <Octra.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `TelegramClient <Octra.client.telegramclient.TelegramClient>`
    ...
    def forward(self):
        """
        The `Forward <Octra.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <Octra.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <Octra.tl.custom.file.File>` wrapping the
        ...
        `file.id <Octra.tl.custom.file.File.id>`,
        `file.name <Octra.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from Octra.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `Octra.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `Octra.client.messages.MessageMethods.forward_messages`
        ...
        `Octra.client.telegramclient.TelegramClient` instance directly.
        """
        if self._client:
    ...
    async def edit(self, *args, **kwargs):
        ...
        `Octra.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `Octra.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `Octra.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <Octra.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <Octra.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <Octra.tl.types.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        <Octra.client.messages.MessageMethods.send_read_acknowledge>`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `Octra.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `Octra.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
