...
class InlineBuilder:
    ...
    <Octra.events.inlinequery.InlineQuery>` ``results``.
    ...
    explained here to avoid repetition:
        ...
        buttons (`list`, `custom.Button <Octra.tl.custom.button.Button>`, :tl:`KeyboardButton`, optional):
    ...
    async def photo(
        ...
        Args:
            ...
            file (`obj`, optional):
                ...
                <Octra.client.uploads.UploadMethods.send_file>`.
