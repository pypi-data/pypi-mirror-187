...
def create(func: Callable, name: str = None, **kwargs) -> Flow:
    ...
    Parameters:
        func (``Callable``):
            ...
            For tests, in a :obj:`~Octra.handlers.MessageHandler` the *update* argument will be a :obj:`~Octra.types.Message`; in a :obj:`~Octra.handlers.CallbackQueryHandler` the *update* will be a :obj:`~Octra.types.CallbackQuery`.
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            testss: "start", ["start", "help", "settings"]. When a message text containing
        ...
        prefixes (``str`` | ``list``, *optional*):
            ...
            Defaults to "/" (slash). testss: ".", "!", ["/", "!", "."], list(".:!").
            Pass None or "" (empty string) to allow commands with no prefix at all.

        case_sensitive (``bool``, *optional*):
            Pass True if you want your command(s) to be case sensitive. Defaults to False.
            testss: when True, command="Start" would trigger /Start but not /start.
    """
