...
class SaveFile:
    async def save_file(
        ...
        .. note::
            ...
            :obj:`functions <Octra.api.functions>` (i.e: a Telegram API method you wish to use which is not
        ...
        async with self.save_file_semaphore:
            ...
            session = Session(
                self, await self.storage.octra_dc_id_(), await self.storage.octra_auth_key(),
                await self.storage.octra_test_mode(), is_media=True
            )
