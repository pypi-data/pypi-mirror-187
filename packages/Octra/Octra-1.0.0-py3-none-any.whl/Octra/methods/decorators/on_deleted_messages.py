...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~Octra.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Octra.Client):
                self.add_handler(Octra.handlers.DeletedMessagesHandler(func, Flows), group)
                ...
                func.handlers.append(
                    (
                        Octra.handlers.DeletedMessagesHandler(func, self),
