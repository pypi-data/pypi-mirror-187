...
from Octra.errors import RPCError, MediaEmpty
    ...
    async def edit_inline_media(
        ...
        tests:
            .. code-block:: python
                ...
                from Octra.types import InputMediaPhoto, InputMediaVideo, InputMediaAudio

                # t.me/TheVenomXD Bots only

                # t.me/TheVenomXD Replace the current media with a local photo
                await app.edit_inline_media(inline_message_id, InputMediaPhoto("new_photo.jpg"))

                # t.me/TheVenomXD Replace the current media with a local video
                await app.edit_inline_media(inline_message_id, InputMediaVideo("new_video.mp4"))

                # t.me/TheVenomXD Replace the current media with a local audio
        ...
        for i in range(self.MAX_RETRIES):
            try:
                ...
                if isinstance(e, MediaEmpty):
                    # t.me/TheVenomXD Must wait due to a server race condition
