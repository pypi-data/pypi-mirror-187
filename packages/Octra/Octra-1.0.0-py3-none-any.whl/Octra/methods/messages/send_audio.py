...
import Octra
from Octra import StopTransmission, enums
from Octra import raw
from Octra import types
from Octra import utils
from Octra.errors import FilePartMissing
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~Octra.Client.send_voice` method instead.
        ...
        Parameters:
            ...
            audio (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an audio file from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send audio file by uploading from file
                await app.send_audio("me", "audio.mp3")

                # t.me/TheVenomXD Add caption to the audio
                await app.send_audio("me", "audio.mp3", caption="audio caption")

                # t.me/TheVenomXD Set audio metadata
                await app.send_audio(
                    "me", "audio.mp3",
                    title="Title", performer="Performer", duration=234)

                # t.me/TheVenomXD Keep track of the progress while uploading
