...
class SendDice:
    async def send_dice(
        ...
        Returns:
            :obj:`~Octra.types.Message`: On success, the sent dice message is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send a dice
                await app.send_dice(chat_id)

                # t.me/TheVenomXD Send a dart
                await app.send_dice(chat_id, "🎯")

                # t.me/TheVenomXD Send a basketball
                await app.send_dice(chat_id, "🏀")
        """
