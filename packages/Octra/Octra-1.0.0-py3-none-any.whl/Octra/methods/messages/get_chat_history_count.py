...
class ExtractChatHistoryCount:
    async def Extract_chat_history_count(
        self: "Octra.Client",
        chat_id: Union[int, str]
    ) -> int:
        """Extract the total count of messages in a chat.

        .. note::

            Due to Telegram latest internal changes, the server can't reliably find anymore the total count of messages
            a **private** or a **basic group** chat has with a single method call. To overcome this limitation, Octra
