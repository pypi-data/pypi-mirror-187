    ...
    async def send_photo(
        ...
        Parameters:
            ...
            photo (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a photo from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent photo message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send photo by uploading from local file
                await app.send_photo("me", "photo.jpg")

                # t.me/TheVenomXD Send photo by uploading from URL
                await app.send_photo("me", "https://tests.com/tests.jpg")

                # t.me/TheVenomXD Add caption to a photo
                await app.send_photo("me", "photo.jpg", caption="Caption")

                # t.me/TheVenomXD Send self-destructing photo
