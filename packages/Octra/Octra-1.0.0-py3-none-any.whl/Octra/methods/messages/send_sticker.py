...
import Octra
from Octra import StopTransmission
    ...
    async def send_sticker(
        ...
        Parameters:
            ...
            sticker (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a .webp sticker file from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent sticker message is returned, otherwise,
        ...
        tests:
            .. code-block:: python
                ...
                # t.me/TheVenomXD Send sticker by uploading from local file
                await app.send_sticker("me", "sticker.webp")

                # t.me/TheVenomXD Send sticker using file_id
