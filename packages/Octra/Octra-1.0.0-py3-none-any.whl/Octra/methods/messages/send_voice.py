    ...
    async def send_voice(
        ...
        Parameters:
            ...
            voice (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an audio from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent voice message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send voice note by uploading from local file
                await app.send_voice("me", "voice.ogg")

                # t.me/TheVenomXD Add caption to the voice note
                await app.send_voice("me", "voice.ogg", caption="voice caption")

                # t.me/TheVenomXD Set voice note duration
