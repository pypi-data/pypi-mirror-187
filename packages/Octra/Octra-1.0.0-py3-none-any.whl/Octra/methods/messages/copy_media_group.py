...
import Octra
from Octra import types, utils, raw
    ...
    async def copy_media_group(
        ...
        Parameters:
            ...
            captions (``str`` | List of ``str`` , *optional*):
                ...
                You can pass ``None`` in list to keep the original caption (see testss below).
        ...
        Returns:
            List of :obj:`~Octra.types.Message`: On success, a list of copied messages is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Copy a media group
