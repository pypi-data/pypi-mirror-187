    ...
    async def send_document(
        ...
        Parameters:
            ...
            document (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a file from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent document message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send document by uploading from local file
                await app.send_document("me", "document.zip")

                # t.me/TheVenomXD Add caption to the document file
