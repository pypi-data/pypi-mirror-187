    ...
    async def send_animation(
        ...
        Parameters:
            ...
            animation (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an animation from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is
            returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send animation by uploading from local file
                await app.send_animation("me", "animation.gif")

                # t.me/TheVenomXD Add caption to the animation
                await app.send_animation("me", "animation.gif", caption="animation caption")

                # t.me/TheVenomXD Unsave the animation once is sent
