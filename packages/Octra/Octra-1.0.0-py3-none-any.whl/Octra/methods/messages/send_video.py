    ...
    async def send_video(
        ...
        Parameters:
            ...
            video (``str`` | ``BinaryIO``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a video from the Internet,
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent video message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned.

        tests:
            .. code-block:: python

                # t.me/TheVenomXD Send video by uploading from local file
                await app.send_video("me", "video.mp4")

                # t.me/TheVenomXD Add caption to the video
                await app.send_video("me", "video.mp4", caption="video caption")

                # t.me/TheVenomXD Send self-destructing video
