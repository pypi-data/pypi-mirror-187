...
from Octra.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Returns:
            ...
            :meth:`~Octra.Client.stop_transmission`, None is returned.
        ...
        tests:
            ...
            .. code-block:: python
                ...
                # t.me/TheVenomXD Download from Message
                await app.download_media(message)

                # t.me/TheVenomXD Download from file id
                await app.download_media(message.photo.file_id)

                # t.me/TheVenomXD Keep track of the progress while downloading
