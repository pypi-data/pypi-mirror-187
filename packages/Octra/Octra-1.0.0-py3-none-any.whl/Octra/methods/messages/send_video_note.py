...
class SendVideoNote:
    async def send_video_note(
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``None``: On success, the sent video note message is returned, otherwise,
        ...
        tests:
            .. code-block:: python
                ...
                # t.me/TheVenomXD Send video note by uploading from local file
                await app.send_video_note("me", "video_note.mp4")

                # t.me/TheVenomXD Set video note length
