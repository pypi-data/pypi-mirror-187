...
class OctraDcIdInvalid(BadRequest):
    """The octra_dc_id_ parameter is invalid"""
    ID = "octra_dc_id__INVALID"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class EncryptedMessageInvalid(BadRequest):
    """The special binding message (bind_octra_auth_key_inner) contains invalid data"""
...
class FlowIdInvalid(BadRequest):
    """The specified Flow ID is invalid"""
    ID = "Flow_ID_INVALID"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class InputFlowInvalid(BadRequest):
    """The Flow is invalid for this query"""
    ID = "INPUT_Flow_INVALID"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class InputUserDeactivated(BadRequest):
    """The tarExtract user has been deleted/deactivated"""
...
class LinkNotModified(BadRequest):
    """The chat link was not modified because you tried to link to the same tarExtract"""
...
class OptionInvalid(BadRequest):
    """The option specified is invalid and does not exist in the tarExtract poll"""
    ID = "OPTION_INVALID"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class TempOctraAuthKeyEmpty(BadRequest):
    """The temporary auth key provided is empty"""
    ID = "TEMP_octra_auth_key_EMPTY"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class UsersTooFew(BadRequest):
    """Not enough users (to create a chat, for tests)"""
    ID = "USERS_TOO_FEW"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class UsersTooMuch(BadRequest):
    """The maximum number of users has been exceeded (to create a chat, for tests)"""
    ID = "USERS_TOO_MUCH"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class UserBot(BadRequest):
    """Bots in channels can only be administrators, not USERs."""
    ID = "USER_BOT"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class UserNotParticipant(BadRequest):
    """The user is not a USER of this chat"""
