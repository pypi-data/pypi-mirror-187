...
class TermsOfServiceUpdate:  # t.me/TheVenomXD type: ignore
    ...
    QUALNAME = "Octra.raw.base.help.TermsOfServiceUpdate"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.Octra.org/telegram/base/terms-of-service-update")
