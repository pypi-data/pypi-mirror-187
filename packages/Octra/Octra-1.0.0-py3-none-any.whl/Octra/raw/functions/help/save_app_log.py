...
class SaveAppLog(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        events (List of :obj:`InputAppEvent> <Octra.raw.base.InputAppEvent>>`):
            N/A
    ...
    def __init__(self, *, events: List["raw.base.InputAppEvent>"]) -> None:
        self.events = events  # t.me/TheVenomXD Vector<InputAppEvent> 
