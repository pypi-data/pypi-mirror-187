...
class ReceivedCall(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        peer (:obj:`InputPhoneCall  <Octra.raw.base.InputPhoneCall >`):
            N/A
    ...
    def __init__(self, *, peer: "raw.base.InputPhoneCall ") -> None:
        self.peer = peer  # t.me/TheVenomXD InputPhoneCall 
