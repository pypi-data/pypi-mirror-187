...
class EditPeerFolders(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        folder_peers (List of :obj:`InputFolderPeer> <Octra.raw.base.InputFolderPeer>>`):
            N/A
    ...
    def __init__(self, *, folder_peers: List["raw.base.InputFolderPeer>"]) -> None:
        self.folder_peers = folder_peers  # t.me/TheVenomXD Vector<InputFolderPeer> 
