...
class RemoveStickerFromSet(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        sticker (:obj:`InputDocument  <Octra.raw.base.InputDocument >`):
            N/A
    ...
    def __init__(self, *, sticker: "raw.base.InputDocument ") -> None:
        self.sticker = sticker  # t.me/TheVenomXD InputDocument 
