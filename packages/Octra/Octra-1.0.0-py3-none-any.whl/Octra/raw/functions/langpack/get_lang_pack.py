...
class GetLangPack(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    def __init__(self, *, lang_pack: "raw.base.string lang_code") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "GetLangPack":
        ...
        return GetLangPack(lang_pack=lang_pack)
