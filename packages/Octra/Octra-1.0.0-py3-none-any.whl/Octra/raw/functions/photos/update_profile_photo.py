...
class UpdateProfilePhoto(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        ...
        id (:obj:`InputPhoto  <Octra.raw.base.InputPhoto >`):
            N/A
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD fallback", id: "raw.base.InputPhoto ") -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD fallback
        self.id = id  # t.me/TheVenomXD InputPhoto 
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateProfilePhoto":
        ...
        return UpdateProfilePhoto(flags=flags, id=id)
