...
class DeletePhotos(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        id (List of :obj:`InputPhoto> <Octra.raw.base.InputPhoto>>`):
            N/A
    ...
    def __init__(self, *, id: List["raw.base.InputPhoto>"]) -> None:
        self.id = id  # t.me/TheVenomXD Vector<InputPhoto> 
