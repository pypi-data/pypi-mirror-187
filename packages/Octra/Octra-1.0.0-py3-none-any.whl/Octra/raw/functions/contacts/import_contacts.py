...
class ImportContacts(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        contacts (List of :obj:`InputContact> <Octra.raw.base.InputContact>>`):
            N/A

    Returns:
        :obj:`contacts.ImportedContacts <Octra.raw.base.contacts.ImportedContacts>`
    """
    ...
    def __init__(self, *, contacts: List["raw.base.InputContact>"]) -> None:
        self.contacts = contacts  # t.me/TheVenomXD Vector<InputContact> 
