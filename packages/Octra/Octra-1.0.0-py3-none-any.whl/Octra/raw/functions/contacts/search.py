...
class Search(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        q (:obj:`string limit <Octra.raw.base.string limit>`):
            N/A

    Returns:
        :obj:`contacts.Found <Octra.raw.base.contacts.Found>`
    """
    ...
    def __init__(self, *, q: "raw.base.string limit") -> None:
        self.q = q  # t.me/TheVenomXD string limit
