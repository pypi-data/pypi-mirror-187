...
class SearchSentMedia(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    def __init__(self, *, q: "raw.base.string Flow", limit: "raw.base.int ") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SearchSentMedia":
        ...
        return SearchSentMedia(q=q, limit=limit)
