...
class EditChatAdmin(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        ...
        is_admin (:obj:`Bool  <Octra.raw.base.Bool >`):
            N/A
    ...
    def __init__(self, *, chat_id: "raw.base.long octra_user_id", is_admin: "raw.base.Bool ") -> None:
        self.chat_id = chat_id  # t.me/TheVenomXD long octra_user_id
        self.is_admin = is_admin  # t.me/TheVenomXD Bool 
    ...
    def read(b: BytesIO, *args: Any) -> "EditChatAdmin":
        ...
        return EditChatAdmin(chat_id=chat_id, is_admin=is_admin)
