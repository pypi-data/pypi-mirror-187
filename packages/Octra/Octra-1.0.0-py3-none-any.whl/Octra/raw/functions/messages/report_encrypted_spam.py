...
class ReportEncryptedSpam(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat  <Octra.raw.base.InputEncryptedChat >`):
            N/A
    ...
    def __init__(self, *, peer: "raw.base.InputEncryptedChat ") -> None:
        self.peer = peer  # t.me/TheVenomXD InputEncryptedChat 
