...
class GetTopReactions(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Returns:
        :obj:`messages.Reactions <Octra.raw.base.messages.Reactions>`
    """

    __slots__: List[str] = ["limit"]

    ID = 0xbb8125ba
    QUALNAME = "functions.messages.GetTopReactions"

    def __init__(self, *, limit: "raw.base.int hash") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "GetTopReactions":
        ...
        return GetTopReactions(limit=limit)
