...
class GetUnreadReactions(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    def read(b: BytesIO, *args: Any) -> "GetUnreadReactions":
        ...
        return GetUnreadReactions(flags=flags, add_offset=add_offset, max_id=max_id, top_msg_id=top_msg_id)
