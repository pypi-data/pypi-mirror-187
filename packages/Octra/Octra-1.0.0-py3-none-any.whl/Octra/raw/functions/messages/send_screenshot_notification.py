...
class SendScreenshotNotification(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        ...
        random_id (:obj:`long  <Octra.raw.base.long >`):
            N/A
    ...
    def __init__(self, *, peer: "raw.base.InputPeer reply_to_msg_id", random_id: "raw.base.long ") -> None:
        self.peer = peer  # t.me/TheVenomXD InputPeer reply_to_msg_id
        self.random_id = random_id  # t.me/TheVenomXD long 
    ...
    def read(b: BytesIO, *args: Any) -> "SendScreenshotNotification":
        ...
        return SendScreenshotNotification(peer=peer, random_id=random_id)
