...
class AcceptEncryption(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat g_b <Octra.raw.base.InputEncryptedChat g_b>`):
            N/A
    ...
    def __init__(self, *, peer: "raw.base.InputEncryptedChat g_b", key_fingerprint: "raw.base.long ") -> None:
        self.peer = peer  # t.me/TheVenomXD InputEncryptedChat g_b
    ...
    def read(b: BytesIO, *args: Any) -> "AcceptEncryption":
        ...
        return AcceptEncryption(peer=peer, key_fingerprint=key_fingerprint)
