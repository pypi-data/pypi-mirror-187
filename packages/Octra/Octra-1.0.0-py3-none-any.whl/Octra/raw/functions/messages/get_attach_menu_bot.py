...
class GetAttachMenuBot(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        bot (:obj:`InputUser  <Octra.raw.base.InputUser >`):
            N/A

    Returns:
        :obj:`AttachMenuBotsBot <Octra.raw.base.AttachMenuBotsBot>`
    """
    ...
    def __init__(self, *, bot: "raw.base.InputUser ") -> None:
        self.bot = bot  # t.me/TheVenomXD InputUser 
