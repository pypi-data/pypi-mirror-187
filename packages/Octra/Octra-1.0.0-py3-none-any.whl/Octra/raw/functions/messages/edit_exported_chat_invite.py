...
class EditExportedChatInvite(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        ...
        request_needed (:obj:`Bool title <Octra.raw.base.Bool title>`, *optional*):
            N/A

    Returns:
        :obj:`messages.ExportedChatInvite <Octra.raw.base.messages.ExportedChatInvite>`
    """

    __slots__: List[str] = ["flags", "peer", "expire_date", "request_needed"]

    ID = 0xbdca2f75
    QUALNAME = "functions.messages.EditExportedChatInvite"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD revoked", peer: "raw.base.InputPeer link", expire_date: "raw.base.int usage_limit" = None, request_needed: "raw.base.Bool title" = None) -> None:
        ...
        self.request_needed = request_needed  # t.me/TheVenomXD flags.3?Bool title
    ...
    def read(b: BytesIO, *args: Any) -> "EditExportedChatInvite":
        ...
        return EditExportedChatInvite(flags=flags, peer=peer, expire_date=expire_date, request_needed=request_needed)
