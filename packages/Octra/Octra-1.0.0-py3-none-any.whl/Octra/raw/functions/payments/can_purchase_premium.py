...
class CanPurchasePremium(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        purpose (:obj:`InputStorePaymentPurpose  <Octra.raw.base.InputStorePaymentPurpose >`):
            N/A
    ...
    def __init__(self, *, purpose: "raw.base.InputStorePaymentPurpose ") -> None:
        self.purpose = purpose  # t.me/TheVenomXD InputStorePaymentPurpose 
