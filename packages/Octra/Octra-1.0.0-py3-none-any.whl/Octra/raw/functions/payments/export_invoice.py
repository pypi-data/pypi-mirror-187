...
class ExportInvoice(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        invoice_media (:obj:`InputMedia  <Octra.raw.base.InputMedia >`):
            N/A

    Returns:
        :obj:`payments.ExportedInvoice <Octra.raw.base.payments.ExportedInvoice>`
    """
    ...
    def __init__(self, *, invoice_media: "raw.base.InputMedia ") -> None:
        self.invoice_media = invoice_media  # t.me/TheVenomXD InputMedia 
