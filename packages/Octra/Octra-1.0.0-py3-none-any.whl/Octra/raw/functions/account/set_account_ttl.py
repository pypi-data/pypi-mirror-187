...
class SetAccountTTL(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        ttl (:obj:`AccountDaysTTL  <Octra.raw.base.AccountDaysTTL >`):
            N/A
    ...
    def __init__(self, *, ttl: "raw.base.AccountDaysTTL ") -> None:
        self.ttl = ttl  # t.me/TheVenomXD AccountDaysTTL 
