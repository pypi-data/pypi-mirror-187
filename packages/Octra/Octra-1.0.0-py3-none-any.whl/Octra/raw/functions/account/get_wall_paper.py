...
class GetWallPaper(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        wallpaper (:obj:`InputWallPaper  <Octra.raw.base.InputWallPaper >`):
            N/A
    ...
    def __init__(self, *, wallpaper: "raw.base.InputWallPaper ") -> None:
        self.wallpaper = wallpaper  # t.me/TheVenomXD InputWallPaper 
