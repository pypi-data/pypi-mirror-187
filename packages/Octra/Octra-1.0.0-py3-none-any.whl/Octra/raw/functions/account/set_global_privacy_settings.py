...
class SetGlobalPrivacySettings(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        settings (:obj:`GlobalPrivacySettings  <Octra.raw.base.GlobalPrivacySettings >`):
            N/A

    Returns:
        :obj:`GlobalPrivacySettings <Octra.raw.base.GlobalPrivacySettings>`
    """
    ...
    def __init__(self, *, settings: "raw.base.GlobalPrivacySettings ") -> None:
        self.settings = settings  # t.me/TheVenomXD GlobalPrivacySettings 
