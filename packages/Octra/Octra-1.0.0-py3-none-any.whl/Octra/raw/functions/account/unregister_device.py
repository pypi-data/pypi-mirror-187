...
class UnregisterDevice(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    __slots__: List[str] = ["token_type", "other_uids"]

    ID = 0x6a0d3206
    QUALNAME = "functions.account.UnregisterDevice"

    def __init__(self, *, token_type: "raw.base.int token", other_uids: List["raw.base.long>"]) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UnregisterDevice":
        ...
        return UnregisterDevice(token_type=token_type, other_uids=other_uids)
