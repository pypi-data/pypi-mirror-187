...
class UpdateEmojiStatus(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        emoji_status (:obj:`EmojiStatus  <Octra.raw.base.EmojiStatus >`):
            N/A
    ...
    def __init__(self, *, emoji_status: "raw.base.EmojiStatus ") -> None:
        self.emoji_status = emoji_status  # t.me/TheVenomXD EmojiStatus 
