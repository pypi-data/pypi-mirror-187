...
class ConfirmPhone(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    __slots__: List[str] = ["phone_code_hash"]

    ID = 0x5f2178c3
    QUALNAME = "functions.account.ConfirmPhone"

    def __init__(self, *, phone_code_hash: "raw.base.string phone_code") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ConfirmPhone":
        ...
        return ConfirmPhone(phone_code_hash=phone_code_hash)
