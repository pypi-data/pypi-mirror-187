...
class GetSecureValue(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Parameters:
        types (List of :obj:`SecureValueType> <Octra.raw.base.SecureValueType>>`):
            N/A

    Returns:
        List of :obj:`SecureValue <Octra.raw.base.SecureValue>`
    """
    ...
    def __init__(self, *, types: List["raw.base.SecureValueType>"]) -> None:
        self.types = types  # t.me/TheVenomXD Vector<SecureValueType> 
