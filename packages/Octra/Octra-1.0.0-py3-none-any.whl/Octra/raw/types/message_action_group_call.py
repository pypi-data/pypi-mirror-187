...
class MessageActionGroupCall(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["flags", "duration"]

    ID = 0x7a0d7f42
    QUALNAME = "types.MessageActionGroupCall"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD call", duration: "raw.base.int " = None) -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD call
        self.duration = duration  # t.me/TheVenomXD flags.0?int 
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionGroupCall":
        ...
        return MessageActionGroupCall(flags=flags, duration=duration)
