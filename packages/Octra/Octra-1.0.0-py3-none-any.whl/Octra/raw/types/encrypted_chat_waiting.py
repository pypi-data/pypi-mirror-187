...
class EncryptedChatWaiting(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        participant_id (:obj:`long  <Octra.raw.base.long >`):
            N/A
    ...
    __slots__: List[str] = ["id", "date", "participant_id"]

    ID = 0x66b25953
    QUALNAME = "types.EncryptedChatWaiting"

    def __init__(self, *, id: "raw.base.int access_hash", date: "raw.base.int admin_id", participant_id: "raw.base.long ") -> None:
        self.id = id  # t.me/TheVenomXD int access_hash
        self.date = date  # t.me/TheVenomXD int admin_id
        self.participant_id = participant_id  # t.me/TheVenomXD long 
    ...
    def read(b: BytesIO, *args: Any) -> "EncryptedChatWaiting":
        ...
        return EncryptedChatWaiting(id=id, date=date, participant_id=participant_id)
