...
class InputPaymentCredentialsGooglePay(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        payment_token (:obj:`DataJSON  <Octra.raw.base.DataJSON >`):
            N/A
    ...
    def __init__(self, *, payment_token: "raw.base.DataJSON ") -> None:
        self.payment_token = payment_token  # t.me/TheVenomXD DataJSON 
