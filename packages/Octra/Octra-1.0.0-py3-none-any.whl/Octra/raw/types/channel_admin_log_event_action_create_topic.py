...
class ChannelAdminLogEventActionCreateTopic(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        topic (:obj:`ForumTopic  <Octra.raw.base.ForumTopic >`):
            N/A
    ...
    def __init__(self, *, topic: "raw.base.ForumTopic ") -> None:
        self.topic = topic  # t.me/TheVenomXD ForumTopic 
