...
class InputThemeSettings(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.InputThemeSettings`.
    ...
    Parameters:
        ...
        wallpaper (:obj:`InputWallPaper wallpaper_settings <Octra.raw.base.InputWallPaper wallpaper_settings>`, *optional*):
            N/A
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD message_colors_animated", base_theme: "raw.base.BaseTheme accent_color", outbox_accent_color: "raw.base.int message_colors" = None, wallpaper: "raw.base.InputWallPaper wallpaper_settings" = None) -> None:
        ...
        self.wallpaper = wallpaper  # t.me/TheVenomXD flags.1?InputWallPaper wallpaper_settings
    ...
    def read(b: BytesIO, *args: Any) -> "InputThemeSettings":
        ...
        return InputThemeSettings(flags=flags, base_theme=base_theme, outbox_accent_color=outbox_accent_color, wallpaper=wallpaper)
