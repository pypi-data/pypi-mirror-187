...
class SentCodeTypeCall(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        length (:obj:`int  <Octra.raw.base.int >`):
            N/A
    ...
    def __init__(self, *, length: "raw.base.int ") -> None:
        self.length = length  # t.me/TheVenomXD int 
