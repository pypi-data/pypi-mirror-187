...
class LoginTokenSuccess(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        authorization (:obj:`auth.Authorization  <Octra.raw.base.auth.Authorization >`):
            N/A
    ...
    def __init__(self, *, authorization: "raw.base.auth.Authorization ") -> None:
        self.authorization = authorization  # t.me/TheVenomXD auth.Authorization 
