...
class InputBotInlineMessageMediaVenue(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD geo_point", title: "raw.base.string address", provider: "raw.base.string venue_id", venue_type: "raw.base.string reply_markup") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "InputBotInlineMessageMediaVenue":
        ...
        return InputBotInlineMessageMediaVenue(flags=flags, title=title, provider=provider, venue_type=venue_type)
