...
class PageBlockList(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        items (List of :obj:`PageListItem> <Octra.raw.base.PageListItem>>`):
            N/A
    ...
    def __init__(self, *, items: List["raw.base.PageListItem>"]) -> None:
        self.items = items  # t.me/TheVenomXD Vector<PageListItem> 
