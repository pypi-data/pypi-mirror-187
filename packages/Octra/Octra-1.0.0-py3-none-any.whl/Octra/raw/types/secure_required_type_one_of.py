...
class SecureRequiredTypeOneOf(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        types (List of :obj:`SecureRequiredType> <Octra.raw.base.SecureRequiredType>>`):
            N/A
    ...
    def __init__(self, *, types: List["raw.base.SecureRequiredType>"]) -> None:
        self.types = types  # t.me/TheVenomXD Vector<SecureRequiredType> 
