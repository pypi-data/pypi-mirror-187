...
class GroupCallStreamChannels(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel> <Octra.raw.base.GroupCallStreamChannel>>`):
            N/A
    ...
    def __init__(self, *, channels: List["raw.base.GroupCallStreamChannel>"]) -> None:
        self.channels = channels  # t.me/TheVenomXD Vector<GroupCallStreamChannel> 
