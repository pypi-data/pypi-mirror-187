...
class ExportedGroupCallInvite(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.phone.ExportedGroupCallInvite`.
    ...
    Parameters:
        link (:obj:`string  <Octra.raw.base.string >`):
            N/A
    ...
    def __init__(self, *, link: "raw.base.string ") -> None:
        self.link = link  # t.me/TheVenomXD string 
