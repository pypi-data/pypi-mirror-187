...
class JsonArray(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        value (List of :obj:`JSONValue> <Octra.raw.base.JSONValue>>`):
            N/A
    ...
    def __init__(self, *, value: List["raw.base.JSONValue>"]) -> None:
        self.value = value  # t.me/TheVenomXD Vector<JSONValue> 
