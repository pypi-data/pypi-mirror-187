...
class PQInnerDataDc(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, pq: "raw.base.bytes p", q: "raw.base.bytes nonce", server_nonce: "raw.base.int128 new_nonce", dc: "raw.base.int ") -> None:
        ...
        self.dc = dc  # t.me/TheVenomXD int 
    ...
    def read(b: BytesIO, *args: Any) -> "PQInnerDataDc":
        ...
        return PQInnerDataDc(pq=pq, q=q, server_nonce=server_nonce, dc=dc)
