...
class BadServerSalt(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        error_code (:obj:`int new_server_salt <Octra.raw.base.int new_server_salt>`):
            N/A
    ...
    def __init__(self, *, bad_msg_id: "raw.base.long bad_msg_seqno", error_code: "raw.base.int new_server_salt") -> None:
        self.bad_msg_id = bad_msg_id  # t.me/TheVenomXD long bad_msg_seqno
        self.error_code = error_code  # t.me/TheVenomXD int new_server_salt
    ...
    def read(b: BytesIO, *args: Any) -> "BadServerSalt":
        ...
        return BadServerSalt(bad_msg_id=bad_msg_id, error_code=error_code)
