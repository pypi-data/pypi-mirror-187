...
class UpdateChatParticipantDelete(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, chat_id: "raw.base.long octra_user_id", version: "raw.base.int ") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateChatParticipantDelete":
        ...
        return UpdateChatParticipantDelete(chat_id=chat_id, version=version)
