...
class UpdateReadChannelOutbox(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, channel_id: "raw.base.long max_id") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateReadChannelOutbox":
        ...
        return UpdateReadChannelOutbox(channel_id=channel_id)
