...
class UpdatePeerHistoryTTL(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["flags", "ttl_period"]

    ID = 0xbb9bb9a5
    QUALNAME = "types.UpdatePeerHistoryTTL"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD peer", ttl_period: "raw.base.int " = None) -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD peer
        self.ttl_period = ttl_period  # t.me/TheVenomXD flags.0?int 
    ...
    def read(b: BytesIO, *args: Any) -> "UpdatePeerHistoryTTL":
        ...
        return UpdatePeerHistoryTTL(flags=flags, ttl_period=ttl_period)
