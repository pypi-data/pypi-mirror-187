...
class ChannelAdminLogEventActionParticipantJoinByInvite(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        invite (:obj:`ExportedChatInvite  <Octra.raw.base.ExportedChatInvite >`):
            N/A
    ...
    def __init__(self, *, invite: "raw.base.ExportedChatInvite ") -> None:
        self.invite = invite  # t.me/TheVenomXD ExportedChatInvite 
