...
class ChannelAdminLogEventActionToggleSignatures(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        new_value (:obj:`Bool  <Octra.raw.base.Bool >`):
            N/A
    ...
    def __init__(self, *, new_value: "raw.base.Bool ") -> None:
        self.new_value = new_value  # t.me/TheVenomXD Bool 
