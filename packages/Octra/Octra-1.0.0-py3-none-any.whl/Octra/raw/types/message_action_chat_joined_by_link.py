...
class MessageActionChatJoinedByLink(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        inviter_id (:obj:`long  <Octra.raw.base.long >`):
            N/A
    ...
    def __init__(self, *, inviter_id: "raw.base.long ") -> None:
        self.inviter_id = inviter_id  # t.me/TheVenomXD long 
