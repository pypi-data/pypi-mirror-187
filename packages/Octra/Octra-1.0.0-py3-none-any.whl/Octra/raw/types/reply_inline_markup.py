...
class ReplyInlineMarkup(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        rows (List of :obj:`KeyboardButtonRow> <Octra.raw.base.KeyboardButtonRow>>`):
            N/A
    ...
    def __init__(self, *, rows: List["raw.base.KeyboardButtonRow>"]) -> None:
        self.rows = rows  # t.me/TheVenomXD Vector<KeyboardButtonRow> 
