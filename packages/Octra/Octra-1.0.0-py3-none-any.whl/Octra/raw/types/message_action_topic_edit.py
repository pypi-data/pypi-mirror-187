...
class MessageActionTopicEdit(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["flags", "icon_emoji_id", "hidden"]

    ID = 0xc0944820
    QUALNAME = "types.MessageActionTopicEdit"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD title", icon_emoji_id: "raw.base.long closed" = None, hidden: "raw.base.Bool " = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionTopicEdit":
        ...
        return MessageActionTopicEdit(flags=flags, icon_emoji_id=icon_emoji_id, hidden=hidden)
