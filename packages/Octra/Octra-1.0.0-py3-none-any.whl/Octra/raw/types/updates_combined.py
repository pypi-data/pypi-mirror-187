...
class UpdatesCombined(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        seq_start (:obj:`int seq <Octra.raw.base.int seq>`):
            N/A
    ...
    __slots__: List[str] = ["updates", "chats", "seq_start"]

    ID = 0x725b04c3
    QUALNAME = "types.UpdatesCombined"

    def __init__(self, *, updates: List["raw.base.Update> user"], chats: List["raw.base.Chat> dat"], seq_start: "raw.base.int seq") -> None:
        self.updates = updates  # t.me/TheVenomXD Vector<Update> users
        self.chats = chats  # t.me/TheVenomXD Vector<Chat> date
        self.seq_start = seq_start  # t.me/TheVenomXD int seq
    ...
    def read(b: BytesIO, *args: Any) -> "UpdatesCombined":
        ...
        seq_start = TLObject.read(b)
        
        return UpdatesCombined(updates=updates, chats=chats, seq_start=seq_start)
