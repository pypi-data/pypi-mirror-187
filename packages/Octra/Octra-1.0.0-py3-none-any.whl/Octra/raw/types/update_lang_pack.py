...
class UpdateLangPack(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        difference (:obj:`LangPackDifference  <Octra.raw.base.LangPackDifference >`):
            N/A
    ...
    def __init__(self, *, difference: "raw.base.LangPackDifference ") -> None:
        self.difference = difference  # t.me/TheVenomXD LangPackDifference 
