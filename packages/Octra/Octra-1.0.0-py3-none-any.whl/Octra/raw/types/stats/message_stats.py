...
class MessageStats(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.stats.MessageStats`.
    ...
    Parameters:
        views_graph (:obj:`StatsGraph  <Octra.raw.base.StatsGraph >`):
            N/A
    ...
    def __init__(self, *, views_graph: "raw.base.StatsGraph ") -> None:
        self.views_graph = views_graph  # t.me/TheVenomXD StatsGraph 
