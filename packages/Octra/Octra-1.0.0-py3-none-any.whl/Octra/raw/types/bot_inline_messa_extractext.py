...
class BotInlineMessaExtractext(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    ID = 0x8c7f65e2
    QUALNAME = "types.BotInlineMessaExtractext"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "BotInlineMessaExtractext":
        ...
        return BotInlineMessaExtractext(flags=flags, message=message, reply_markup=reply_markup)
