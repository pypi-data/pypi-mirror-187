...
class UpdatePinnedChannelMessages(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        channel_id (:obj:`long messages <Octra.raw.base.long messages>`):
            N/A
    ...
    __slots__: List[str] = ["flags", "channel_id", "pts"]

    ID = 0x5bb98608
    QUALNAME = "types.UpdatePinnedChannelMessages"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD pinned", channel_id: "raw.base.long messages", pts: "raw.base.int pts_count") -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD pinned
        self.channel_id = channel_id  # t.me/TheVenomXD long messages
    ...
    def read(b: BytesIO, *args: Any) -> "UpdatePinnedChannelMessages":
        ...
        return UpdatePinnedChannelMessages(flags=flags, channel_id=channel_id, pts=pts)
