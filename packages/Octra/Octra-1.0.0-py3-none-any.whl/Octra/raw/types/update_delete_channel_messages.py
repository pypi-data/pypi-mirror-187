...
class UpdateDeleteChannelMessages(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, channel_id: "raw.base.long messages", pts: "raw.base.int pts_count") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateDeleteChannelMessages":
        ...
        return UpdateDeleteChannelMessages(channel_id=channel_id, pts=pts)
