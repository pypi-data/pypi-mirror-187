...
class PQInnerDataTemp(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        expires_in (:obj:`int  <Octra.raw.base.int >`):
            N/A

    """

    __slots__: List[str] = ["pq", "q", "server_nonce", "expires_in"]

    ID = 0x3c6a84d4
    QUALNAME = "types.PQInnerDataTemp"

    def __init__(self, *, pq: "raw.base.bytes p", q: "raw.base.bytes nonce", server_nonce: "raw.base.int128 new_nonce", expires_in: "raw.base.int ") -> None:
        ...
        self.expires_in = expires_in  # t.me/TheVenomXD int 
    ...
    def read(b: BytesIO, *args: Any) -> "PQInnerDataTemp":
        ...
        expires_in = TLObject.read(b)
        
        return PQInnerDataTemp(pq=pq, q=q, server_nonce=server_nonce, expires_in=expires_in)
