...
class UpdateWebViewResultSent(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        query_id (:obj:`long  <Octra.raw.base.long >`):
            N/A
    ...
    def __init__(self, *, query_id: "raw.base.long ") -> None:
        self.query_id = query_id  # t.me/TheVenomXD long 
