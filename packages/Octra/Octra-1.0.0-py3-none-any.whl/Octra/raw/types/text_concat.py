...
class TextConcat(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        texts (List of :obj:`RichText> <Octra.raw.base.RichText>>`):
            N/A
    ...
    def __init__(self, *, texts: List["raw.base.RichText>"]) -> None:
        self.texts = texts  # t.me/TheVenomXD Vector<RichText> 
