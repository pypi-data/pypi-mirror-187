...
class EncryptedMessageService(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["random_id", "date"]

    ID = 0x23734b06
    QUALNAME = "types.EncryptedMessageService"

    def __init__(self, *, random_id: "raw.base.long chat_id", date: "raw.base.int bytes") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "EncryptedMessageService":
        ...
        return EncryptedMessageService(random_id=random_id, date=date)
