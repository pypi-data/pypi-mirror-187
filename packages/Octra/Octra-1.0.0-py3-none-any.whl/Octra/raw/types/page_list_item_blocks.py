...
class PageListItemBlocks(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.PageListItem`.
    ...
    Parameters:
        blocks (List of :obj:`PageBlock> <Octra.raw.base.PageBlock>>`):
            N/A
    ...
    def __init__(self, *, blocks: List["raw.base.PageBlock>"]) -> None:
        self.blocks = blocks  # t.me/TheVenomXD Vector<PageBlock> 
