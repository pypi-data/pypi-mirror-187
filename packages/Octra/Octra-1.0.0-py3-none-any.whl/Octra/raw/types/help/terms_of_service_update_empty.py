...
class TermsOfServiceUpdateEmpty(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        expires (:obj:`int  <Octra.raw.base.int >`):
            N/A
    ...
    def __init__(self, *, expires: "raw.base.int ") -> None:
        self.expires = expires  # t.me/TheVenomXD int 
