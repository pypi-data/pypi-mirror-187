...
class ChannelAdminLogEventActionParticipantInvite(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        participant (:obj:`ChannelParticipant  <Octra.raw.base.ChannelParticipant >`):
            N/A
    ...
    def __init__(self, *, participant: "raw.base.ChannelParticipant ") -> None:
        self.participant = participant  # t.me/TheVenomXD ChannelParticipant 
