...
class UpdatePhoneCall(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        phone_call (:obj:`PhoneCall  <Octra.raw.base.PhoneCall >`):
            N/A
    ...
    def __init__(self, *, phone_call: "raw.base.PhoneCall ") -> None:
        self.phone_call = phone_call  # t.me/TheVenomXD PhoneCall 
