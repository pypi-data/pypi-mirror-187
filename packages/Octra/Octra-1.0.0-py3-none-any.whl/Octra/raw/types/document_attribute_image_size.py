...
class DocumentAttributeImageSize(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["w"]

    ID = 0x6c37c15c
    QUALNAME = "types.DocumentAttributeImageSize"

    def __init__(self, *, w: "raw.base.int h") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "DocumentAttributeImageSize":
        ...
        return DocumentAttributeImageSize(w=w)
