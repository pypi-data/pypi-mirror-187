...
class ChatInvitePeek(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        chat (:obj:`Chat expires <Octra.raw.base.Chat expires>`):
            N/A
    ...
    def __init__(self, *, chat: "raw.base.Chat expires") -> None:
        self.chat = chat  # t.me/TheVenomXD Chat expires
    ...
    def read(b: BytesIO, *args: Any) -> "ChatInvitePeek":
        ...
        return ChatInvitePeek(chat=chat)
