...
class MessageMediaDice(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        value (:obj:`int emoticon <Octra.raw.base.int emoticon>`):
            N/A
    ...
    def __init__(self, *, value: "raw.base.int emoticon") -> None:
        self.value = value  # t.me/TheVenomXD int emoticon
