...
class JsonString(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        value (:obj:`string  <Octra.raw.base.string >`):
            N/A
    ...
    def __init__(self, *, value: "raw.base.string ") -> None:
        self.value = value  # t.me/TheVenomXD string 
