...
class ChannelParticipants(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.channels.ChannelParticipants`.
    ...
    def __init__(self, *, count: "raw.base.int participants", chats: List["raw.base.Chat> user"]) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelParticipants":
        ...
        return ChannelParticipants(count=count, chats=chats)
