...
class CdnConfig(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.CdnConfig`.
    ...
    Parameters:
        public_keys (List of :obj:`CdnPublicKey> <Octra.raw.base.CdnPublicKey>>`):
            N/A
    ...
    def __init__(self, *, public_keys: List["raw.base.CdnPublicKey>"]) -> None:
        self.public_keys = public_keys  # t.me/TheVenomXD Vector<CdnPublicKey> 
