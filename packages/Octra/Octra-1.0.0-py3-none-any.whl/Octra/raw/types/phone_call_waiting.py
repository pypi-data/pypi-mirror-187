...
class PhoneCallWaiting(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        participant_id (:obj:`long protocol <Octra.raw.base.long protocol>`):
            N/A

        receive_date (:obj:`int  <Octra.raw.base.int >`, *optional*):
            N/A

    """

    __slots__: List[str] = ["flags", "id", "date", "participant_id", "receive_date"]

    ID = 0xc5226f17
    QUALNAME = "types.PhoneCallWaiting"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD video", id: "raw.base.long access_hash", date: "raw.base.int admin_id", participant_id: "raw.base.long protocol", receive_date: "raw.base.int " = None) -> None:
        ...
        self.participant_id = participant_id  # t.me/TheVenomXD long protocol
        self.receive_date = receive_date  # t.me/TheVenomXD flags.0?int 
    ...
    def read(b: BytesIO, *args: Any) -> "PhoneCallWaiting":
        ...
        return PhoneCallWaiting(flags=flags, id=id, date=date, participant_id=participant_id, receive_date=receive_date)
