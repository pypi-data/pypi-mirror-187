...
class Photo(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Constructor of :obj:`~Octra.raw.base.photos.Photo`.
    ...
    Parameters:
        photo (:obj:`Photo users <Octra.raw.base.Photo users>`):
            N/A
    ...
    def __init__(self, *, photo: "raw.base.Photo users") -> None:
        self.photo = photo  # t.me/TheVenomXD Photo users
