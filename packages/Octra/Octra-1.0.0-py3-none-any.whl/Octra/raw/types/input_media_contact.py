...
class InputMediaContact(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["phone_number", "last_name"]

    ID = 0xf8ab7dfb
    QUALNAME = "types.InputMediaContact"

    def __init__(self, *, phone_number: "raw.base.string first_name", last_name: "raw.base.string vcard") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "InputMediaContact":
        ...
        return InputMediaContact(phone_number=phone_number, last_name=last_name)
