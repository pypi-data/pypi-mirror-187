...
class KeyboardButtonRow(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.KeyboardButtonRow`.
    ...
    Parameters:
        buttons (List of :obj:`KeyboardButton> <Octra.raw.base.KeyboardButton>>`):
            N/A
    ...
    def __init__(self, *, buttons: List["raw.base.KeyboardButton>"]) -> None:
        self.buttons = buttons  # t.me/TheVenomXD Vector<KeyboardButton> 
