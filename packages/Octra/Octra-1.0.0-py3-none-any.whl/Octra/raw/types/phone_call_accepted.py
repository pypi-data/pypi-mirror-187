...
class PhoneCallAccepted(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        participant_id (:obj:`long g_b <Octra.raw.base.long g_b>`):
            N/A
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD video", id: "raw.base.long access_hash", date: "raw.base.int admin_id", participant_id: "raw.base.long g_b", protocol: "raw.base.PhoneCallProtocol ") -> None:
        ...
        self.participant_id = participant_id  # t.me/TheVenomXD long g_b
    ...
    def read(b: BytesIO, *args: Any) -> "PhoneCallAccepted":
        ...
        return PhoneCallAccepted(flags=flags, id=id, date=date, participant_id=participant_id, protocol=protocol)
