...
class ChannelDifferenceEmpty(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD final", pts: "raw.base.int timeout") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelDifferenceEmpty":
        ...
        return ChannelDifferenceEmpty(flags=flags, pts=pts)
