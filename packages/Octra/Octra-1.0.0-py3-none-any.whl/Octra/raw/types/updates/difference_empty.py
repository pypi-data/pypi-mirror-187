...
class DifferenceEmpty(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        date (:obj:`int seq <Octra.raw.base.int seq>`):
            N/A
    ...
    def __init__(self, *, date: "raw.base.int seq") -> None:
        self.date = date  # t.me/TheVenomXD int seq
    ...
    def read(b: BytesIO, *args: Any) -> "DifferenceEmpty":
        ...
        return DifferenceEmpty(date=date)
