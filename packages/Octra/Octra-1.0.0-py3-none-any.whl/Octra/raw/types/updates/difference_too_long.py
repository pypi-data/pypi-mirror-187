...
class DifferenceTooLong(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        pts (:obj:`int  <Octra.raw.base.int >`):
            N/A
    ...
    def __init__(self, *, pts: "raw.base.int ") -> None:
        self.pts = pts  # t.me/TheVenomXD int 
