...
class DifferenceSlice(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        users (List of :obj:`User> intermediate_stat <Octra.raw.base.User> intermediate_stat>`):
            N/A
    ...
    def __init__(self, *, new_messages: List["raw.base.Message> new_encrypted_message"], other_updates: List["raw.base.Update> chat"], users: List["raw.base.User> intermediate_stat"]) -> None:
        ...
        self.users = users  # t.me/TheVenomXD Vector<User> intermediate_state
    ...
    def read(b: BytesIO, *args: Any) -> "DifferenceSlice":
        ...
        return DifferenceSlice(new_messages=new_messages, other_updates=other_updates, users=users)
