...
class InputPaymentCredentialsApplePay(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        payment_data (:obj:`DataJSON  <Octra.raw.base.DataJSON >`):
            N/A
    ...
    def __init__(self, *, payment_data: "raw.base.DataJSON ") -> None:
        self.payment_data = payment_data  # t.me/TheVenomXD DataJSON 
