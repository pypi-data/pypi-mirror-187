...
class MessageExtendedMedia(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        media (:obj:`MessageMedia  <Octra.raw.base.MessageMedia >`):
            N/A
    ...
    def __init__(self, *, media: "raw.base.MessageMedia ") -> None:
        self.media = media  # t.me/TheVenomXD MessageMedia 
