...
class UpdateChannelWebPage(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        channel_id (:obj:`long webpage <Octra.raw.base.long webpage>`):
            N/A
    ...
    def __init__(self, *, channel_id: "raw.base.long webpage", pts: "raw.base.int pts_count") -> None:
        self.channel_id = channel_id  # t.me/TheVenomXD long webpage
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateChannelWebPage":
        ...
        return UpdateChannelWebPage(channel_id=channel_id, pts=pts)
