...
class AffectedMessages(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.messages.AffectedMessages`.
    ...
    def __init__(self, *, pts: "raw.base.int pts_count") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "AffectedMessages":
        ...
        return AffectedMessages(pts=pts)
