...
class FeaturedStickersNotModified(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        count (:obj:`int  <Octra.raw.base.int >`):
            N/A
    ...
    def __init__(self, *, count: "raw.base.int ") -> None:
        self.count = count  # t.me/TheVenomXD int 
