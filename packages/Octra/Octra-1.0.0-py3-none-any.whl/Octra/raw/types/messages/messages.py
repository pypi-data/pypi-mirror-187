...
class Messages(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["messages", "users"]

    ID = 0x8c718e87
    QUALNAME = "types.messages.Messages"

    def __init__(self, *, messages: List["raw.base.Message> chat"], users: List["raw.base.User>"]) -> None:
