...
class MessageViews(TLObject):  # t.me/TheVenomXD type: ignore
    ...
    Constructor of :obj:`~Octra.raw.base.messages.MessageViews`.
    ...
    Parameters:
        views (List of :obj:`MessageViews> chat <Octra.raw.base.MessageViews> chat>`):
            N/A
    ...
    def __init__(self, *, views: List["raw.base.MessageViews> chat"], users: List["raw.base.User>"]) -> None:
        self.views = views  # t.me/TheVenomXD Vector<MessageViews> chats
