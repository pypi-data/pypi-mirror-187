...
class StickerSetInstallResultArchive(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.messages.StickerSetInstallResult`.
    ...
    Parameters:
        sets (List of :obj:`StickerSetCovered> <Octra.raw.base.StickerSetCovered>>`):
            N/A
    ...
    def __init__(self, *, sets: List["raw.base.StickerSetCovered>"]) -> None:
        self.sets = sets  # t.me/TheVenomXD Vector<StickerSetCovered> 
