...
class UpdateChatParticipants(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        participants (:obj:`ChatParticipants  <Octra.raw.base.ChatParticipants >`):
            N/A
    ...
    def __init__(self, *, participants: "raw.base.ChatParticipants ") -> None:
        self.participants = participants  # t.me/TheVenomXD ChatParticipants 
