...
class JsonBool(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        value (:obj:`Bool  <Octra.raw.base.Bool >`):
            N/A
    ...
    def __init__(self, *, value: "raw.base.Bool ") -> None:
        self.value = value  # t.me/TheVenomXD Bool 
