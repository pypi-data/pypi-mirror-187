...
class UpdateReadHistoryOutbox(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    __slots__: List[str] = ["peer", "pts"]

    ID = 0x2f2f21bf
    QUALNAME = "types.UpdateReadHistoryOutbox"

    def __init__(self, *, peer: "raw.base.Peer max_id", pts: "raw.base.int pts_count") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateReadHistoryOutbox":
        ...
        return UpdateReadHistoryOutbox(peer=peer, pts=pts)
