...
class UpdateDcOptions(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        dc_options (List of :obj:`DcOption> <Octra.raw.base.DcOption>>`):
            N/A
    ...
    def __init__(self, *, dc_options: List["raw.base.DcOption>"]) -> None:
        self.dc_options = dc_options  # t.me/TheVenomXD Vector<DcOption> 
