...
class ChannelAdminLogEventActionParticipantVolume(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        participant (:obj:`GroupCallParticipant  <Octra.raw.base.GroupCallParticipant >`):
            N/A
    ...
    def __init__(self, *, participant: "raw.base.GroupCallParticipant ") -> None:
        self.participant = participant  # t.me/TheVenomXD GroupCallParticipant 
