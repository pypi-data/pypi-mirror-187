...
class StatsDateRangeDays(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.StatsDateRangeDays`.
    ...
    __slots__: List[str] = ["min_date"]

    ID = 0xb637edaf
    QUALNAME = "types.StatsDateRangeDays"

    def __init__(self, *, min_date: "raw.base.int max_date") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "StatsDateRangeDays":
        ...
        return StatsDateRangeDays(min_date=min_date)
