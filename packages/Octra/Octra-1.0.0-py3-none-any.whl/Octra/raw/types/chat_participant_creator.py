...
class ChatParticipantCreator(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, octra_user_id: "raw.base.long ") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChatParticipantCreator":
        ...
        return ChatParticipantCreator(octra_user_id=octra_user_id)
