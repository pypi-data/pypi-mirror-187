...
class MessageActionPaymentSent(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        total_amount (:obj:`long invoice_slug <Octra.raw.base.long invoice_slug>`):
            N/A
    ...
    __slots__: List[str] = ["flags", "total_amount", "recurring_used"]

    ID = 0x96163f56
    QUALNAME = "types.MessageActionPaymentSent"

    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD recurring_init", total_amount: "raw.base.long invoice_slug", recurring_used: "raw.base.true currency" = None) -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD recurring_init
        self.total_amount = total_amount  # t.me/TheVenomXD long invoice_slug
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionPaymentSent":
        ...
        return MessageActionPaymentSent(flags=flags, total_amount=total_amount, recurring_used=recurring_used)
