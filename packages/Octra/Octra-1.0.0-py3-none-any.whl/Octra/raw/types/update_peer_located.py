...
class UpdatePeerLocated(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        peers (List of :obj:`PeerLocated> <Octra.raw.base.PeerLocated>>`):
            N/A
    ...
    def __init__(self, *, peers: List["raw.base.PeerLocated>"]) -> None:
        self.peers = peers  # t.me/TheVenomXD Vector<PeerLocated> 
