...
class Contacts(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        contacts (List of :obj:`Contact> saved_coun <Octra.raw.base.Contact> saved_coun>`):
            N/A
    ...
    def __init__(self, *, contacts: List["raw.base.Contact> saved_coun"], users: List["raw.base.User>"]) -> None:
        self.contacts = contacts  # t.me/TheVenomXD Vector<Contact> saved_count
