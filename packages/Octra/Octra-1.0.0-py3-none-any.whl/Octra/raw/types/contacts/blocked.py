...
class Blocked(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        blocked (List of :obj:`PeerBlocked> chat <Octra.raw.base.PeerBlocked> chat>`):
            N/A
    ...
    def __init__(self, *, blocked: List["raw.base.PeerBlocked> chat"], users: List["raw.base.User>"]) -> None:
        self.blocked = blocked  # t.me/TheVenomXD Vector<PeerBlocked> chats
