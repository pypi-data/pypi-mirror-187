...
class InputPrivacyValueDisallowUsers(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        users (List of :obj:`InputUser> <Octra.raw.base.InputUser>>`):
            N/A
    ...
    def __init__(self, *, users: List["raw.base.InputUser>"]) -> None:
        self.users = users  # t.me/TheVenomXD Vector<InputUser> 
