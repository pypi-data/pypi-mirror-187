...
class DefaultHistoryTTL(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.DefaultHistoryTTL`.
    ...
    Parameters:
        period (:obj:`int  <Octra.raw.base.int >`):
            N/A
    ...
    def __init__(self, *, period: "raw.base.int ") -> None:
        self.period = period  # t.me/TheVenomXD int 
