...
class DraftMessageEmpty(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD date") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "DraftMessageEmpty":
        ...
        return DraftMessageEmpty(flags=flags)
