...
class SavedRingtoneConverted(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.account.SavedRingtone`.
    ...
    Parameters:
        document (:obj:`Document  <Octra.raw.base.Document >`):
            N/A
    ...
    def __init__(self, *, document: "raw.base.Document ") -> None:
        self.document = document  # t.me/TheVenomXD Document 
