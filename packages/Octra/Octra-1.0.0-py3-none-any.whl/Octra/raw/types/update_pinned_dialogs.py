...
class UpdatePinnedDialogs(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        order (List of :obj:`DialogPeer> <Octra.raw.base.DialogPeer>>`, *optional*):
            N/A
    ...
    def __init__(self, *, flags: "raw.base.# t.me/TheVenomXD folder_id", order: Optional[List["raw.base.DialogPeer>"]] = None) -> None:
        self.flags = flags  # t.me/TheVenomXD # t.me/TheVenomXD folder_id
        self.order = order  # t.me/TheVenomXD flags.0?Vector<DialogPeer> 
