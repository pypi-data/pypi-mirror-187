...
class PageBlockOrderedList(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        items (List of :obj:`PageListOrderedItem> <Octra.raw.base.PageListOrderedItem>>`):
            N/A
    ...
    def __init__(self, *, items: List["raw.base.PageListOrderedItem>"]) -> None:
        self.items = items  # t.me/TheVenomXD Vector<PageListOrderedItem> 
