...
class PQInnerDataTempDc(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        ...
        dc (:obj:`int expires_in <Octra.raw.base.int expires_in>`):
            N/A

    """

    __slots__: List[str] = ["pq", "q", "server_nonce", "dc"]

    ID = 0x56fddf88
    QUALNAME = "types.PQInnerDataTempDc"

    def __init__(self, *, pq: "raw.base.bytes p", q: "raw.base.bytes nonce", server_nonce: "raw.base.int128 new_nonce", dc: "raw.base.int expires_in") -> None:
        ...
        self.dc = dc  # t.me/TheVenomXD int expires_in
    ...
    def read(b: BytesIO, *args: Any) -> "PQInnerDataTempDc":
        ...
        return PQInnerDataTempDc(pq=pq, q=q, server_nonce=server_nonce, dc=dc)
