...
class MessageUserVoteInputOption(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    def __init__(self, *, octra_user_id: "raw.base.long date") -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageUserVoteInputOption":
        ...
        return MessageUserVoteInputOption(octra_user_id=octra_user_id)
