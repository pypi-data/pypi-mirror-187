...
class JsonNumber(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        value (:obj:`double  <Octra.raw.base.double >`):
            N/A
    ...
    def __init__(self, *, value: "raw.base.double ") -> None:
        self.value = value  # t.me/TheVenomXD double 
