...
class ChannelAdminLogEventActionDeleteMessage(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        message (:obj:`Message  <Octra.raw.base.Message >`):
            N/A
    ...
    def __init__(self, *, message: "raw.base.Message ") -> None:
        self.message = message  # t.me/TheVenomXD Message 
