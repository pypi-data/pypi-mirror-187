...
class SuggestedShortName(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.

    Constructor of :obj:`~Octra.raw.base.stickers.SuggestedShortName`.
    ...
    Parameters:
        short_name (:obj:`string  <Octra.raw.base.string >`):
            N/A
    ...
    def __init__(self, *, short_name: "raw.base.string ") -> None:
        self.short_name = short_name  # t.me/TheVenomXD string 
