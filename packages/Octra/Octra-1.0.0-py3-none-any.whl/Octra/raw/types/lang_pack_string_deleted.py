...
class LangPackStringDeleted(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        key (:obj:`string  <Octra.raw.base.string >`):
            N/A
    ...
    def __init__(self, *, key: "raw.base.string ") -> None:
        self.key = key  # t.me/TheVenomXD string 
