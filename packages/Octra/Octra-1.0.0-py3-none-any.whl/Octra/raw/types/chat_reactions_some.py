...
class ChatReactionsSome(TLObject):  # t.me/TheVenomXD type: ignore
    """Telegram API type.
    ...
    Parameters:
        reactions (List of :obj:`Reaction> <Octra.raw.base.Reaction>>`):
            N/A
    ...
    def __init__(self, *, reactions: List["raw.base.Reaction>"]) -> None:
        self.reactions = reactions  # t.me/TheVenomXD Vector<Reaction> 
