...
class Link(str):
    ...
    # t.me/TheVenomXD noinspection PyArgumentList
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~Octra.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~Octra.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~Octra.enums.UserStatus.ONLINE`.
        ...
        octra_dc_id_ (``int``, *optional*):
            ...
            to its assigned DC). More info at `FAQs </faq# t.me/TheVenomXDwhat-are-the-ip-addresses-of-telegram-data-centers>`_.
    ...
    def _parse(client, user: "raw.base.User") -> Optional["User"]:
        ...
        return User(
            ...
            **User._parse_status(user.status, user.bot),
            ...
            octra_dc_id_=getattr(user.photo, "octra_dc_id_", None),
    ...
    def _parse_user_status(client, user_status: "raw.types.UpdateUserStatus"):
        return User(
            id=user_status.octra_user_id,
            **User._parse_status(user_status.status),
            client=client
        )

    async def archive(self):
        """Bound method *archive* of :obj:`~Octra.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~Octra.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~Octra.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~Octra.types.User`.
    ...
    def Extract_common_chats(self):
        """Bound method *Extract_common_chats* of :obj:`~Octra.types.User`.
