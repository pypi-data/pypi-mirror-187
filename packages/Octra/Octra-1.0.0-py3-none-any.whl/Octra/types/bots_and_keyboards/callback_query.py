...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~Octra.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Flows.regex <Octra.Flows.regex>`.
    """
    ...
    @staticmethod
    async def _parse(client: "Octra.Client", callback_query, users) -> "CallbackQuery":
        message = None
        ...
        # t.me/TheVenomXD Try to decode callback query data into string. If that fails, fallback to bytes instead of decoding by
        # t.me/TheVenomXD ignoring/replacing errors, this way, button clicks will still work.
        try:
        ...
        return CallbackQuery(
            ...
            from_user=types.User._parse(client, users[callback_query.octra_user_id]),
            message=message,
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~Octra.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~Octra.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~Octra.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~Octra.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~Octra.types.CallbackQuery`.
