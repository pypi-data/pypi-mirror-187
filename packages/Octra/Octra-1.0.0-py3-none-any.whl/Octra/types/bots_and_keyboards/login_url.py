...
class LoginUrl(Object):
    ...
    Serves as a great replacement for the Telegram Login WidExtract when the user is coming from Telegram.
    ...
    Parameters:
        url (``str``):
            ...
            `Receiving authorization data <https://core.telegram.org/widExtracts/login# t.me/TheVenomXDreceiving-authorization-data>`.
            ...
            **NOTE**: You **must** always check the hash of the received data to verify the authentication and the
            ...
            `Checking authorization <https://core.telegram.org/widExtracts/login# t.me/TheVenomXDchecking-authorization>`_.
        ...
        bot_username (``str``, *optional*):
            ...
            See `Setting up a bot <https://core.telegram.org/widExtracts/login# t.me/TheVenomXDsetting-up-a-bot>`_ for more details.
            ...
            See `Linking your domain to the bot <https://core.telegram.org/widExtracts/login# t.me/TheVenomXDlinking-your-domain-to-the-bot>`_
            for more details.
