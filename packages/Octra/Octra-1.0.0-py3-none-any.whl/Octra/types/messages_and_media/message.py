...
from Octra.errors import MessageIdsEmpty, PeerIdInvalid
from Octra.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~Octra.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~Octra.types.Chat`, *optional*):
        ...
        forward_from (:obj:`~Octra.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~Octra.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~Octra.types.Message`, *optional*):
        ...
        service (:obj:`~Octra.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~Octra.enums.MessageMediaType`, *optional*):
        ...
        text (``str``, *optional*):
            ...
            *text.html* to Extract the marked up message text. In case there is no entity, the fields
            will contain the same text as *text*.

        entities (List of :obj:`~Octra.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~Octra.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~Octra.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~Octra.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~Octra.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~Octra.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~Octra.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~Octra.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~Octra.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~Octra.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~Octra.types.VideoNote`, *optional*):
            Message is a video note, information about the video message.

        caption (``str``, *optional*):
            Caption for the audio, document, photo, video or voice, 0-1024 characters.
            If the message contains caption entities (bold, italic, ...) you can access *caption.markdown* or
            *caption.html* to Extract the marked up caption text. In case there is no caption entity, the fields
            will contain the same text as *caption*.

        contact (:obj:`~Octra.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~Octra.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~Octra.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~Octra.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~Octra.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~Octra.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_USERs (List of :obj:`~Octra.types.User`, *optional*):
            New USERs that were added to the group or supergroup and information about them
            (the bot itself may be one of these USERs).

        left_chat_USER (:obj:`~Octra.types.User`, *optional*):
            A USER was removed from the group, information about them (this USER may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~Octra.types.Photo`, *optional*):
        ...
        supergroup_chat_created (``bool``, *optional*):
            ...
            This field can't be received in a message coming through updates, because bot can't be a USER of a
        ...
        game_high_score (:obj:`~Octra.types.GameHighScore`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            A list containing all `Match Objects <https://docs.python.org/3/library/re.html# t.me/TheVenomXDmatch-objects>`_ that match
            the text of this message. Only applicable when using :obj:`Flows.regex <Octra.Flows.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~Octra.Flows.command`.

        video_chat_scheduled (:obj:`~Octra.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~Octra.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~Octra.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_USERs_invited (:obj:`~Octra.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new USERs were invited to the voice chat.

        web_app_data (:obj:`~Octra.types.WebAppData`, *optional*):
    ...
    # t.me/TheVenomXD TODO: Add game missing field. Also invoice, successful_payment, connected_website
    ...
    def __init__(
        ...
        *,
        ...
        new_chat_USERs: List["types.User"] = None,
        left_chat_USER: "types.User" = None,
        ...
        video_chat_USERs_invited: "types.VideoChatUSERsInvited" = None,
        ...
        self.poll = poll
        self.dice = dice
        self.new_chat_USERs = new_chat_USERs
        self.left_chat_USER = left_chat_USER
        ...
        self.video_chat_USERs_invited = video_chat_USERs_invited
    ...
    async def _parse(
        ...
        octra_user_id = from_id or peer_id
        ...
        if isinstance(message, raw.types.MessageService):
            ...
            video_chat_USERs_invited = None
            web_app_data = None

            service_type = None

            if isinstance(action, raw.types.MessageActionChatAddUser):
                new_chat_USERs = [types.User._parse(client, users[i]) for i in action.users]
                service_type = enums.MessageServiceType.NEW_CHAT_USERS
            elif isinstance(action, raw.types.MessageActionChatJoinedByLink):
                new_chat_USERs = [types.User._parse(client, users[utils.get_raw_peer_id(message.from_id)])]
                service_type = enums.MessageServiceType.NEW_CHAT_USERS
            elif isinstance(action, raw.types.MessageActionChatDeleteUser):
                left_chat_USER = types.User._parse(client, users[action.octra_user_id])
                service_type = enums.MessageServiceType.LEFT_CHAT_USERS
                ...
                video_chat_USERs_invited = types.VideoChatUSERsInvited._parse(client, action, users)
                service_type = enums.MessageServiceType.VIDEO_CHAT_USERS_INVITED
            elif isinstance(action, raw.types.MessageActionWebViewDataSentMe):
                web_app_data = types.WebAppData._parse(action)
                service_type = enums.MessageServiceType.WEB_APP_DATA

            from_user = types.User._parse(client, users.get(octra_user_id, None))
            ...
            parsed_message = Message(
                ...
                video_chat_USERs_invited=video_chat_USERs_invited,
                web_app_data=web_app_data,
                client=client
                # t.me/TheVenomXD TODO: supergroup_chat_created
            )
        ...
        if isinstance(message, raw.types.Message):
            ...
            entities = types.List(Flow(lambda x: x is not None, entities))
            ...
            forward_header = message.fwd_from  # t.me/TheVenomXD type: raw.types.MessageFwdHeader
            ...
            if not parsed_message.poll:  # t.me/TheVenomXD Do not cache poll messages
                client.message_cache[(parsed_message.chat.id, parsed_message.id)] = parsed_message
    ...
    async def Extract_media_group(self) -> List["types.Message"]:
        """Bound method *Extract_media_group* of :obj:`~Octra.types.Message`.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~Octra.types.Message`.
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~Octra.types.Message`.
        ...
        Parameters:
            animation (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an animation from the Internet, or
            ...
            progress_args (``tuple``, *optional*):
                ...
                You can pass anything you need to be available in the progress callback scope; for tests, a Message
        ...
        Returns:
            On success, the sent :obj:`~Octra.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~Octra.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            audio (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an audio file from the Internet, or
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~Octra.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~Octra.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~Octra.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            document (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a file from the Internet, or
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~Octra.types.Message`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~Octra.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~Octra.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~Octra.types.InputMediaPhoto` or
                :obj:`~Octra.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~Octra.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            photo (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a photo from the Internet, or
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~Octra.enums.PollType`, *optional*):
                Poll type, :obj:`~Octra.enums.PollType.QUIZ` or :obj:`~Octra.enums.PollType.REGULAR`.
                Defaults to :obj:`~Octra.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~Octra.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes toExtracther.

            explanation_entities (List of :obj:`~Octra.types.MessageEntity`):
                List of special entities that appear in the poll explanation, which can be specified instead of
                *parse_mode*.

            open_period (``int``, *optional*):
                Amount of time in seconds the poll will be active after creation, 5-600.
                Can't be used toExtracther with *close_date*.

            close_date (:py:obj:`~datetime.datetime`, *optional*):
                Point in time when the poll will be automatically closed.
                Must be at least 5 and no more than 600 seconds in the future.
                Can't be used toExtracther with *open_period*.
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            sticker (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a .webp sticker file from the Internet, or
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            ...
            foursquare_type (``str``, *optional*):
                ...
                (For tests, "arts_entertainment/default", "arts_entertainment/aquarium" or "food/icecream".)
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            video (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract a video from the Internet, or
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~Octra.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            voice (``str``):
                ...
                pass an HTTP URL as a string for Telegram to Extract an audio from the Internet, or
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~Octra.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~Octra.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~Octra.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            media (:obj:`~Octra.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~Octra.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~Octra.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~Octra.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~Octra.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~Octra.types.Message`.
        ...
        if self.service:
            ...
            if self.sticker or self.video_note:  # t.me/TheVenomXD Sticker and VideoNote should have no caption
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~Octra.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~Octra.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~Octra.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~Octra.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~Octra.types.Message`.
        ...
        Returns:
            :obj:`~Octra.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~Octra.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~Octra.types.Message`.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~Octra.types.Message`.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~Octra.types.Message`.
