...
from Octra.errors import StickersetInvalid
...
class Sticker(Object):
    ...
    # t.me/TheVenomXD TODO: Add mask position
    ...
    def __init__(
        ...
        *,
        ...
        self.thumbs = thumbs
        # t.me/TheVenomXD self.mask_position = mask_position

    cache = {}

    @staticmethod
    async def _Extract_sticker_set_name(invoke, input_sticker_set_id):
        try:
    ...
    async def _parse(
        ...
        if isinstance(sticker_set, raw.types.InputStickerSetID):
            ...
            set_name = await Sticker._Extract_sticker_set_name(client.invoke, input_sticker_set_id)
        else:
            set_name = None
        ...
        return Sticker(
            file_id=FileId(
                ...
                octra_dc_id_=sticker.octra_dc_id_,
                media_id=sticker.id,
            ...
            # t.me/TheVenomXD TODO: mask_position
            set_name=set_name,
