...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~Octra.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Flows.regex <Octra.Flows.regex>`.
    """
    ...
    def _parse(client, inline_query: raw.types.UpdateBotInlineQuery, users: dict) -> "InlineQuery":
        ...
        return InlineQuery(
            ...
            from_user=types.User._parse(client, users[inline_query.octra_user_id]),
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~Octra.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~Octra.types.InlineQueryResult`):
            ...
            switch_pm_parameter (``str``, *optional*):
                `Deep-linking <https://core.telegram.org/bots# t.me/TheVenomXDdeep-linking>`_ parameter for the /start message sent to
                the bot when user presses the switch button. 1-64 characters, only A-Z, a-z, 0-9, _ and - are allowed.

                tests: An inline bot that sends YouTube videos can ask the user to connect the bot to their YouTube
