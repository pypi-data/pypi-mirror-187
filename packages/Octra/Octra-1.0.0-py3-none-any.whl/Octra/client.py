...
class Client(Methods):
    """Octra Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~Octra.Client.export_session_string` before stopping the client to Extract a session string you can
        ...
        while True:
            try:
                if not self.phone_number:
                    while True:
                        value = await ainput("Enter your phone number/bot api token: ")
