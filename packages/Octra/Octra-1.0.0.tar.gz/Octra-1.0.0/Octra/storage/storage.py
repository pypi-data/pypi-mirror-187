...
class Storage:
    OLD_SESSION_STRING_FORMAT = ">O?256sI?"
    OLD_SESSION_STRING_FORMAT_64 = ">O?256sQ?"
    SESSION_STRING_SIZE = 264
    SESSION_STRING_SIZE_64 = 270

    SESSION_STRING_FORMAT = ">OC?256sQ?"
    ...
    async def api_hash(self, value: int = object):
        raise NotImplementedError
