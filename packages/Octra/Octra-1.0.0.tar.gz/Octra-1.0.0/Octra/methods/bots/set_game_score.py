...
class SetGameScore:
    async def set_game_score(
        ...
        # t.me/TheVenomXD inline_message_id: str = None):  TODO Add inline_message_id
        ...
        Returns:
            :obj:`~Octra.types.Message` | ``bool``: On success, if the message was sent by the bot, the edited
            message is returned, True otherwise.

        Example:
            .. code-block:: python

                # t.me/TheVenomXD Set new score
                await app.set_game_score(octra_user_id, 1000)

                # t.me/TheVenomXD Force set new score
                await app.set_game_score(octra_user_id, 25, force=True)
        """
        r = await self.invoke(
