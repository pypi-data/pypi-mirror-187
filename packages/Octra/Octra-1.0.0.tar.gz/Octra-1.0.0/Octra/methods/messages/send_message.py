...
import Octra
from Octra import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~Octra.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # t.me/TheVenomXD Simple example
                await app.send_message("me", "Message sent with **Octra**!")

                # t.me/TheVenomXD Disable web page previews
                await app.send_message("me", "https://docs.Octra.org",
                    disable_web_page_preview=True)

                # t.me/TheVenomXD Reply to a message using its id
                await app.send_message("me", "this is a reply", reply_to_message_id=123)

            .. code-block:: python

                # t.me/TheVenomXD For bots only, send messages with keyboards attached

                from Octra.types import (
                    ReplyKeyboardMarkup, InlineKeyboardMarkup, InlineKeyboardButton)

                # t.me/TheVenomXD Send a normal keyboard
                await app.send_message(
                    chat_id, "Look at that button!",
                    reply_markup=ReplyKeyboardMarkup([["Nice!"]]))

                # t.me/TheVenomXD Send an inline keyboard
                await app.send_message(
                    chat_id, "These are inline buttons",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [InlineKeyboardButton("Data", callback_data="callback_data")],
                            [InlineKeyboardButton("Docs", url="https://docs.Octra.org")]
                        ]))
        """
