...
class ExtractChatAdminInviteLinksCount:
    async def Extract_chat_admin_invite_links_count(
        self: "Octra.Client",
        chat_id: Union[int, str],
        admin_id: Union[int, str],
        revoked: bool = False,
    ) -> int:
        """Extract the count of the invite links created by an administrator in a chat.
