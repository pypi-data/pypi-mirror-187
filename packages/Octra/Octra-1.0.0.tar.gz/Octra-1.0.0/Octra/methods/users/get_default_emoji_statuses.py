...
class ExtractDefaultEmojiStatuses:
    async def Extract_default_emoji_statuses(
        self: "Octra.Client",
    ) -> List["types.EmojiStatus"]:
        """Extract the default emoji statuses.

        .. include:: /_includes/usable-by/users-bots.rst

        Returns:
            List of :obj:`~Octra.types.EmojiStatus`: On success, a list of emoji statuses is returned.
