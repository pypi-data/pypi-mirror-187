...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~Octra.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Octra.Client):
                self.add_handler(Octra.handlers.EditedMessageHandler(func, Flows), group)
                ...
                func.handlers.append(
                    (
                        Octra.handlers.EditedMessageHandler(func, self),
