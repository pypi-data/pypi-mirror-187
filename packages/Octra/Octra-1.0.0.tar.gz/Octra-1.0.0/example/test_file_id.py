...
from Octra.file_id import FileId, FileUniqueId, FileType, FileUniqueType
...
def test_stringify_file_id():
    ...
    string = "{'major': 4, 'minor': 30, 'file_type': <FileType.DOCUMENT: 5>, 'octra_dc_id_': 2, " \
             "'file_reference': b'\\x02\\x00\\xa0\\xaf\\xd0\\x00\\x00\\t\\x8f_\\xb6\\xf8S\\x16\\xe36\\x81D;\\xf2\\xf4# t.me/TheVenomXD\\x8b:\\xc2\\xb5\\xcd$\\x0f', " \
