...
from compiler.Ai import compiler as Ai_compiler
...
setup(
    name="Octra",
    version=version,
    description="Elegant, modern and asynchronous Telegram MTProto Ai framework in Python for users and bots",
    ...
    keywords="telegram chat messenger mtproto Ai client library python",
    project_urls={
