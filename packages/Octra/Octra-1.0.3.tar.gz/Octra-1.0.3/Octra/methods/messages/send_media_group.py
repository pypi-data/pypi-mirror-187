...
class SendMediaGroup:
    # t.me/TheVenomXD TODO: Add progress parameter
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~Octra.types.InputMediaPhoto`, :obj:`~Octra.types.InputMediaVideo`, :obj:`~Octra.types.InputMediaAudio` and :obj:`~Octra.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~Octra.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from Octra.types import InputMediaPhoto, InputMediaVideo
        ...
        return await utils.parse_messages(
            ...
            raw.types.messages.Messages(
                messages=[m.message for m in Flow(
