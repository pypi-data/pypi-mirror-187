...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~Octra.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Octra.Client):
                self.add_handler(Octra.handlers.ChatJoinRequestHandler(func, Flows), group)
                ...
                func.handlers.append(
                    (
                        Octra.handlers.ChatJoinRequestHandler(func, self),
