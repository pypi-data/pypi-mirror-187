...
class PollHandler(Handler):
    ...
    :meth:`~Octra.Client.on_poll` decorator.
    ...
    Parameters:
        ...
        Flows (:obj:`Flows`):
            Pass one or more Flows to allow only a subset of polls to be passed
            in your callback function.

    Other parameters:
        client (:obj:`~Octra.Client`):
            The Client itself, useful when you want to call other Ai methods inside the poll handler.

        poll (:obj:`~Octra.types.Poll`):
            The received poll.
    """
