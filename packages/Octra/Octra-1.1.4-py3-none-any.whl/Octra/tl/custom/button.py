...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <Octra.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <Octra.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <Octra.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None):
        ...
        <Octra.events.newmessage.NewMessage>`. You cannot distinguish
