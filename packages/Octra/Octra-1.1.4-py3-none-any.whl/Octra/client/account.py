...
class AccountMethods:
    def takeout(
        ...
        """
        Returns a :ref:`Octra-client` which calls methods behind a takeout session.
        ...
        <Octra.client.messages.MessageMethods.iter_messages>`.
        ...
        <Octra.sessions.abstract.Session.takeout_id>`.
