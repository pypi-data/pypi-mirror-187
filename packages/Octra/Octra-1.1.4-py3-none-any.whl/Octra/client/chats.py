...
class ChatMethods:
    ...
    def iter_participants(
        ...
        Example
            .. code-block:: python
                ...
                # Filter by admins
                from Octra.tl.types import ChannelParticipantsAdmins
    ...
    def iter_admin_log(
        ...
        *all* event types will be returned. If at least one of them is
        ...
        Yields
            Instances of `AdminLogEvent <Octra.tl.custom.adminlogevent.AdminLogEvent>`.
    ...
    async def kick_participant(
        ...
        Returns
            Returns the service `Message <Octra.tl.custom.message.Message>`
    ...
    async def get_permissions(
        ...
        Returns
            A `ParticipantPermissions <Octra.tl.custom.participantpermissions.ParticipantPermissions>`
    ...
    async def get_stats(
        ...
        Raises
            ...
            ``Octra.errors.ChatAdminRequiredError`` will appear.
