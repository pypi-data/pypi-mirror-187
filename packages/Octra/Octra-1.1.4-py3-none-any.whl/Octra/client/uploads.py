...
def _resize_photo_if_needed(
    ...
    try:
        ...
        # See https://github.com/LonamiWebs/Octra/issues/1121 for more.
...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            reply_to (`int` | `Message <Octra.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <Octra.tl.custom.message.Message>` (or messages)
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <Octra.tl.custom.inputsizedfile.InputSizedFile>`
