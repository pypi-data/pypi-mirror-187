...
LastEditTime : 2023-01-20 12:52:08
LastEditors  : BDFD
Description  : 
...
def pre_greenampt(original_input):
    ...
    result = wes.greenampt(function_input["thetai"], function_input["thetas"], function_input["Psi"], function_input["K"], function_input["dti"], function_input["nin"], function_input["dd"], function_input["i"], function_input["iyesno"], function_input["ss1"], function_input["ss2"], function_input["ss3"])
