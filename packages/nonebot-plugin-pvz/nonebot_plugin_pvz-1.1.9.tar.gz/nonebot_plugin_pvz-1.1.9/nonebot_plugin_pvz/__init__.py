...
import asyncio
import os
from nonebot_plugin_pvz.config import Config
...
async def _():
    ...
    await _help.finish(
        MessageSegment.image("file:///" / PVZ_OUTPUT_PATH / "help.png") + MessageSegment.text("更详细的命令可以参考https://github.com/longchengguxiao/nonebot_plugin_pvz#%E5%91%BD%E4%BB%A4%E8%AF%A6%E8%A7%A3"), at_sender=True)
