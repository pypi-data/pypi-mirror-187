...
class RawMessage(object):
    ...
    def __new__(cls, net_pointer: c_void_p):
        ...
        instance = RawMessage._RawMessage__weakrefs.get(net_pointer.value)
        if instance is None:
            instance = super(RawMessage, cls).__new__(cls)
            RawMessage._RawMessage__weakrefs[net_pointer.value] = instance
    ...
    def __init__(self, net_pointer: c_void_p):
        ...
        RawMessage:
            Instance wrapping the .net type RawMessage
        """
        if '_RawMessage__pointer' in dir(self):
            return
    ...
    def __finalizerfunc(self):
        del RawMessage._RawMessage__weakrefs[self.__pointer.value]
    ...
    __interop_func = InteropUtils.get_function("rawmessage_constructor")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p, c_void_p]
    @staticmethod
    def Constructor(key: str, value: c_void_p) -> c_void_p:
        """
        Parameters
        ----------
        ...
        result = InteropUtils.invoke("rawmessage_constructor", key_ptr, value)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_constructor2")
    __interop_func.restype = c_void_p
    ...
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_get_metadata")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Metadata(self) -> c_void_p:
        ...
        """
        result = InteropUtils.invoke("rawmessage_get_metadata", self.__pointer)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_get_key")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Key(self) -> str:
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("rawmessage_get_key", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_set_key")
    ...
    def set_Key(self, value: str) -> None:
        ...
        InteropUtils.invoke("rawmessage_set_key", self.__pointer, value_ptr)
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_get_value")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Value(self) -> c_void_p:
        ...
        c_void_p:
            GC Handle Pointer to .Net type byte[]
        """
        result = InteropUtils.invoke("rawmessage_get_value", self.__pointer)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("rawmessage_set_value")
    __interop_func.restype = None
    __interop_func.argtypes = [c_void_p, c_void_p]
    def set_Value(self, value: c_void_p) -> None:
        ...
        None:
            Underlying .Net type is void
        """
        InteropUtils.invoke("rawmessage_set_value", self.__pointer, value)
