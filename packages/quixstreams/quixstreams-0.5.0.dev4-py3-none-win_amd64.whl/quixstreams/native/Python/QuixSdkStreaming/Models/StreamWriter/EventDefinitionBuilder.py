...
from ....QuixSdkProcess.Models.EventLevel import EventLevel
...
class EventDefinitionBuilder(object):
    ...
    def __new__(cls, net_pointer: c_void_p):
        ...
        instance = EventDefinitionBuilder._EventDefinitionBuilder__weakrefs.get(net_pointer.value)
        if instance is None:
            instance = super(EventDefinitionBuilder, cls).__new__(cls)
            EventDefinitionBuilder._EventDefinitionBuilder__weakrefs[net_pointer.value] = instance
    ...
    def __init__(self, net_pointer: c_void_p):
        ...
        EventDefinitionBuilder:
            Instance wrapping the .net type EventDefinitionBuilder
        """
        if '_EventDefinitionBuilder__pointer' in dir(self):
            return
    ...
    def __finalizerfunc(self):
        del EventDefinitionBuilder._EventDefinitionBuilder__weakrefs[self.__pointer.value]
    ...
    __interop_func = InteropUtils.get_function("eventdefinitionbuilder_constructor")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p, c_void_p, c_void_p]
    @staticmethod
    def Constructor(streamEventsWriter: c_void_p, location: str, properties: c_void_p = None) -> c_void_p:
        """
        Parameters
        ----------
        ...
        result = InteropUtils.invoke("eventdefinitionbuilder_constructor", streamEventsWriter, location_ptr, properties)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinitionbuilder_setlevel")
    __interop_func.restype = c_void_p
    ...
    def SetLevel(self, level: EventLevel) -> c_void_p:
        ...
        c_void_p:
            GC Handle Pointer to .Net type EventDefinitionBuilder
        """
        result = InteropUtils.invoke("eventdefinitionbuilder_setlevel", self.__pointer, level.value)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinitionbuilder_setcustomproperties")
    __interop_func.restype = c_void_p
    ...
    def SetCustomProperties(self, customProperties: str) -> c_void_p:
        ...
        result = InteropUtils.invoke("eventdefinitionbuilder_setcustomproperties", self.__pointer, customProperties_ptr)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinitionbuilder_adddefinition")
    __interop_func.restype = c_void_p
    ...
    def AddDefinition(self, eventId: str, name: str = None, description: str = None) -> c_void_p:
        ...
        result = InteropUtils.invoke("eventdefinitionbuilder_adddefinition", self.__pointer, eventId_ptr, name_ptr, description_ptr)
        result_ptr = ctypes.c_void_p(result) if result is not None else None
        return result_ptr
