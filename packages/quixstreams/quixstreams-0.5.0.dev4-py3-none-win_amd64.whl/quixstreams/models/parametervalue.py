...
class ParameterValue(object):
    ...
    def __init__(self, net_pointer: ctypes.c_void_p):
        ...
        self.__interop = pvi(net_pointer)

        self._type = ec.enum_to_another(self.__interop.get_Type(), ParameterValueType)
        self._binary = None
        self._numeric = None
        self._string = None
        self._binary = None
        if self._type == ParameterValueType.Binary:
            val_uptr = self.__interop.get_BinaryValue()
            ...
            self._string = self.__interop.get_StringValue()
            self._value = self._string
        elif self._type == ParameterValueType.Numeric:
            self._numeric = self.__interop.get_NumericValue()
    ...
    def numeric_value(self, value: float):
        ...
        self._numeric = value
        self._value = value
        self.__interop.set_NumericValue(value)
    ...
    def string_value(self, value: str):
        ...
        self._string = value
        self._value = value
        self.__interop.set_StringValue(value)
    ...
    def binary_value(self, value: Union[bytearray, bytes]):
        ...
        try:
            self.__interop.set_BinaryValue(uptr)
        finally:
