...
class EventDefinition(object):
    ...
    __interop_func = InteropUtils.get_function("eventdefinition_constructor")
    ...
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_id")
    __interop_func.restype = c_void_p
    ...
    def get_Id(self) -> str:
        ...
        """
        result = InteropUtils.invoke("eventdefinition_get_id", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_name")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Name(self) -> str:
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("eventdefinition_get_name", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_description")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Description(self) -> str:
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("eventdefinition_get_description", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_location")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_Location(self) -> str:
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("eventdefinition_get_location", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_customproperties")
    __interop_func.restype = c_void_p
    __interop_func.argtypes = [c_void_p]
    def get_CustomProperties(self) -> str:
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("eventdefinition_get_customproperties", self.__pointer)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    
    # ctypes function return type//parameter fix
    __interop_func = InteropUtils.get_function("eventdefinition_get_level")
    ...
    def get_Level(self) -> EventLevel:
        ...
        """
        result = InteropUtils.invoke("eventdefinition_get_level", self.__pointer)
        return result
