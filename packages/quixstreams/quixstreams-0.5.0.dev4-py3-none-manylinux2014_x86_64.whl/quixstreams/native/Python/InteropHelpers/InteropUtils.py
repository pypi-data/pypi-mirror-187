...
class InteropUtils(object):
    ...
    @staticmethod
    def invoke_and_free(hptr: ctypes.c_void_p, func, *args):
        """
    ...
    def create_nullable(underlying_ctype):
        """
        Create a nullable type that is equivalent for serialization purposes to a nullable c# type
        ...
        temp_nullable = type("Nullable_"+underlying_ctype.__name__, (ctypes.Structure, ), {
