...
class CommitOptions(object):
    def __init__(self, net_pointer: ctypes.c_void_p = None):
        ...
        if net_pointer is None:
            self.__interop = coi(coi.Constructor())
        else:
            self.__interop = coi(net_pointer)
    ...
    def auto_commit_enabled(self) -> bool:
        ...
        Default is True.
        """
        return self.__interop.get_AutoCommitEnabled()
    ...
    def auto_commit_enabled(self, value: bool) -> None:
        ...
        Default is True.
        """
        self.__interop.set_AutoCommitEnabled(value)
    ...
    def commit_interval(self) -> Optional[int]:
        ...
        """
        return self.__interop.get_CommitInterval()
    ...
    def commit_interval(self, value: Optional[int]) -> None:
        ...
        """
        self.__interop.set_CommitInterval(value)
    ...
    def commit_every(self) -> Optional[int]:
        ...
        """
        return self.__interop.get_CommitEvery()
    ...
    def commit_every(self, value: Optional[int]) -> None:
        ...
        """
        self.__interop.set_CommitEvery(value)
