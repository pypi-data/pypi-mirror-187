...
class StreamPropertiesWriter(object):
    ...
    def location(self, value: str):
        ...
        self.__interop.set_Location(value)
    ...
    def time_of_recording(self) -> datetime:
        ...
        hptr = self.__interop.get_TimeOfRecording()
    ...
    def time_of_recording(self, value: datetime):
        ...
        try:
            self.__interop.set_TimeOfRecording(hptr)
        finally:
    ...
    def flush_interval(self) -> int:
        """
            ...
            Defaults to 30000.
        """
        return self.__interop.get_FlushInterval()
    ...
    def flush_interval(self, value: int):
        ...
        """
        self.__interop.set_FlushInterval(value)
