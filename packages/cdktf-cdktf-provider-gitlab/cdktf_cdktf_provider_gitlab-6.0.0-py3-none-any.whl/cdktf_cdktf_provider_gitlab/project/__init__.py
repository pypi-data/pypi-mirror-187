...
class Project(
    ...
    def __init__(
        ...
        *,
        ...
        :param import_url: Git URL to a repository to be imported. Together with ``mirror = true`` it will setup a Pull Mirror. This can also be used together with ``forked_from_project_id`` to setup a Pull Mirror for a fork. The fork takes precedence over the import. This field cannot be imported via ``terraform import``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#import_url Project#import_url}
