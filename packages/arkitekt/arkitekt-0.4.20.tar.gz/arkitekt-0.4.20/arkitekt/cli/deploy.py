...
def generate_definitions(module_path: str = "hu") -> List[DefinitionInput]:
...
def generate_deployment(identifier: str, version: str, module_path: str, deployed: dict, deployer: str) -> Deployment:
    ...
    definitions = generate_definitions(module_path)

    deployment = Deployment(identifier=identifier, version=version, deployer=deployer, definitions=definitions, deployed=deployed)
