...
- y (number; default 100)"""
    ...
    _type = 'Connector'
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, stroke=Component.UNDEFINED, strokeWidth=Component.UNDEFINED, fill=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, r=Component.UNDEFINED, color=Component.UNDEFINED, pos_list=Component.UNDEFINED, path_list=Component.UNDEFINED, target_list=Component.UNDEFINED, target_pl_list=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'color', 'fill', 'path_list', 'pos_list', 'r', 'stroke', 'strokeWidth', 'target_list', 'target_pl_list', 'x', 'y']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'color', 'fill', 'path_list', 'pos_list', 'r', 'stroke', 'strokeWidth', 'target_list', 'target_pl_list', 'x', 'y']
