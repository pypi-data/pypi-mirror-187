...
def st_on_hover_tabs_venrup(tabName, iconName, styles=None, default_choice=1, key=None):
...
if not _RELEASE:
    ...
    with st.sidebar:
         tabs = st_on_hover_tabs_venrup(tabName=['Dashboard', 'Money', 'Economy'], 
