...
from cx_copilot import CXCopilot, GPTCompletionBlock, OpenAIEmbeddingBlock, PineconeVectorDBBlock, RedisCache, FrontConversationRepository
...
print(FrontConversationRepository('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzY29wZXMiOlsic2hhcmVkOioiXSwiaWF0IjoxNjc0NTMwMDM3LCJpc3MiOiJmcm9udCIsInN1YiI6IjA5MTg5MDgzYzNiYzg3ZDYwNzc5IiwianRpIjoiNGNmZmRiMWEwMjg0YWZhMiJ9.13x-dUnSpcbmKADvKj0fdKu--fYzydvy2kt5HmOmkaM').get_conversation_by_id('66281573714').threads)
