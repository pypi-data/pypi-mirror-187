...
from low_code_assistant import action, data, util
from low_code_assistant.assistant import drawer, mixpanel
from low_code_assistant.df_select import DfSelect
from low_code_assistant.hooks import use_reducer_addon
from low_code_assistant.serialize import dumps
from low_code_assistant.util import nb_locals
...
def TransformDrawer(action_state, set_code, dfs, open, edit, on_close, on_load_own_data, overwrite_warning=None):
    ...
    def pre_select_df():
        if open and df_var_name is None:
