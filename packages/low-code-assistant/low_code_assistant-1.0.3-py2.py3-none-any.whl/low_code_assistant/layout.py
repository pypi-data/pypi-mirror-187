...
import low_code_assistant.deploy
from low_code_assistant import app, css, util
from low_code_assistant.thumbnail import Thumbnail
    ...
    def group_obj_vars():
        def sort_vars(var):
            ...
            if isinstance(obj, plotly.graph_objs._figure.Figure) or (
                isinstance(obj, reacton.core.Element) and obj.component is solara.express.FigurePlotlyCrossFiltered
            ):
                return 0
...
Preview = low_code_assistant.deploy.Deployer
