...
class StockListView extends base_1.DOMWidgetView {
  ...
  `);
    ...
    render() {
        ...
        this.$el.find('ul.stock_symbol_list').on('click', 'button');
...
//# sourceMappingURL=lib_widgets_example_widget_js-lib_widgets_stock_list_widget_js-lib_widgets_stock_lookup_widget_js.01edd111a2ff3fb8b6b7.js.map