...
class StockListView extends base_1.DOMWidgetView {
  ...
  `);
    ...
    render() {
        ...
        this.model.on('change:stocks', this.onStocksChange, this);
        setInterval(() => {
...
//# sourceMappingURL=lib_widgets_example_widget_js-lib_widgets_stock_list_widget_js-lib_widgets_stock_lookup_widget_js.5545af0e7e9b47ac5a74.js.map