  ...
  `);
    ...
    render() {
        ...
        this.$el.find('ul.stock_symbol_list').on('click', 'button', (evt) => {
            ...
            this.send({ name: 'delete-stock', stock_symbol: stockSymbol });
            console.log(jquery_1.default(evt.target).attr('data-stock-symbol'));
        });
...
//# sourceMappingURL=lib_widgets_example_widget_js-lib_widgets_stock_list_widget_js-lib_widgets_stock_lookup_widget_js.04c73fb94e97c0ee9b27.js.map