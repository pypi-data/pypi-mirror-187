...
class StockListView extends base_1.DOMWidgetView {
  ...
  `);
    ...
    render() {
        ...
        this.model.on('change:stocks', this.onStocksChange);
        setInterval(() => {
...
//# sourceMappingURL=lib_widgets_example_widget_js-lib_widgets_stock_list_widget_js-lib_widgets_stock_lookup_widget_js.c27abf5c1f7d0e69eb87.js.map