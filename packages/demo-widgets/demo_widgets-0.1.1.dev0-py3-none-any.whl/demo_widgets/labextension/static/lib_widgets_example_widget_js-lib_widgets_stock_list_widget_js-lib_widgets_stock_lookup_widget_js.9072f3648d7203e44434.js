  ...
  `);
    ...
    render() {
        ...
        this.$el.find('ul.stock_symbol_list').on('click', 'button', (evt) => {
            console.log(evt.target.attr('data-stock-symbol'));
        });
...
//# sourceMappingURL=lib_widgets_example_widget_js-lib_widgets_stock_list_widget_js-lib_widgets_stock_lookup_widget_js.9072f3648d7203e44434.js.map