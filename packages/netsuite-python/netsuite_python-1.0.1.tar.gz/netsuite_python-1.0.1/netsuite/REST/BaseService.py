...
from netsuite_python.netsuite import NetsuiteToken, Netsuite
from netsuite_python.netsuite.REST.models import BaseDataModel
from netsuite_python.netsuite.exceptions import NetsuiteUnauthorizedException, NetsuiteForbiddenException
...
class BaseService:
    ...
    def restful_request(self, method: str, path: str, data: dict = None, params: dict = None):
        ...
        if response.status_code == 401:  # Unauthorized
            raise NetsuiteUnauthorizedException(fault)
        if response.status_code == 403:  # Forbidden
            raise NetsuiteForbiddenException(fault)
