...
from netsuite_python.netsuite.REST.V1.mixins import ModelMixin, DeleteMixin, RetrieveMixin, CreateCustomFieldMixin
from netsuite_python.netsuite.REST.models import Address, CustomField, PhoneNumber, SocialAccount, EmailAddress, DuplicateOption
