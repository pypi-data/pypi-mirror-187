...
def generate_client_config():
    ...
    netsuite_certificate_path = prompt("Netsuite Key Path", default=api_settings.defaults.get('NETSUITE_CERTIFICATE_PATH'))
    ...
    creds = {
        ...
        'NETSUITE_CERTIFICATE_PATH': netsuite_certificate_path,
        'APP_NAME': app_name,
