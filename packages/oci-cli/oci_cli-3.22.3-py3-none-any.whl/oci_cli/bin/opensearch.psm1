...
function GetOciCommandsToLongParams_opensearch() {
    $ociCommandsToLongParams = @{
        ...
        'opensearch cluster update' = 'defined-tags display-name force freeform-tags from-json help if-match max-wait-seconds opensearch-cluster-id software-version wait-for-state wait-interval-seconds'
