...
class Mcu(FunctionParams):
    ...
    theta: ParameterFloatType = pydantic.Field(
        default=0, description="Theta radian angle.", is_param=True
    )
    phi: ParameterFloatType = pydantic.Field(
        default=0, description="Phi radian angle.", is_param=True
    )
    lam: ParameterFloatType = pydantic.Field(
        default=0, description="Lambda radian angle.", is_param=True
    )
    gam: ParameterFloatType = pydantic.Field(
        default=0, description="gam radian angle.", is_param=True
    )
