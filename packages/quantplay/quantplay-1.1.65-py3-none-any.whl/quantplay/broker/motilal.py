...
class Motilal(Broker):
    ...
    def __init__(self, is_uat=False, headers=None, load_instruments=True, username=None, password=None, api_key=None,
        ...
        try:
            if headers:
                ...
                self.generate_token(username, password, api_key, two_fa, totp)
                self.get_orders()
    ...
    def generate_token(self, username, password, api_key, two_fa, totp):
        ...
        self.headers['ApiKey'] = api_key
        self.headers['vendorinfo'] = username
