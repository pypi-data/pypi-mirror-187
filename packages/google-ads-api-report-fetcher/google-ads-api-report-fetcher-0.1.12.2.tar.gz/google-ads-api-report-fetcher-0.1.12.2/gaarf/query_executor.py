...
class AdsReportFetcher:
    ...
    def fetch(self,
        ...
        optimize_strategy_enum = getattr(OptimizeStrategy, optimize_strategy)
    ...
    def _parse_ads_response(
        ...
        optimize_strategy: OptimizeStrategy = OptimizeStrategy.PROTOBUF
    ) -> List[List[Tuple[Any]]]:
        total_results: List[List[Tuple[Any]]] = []
        ...
        logger.info("Execution took: %d", end - start)
        return total_results

    def _parse_batch(self, parser, batch: Sequence["GoogleAdsRow"]):
...
class AdsQueryExecutor:
    ...
    def execute(self,
                ...
                optimize_performance: bool = False) -> None:
