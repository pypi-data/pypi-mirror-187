...
'''
    tmplt_evrnt_str_deploy_succeed = f'''<p style = "margin:0; padding:0; line-height:15px;">- {{value_str_namespace}}::{{value_str_deployment}} --> {{value_str_scaledup_podname}} ( {{value_str_response_scaledup}} )</p>'''
