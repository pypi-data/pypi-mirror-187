...
class Api():
    ...
    def __job_key_recent(self) -> str:
        ...
        return '' if len(resp['jobs']) == 0 else resp['jobs'][0]['jobKey']
    ...
    def database_tables_empty(self, name: str, tables: list, dry_run: bool = False) -> dict:
        ...
        d = {'tables': tables}
        url = f'{self.api_version}storage/{name}/empty-tables?dryRun={dry_run}'
        resp = self._fetch_json('post', url, json=d)
        return resp
