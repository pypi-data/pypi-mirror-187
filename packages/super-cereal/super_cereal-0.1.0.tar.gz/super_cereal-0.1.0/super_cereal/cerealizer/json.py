...
class JsonCerealizer(Cerealizer[T, JsonTypes]):
    def __init__(self, additional_cerealizers: typing.List[Cerealizer] = None) -> None:
        self.additional_cerealizers = additional_cerealizers if additional_cerealizers is not None else []
            ...
            if typing.get_origin(expected_type) in [typing.Union]:
                for t in typing.get_args(expected_type):
                    ...
                    if type(obj) == typing.get_origin(t):
                        return _serialize(obj, t)
            for addl_cerealizer in self.additional_cerealizers:
                if expected_type == addl_cerealizer.supported_types():
                    return addl_cerealizer.serialize(obj)
