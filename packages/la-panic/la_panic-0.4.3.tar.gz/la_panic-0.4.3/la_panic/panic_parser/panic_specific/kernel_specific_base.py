...
class KernelSpecificBase(object):
    ...
    def __init__(self, panic_infos: RawCrashStack, contains_crashed_core_info: bool):
        ...
        self.__cores_state = KernelSpecificBase.parse_cores_state(panic_infos, crashed_core_state)
    ...
    @staticmethod
    def parse_cores_state(panic_infos: RawCrashStack, crashed_core_state: Optional[CrashedCoreState]) -> List[CoreInfo]:
