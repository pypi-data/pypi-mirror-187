...
class ModelLoader():
    ...
    def update_model(self, model):
        ...
        while True:
            log.info('Sending request to update checkpoint with the param {}'.format(checkpoint_id))
            r = requests.post(f'{SERVER_URL}/api/endpoint/client/update_checkpoint', data={'user_id': USER_ID, 'token': TOKEN, 'endpoint_id': ENDPOINT_ID, 'checkpoint_id': checkpoint_id})
