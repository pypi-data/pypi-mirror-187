...
setup(
    ...
    description='A python package that helps you run TOPSIS (technique for order performance by similarity to ideal solution) for multi-criteria decision making',
    ...
    url='https://github.com/sakshamsood3/Topsis-Saksham-102017191',
