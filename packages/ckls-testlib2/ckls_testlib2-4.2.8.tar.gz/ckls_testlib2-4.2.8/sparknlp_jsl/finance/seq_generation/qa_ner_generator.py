...
class FinanceNerQuestionGenerator(A):
    """
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.sequence_generation.FinanceNerQuestionGenerator",
                 java_model=None):
        super(FinanceNerQuestionGenerator, self).__init__(
            classname=classname,
