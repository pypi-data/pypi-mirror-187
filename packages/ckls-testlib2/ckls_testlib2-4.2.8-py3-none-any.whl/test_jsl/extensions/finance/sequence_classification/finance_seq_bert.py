...
class FinanceSeqBertCase(unittest.TestCase):
    ...
    def test_pretrained_model(self):
        self.buildAndFitAndTest(
            fin.FinanceBertForSequenceClassification.pretrained("finclf_augmented_esg", "en", "finance/models").setInputCols(["document","token"]).setOutputCol("test_result"))
