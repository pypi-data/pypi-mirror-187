...
class FinanceAssertApproachCase(unittest.TestCase):
    spark = get_spark_session()

    train_data = spark.read.option("header", "true").csv(path=  "../src/test/resources/rsAnnotations-1-120-random.csv")
    ...
    def test_train_model(self):
        model = sparknlp_jsl.finance.AssertionDLApproach() \
