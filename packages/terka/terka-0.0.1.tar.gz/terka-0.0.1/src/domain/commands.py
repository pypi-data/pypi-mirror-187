...
class CommandHandler:
    ...
    def execute(self,
        ...
        if not entity and command not in ("unfocus", "log", "calendar"):
...
class TerkaTask(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        if self.is_completed:
            ...
            yield Static(task_text, classes="header", id="header")
        ...
        yield Static(f"Created {creation_message}", classes="header")
        if self.is_completed:
            ...
            if completion_date:
                ...
                yield Static("Completion date unknown", classes="header")
        else:
            yield Static(f"Due date: {self.entity.due_date}", classes="header")
