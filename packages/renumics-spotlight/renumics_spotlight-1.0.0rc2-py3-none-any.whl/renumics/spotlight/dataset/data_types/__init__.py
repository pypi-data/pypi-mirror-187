...
class BaseData(ABC):
    ...
    @classmethod
    @abstractmethod
    def decode(cls, value: Union[np.ndarray, np.void]) -> "BaseData":
        """
...
class BaseFileBasedData(BaseData):
    """
    ...
    @classmethod
    @abstractmethod
    def from_file(cls, filepath: PathType) -> "BaseFileBasedData":
        """
...
class Window:
    ...
    continuous data (only :class:`Audio <renumics.spotlight.data_types.Audio>`
