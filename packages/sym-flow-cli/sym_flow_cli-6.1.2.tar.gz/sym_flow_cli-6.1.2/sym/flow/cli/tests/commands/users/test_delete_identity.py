...
class TestUsersDeleteIdentity:
    ...
    def test_delete_no_force_no_confirm(self, click_setup, users):
        with click_setup() as runner:
            result = runner.invoke(
                click_command,
                [
    ...
    @patch("sym.flow.cli.commands.users.delete_identity.click.confirm", return_value=True)
    def test_delete_no_force_with_confirm(self, _, click_setup, users):
        with click_setup() as runner:
            result = runner.invoke(
                click_command,
                [
