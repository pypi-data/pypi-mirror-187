...
class PagSeguro(object):
    ...
    def post(self, uri, payload):
        ...
        self.payload_debug = payload
        self.url_debug = url
        self.response = requests.post(url, data=payload, headers=self.config.HEADERS)
    ...
    def print_request(self, debug = False):

        self.payload_debug = json.loads(self.payload_debug)
        if 'payment_method' in self.payload_debug:
            self.payload_debug['payment_method']['card']['security_code'] = "xxx"
            self.payload_debug['payment_method']['card']['number'] = "xxxxxx"
        ...
        if debug:
            ...
            print("------------------------------")
            print("Body:")
            print(self.payload_debug)
            print("------------------------------")
            print("Response:")
            print(json.dumps(json.loads(self.response.text), indent=4))
            print("------------------------------")

        return self.payload_debug
