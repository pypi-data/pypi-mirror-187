...
class SWANiSlicer(QThread):    
    def __init__(self, slicerPath, ptFolder, parent = None):
    ...
    def run(self):
        ...
        cmd=self.slicerPath+" --no-splash --no-main-window --python-script "+os.path.join(os.path.dirname(__file__),"slicerScript.py")
