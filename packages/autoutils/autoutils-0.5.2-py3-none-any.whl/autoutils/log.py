...
class ColorfulStreamHandler(logging.StreamHandler):
    ...
    def __init__(self, log_format: str = None, colorful: bool = True):
        super().__init__()
    ...
    def emit(self, record: logging.LogRecord) -> None:
        try:
            ...
            record.process_thread = self.get_color_text(self.get_process_thread(record),
            ...
            record.text = self.get_color_text(record.message, color=color)
