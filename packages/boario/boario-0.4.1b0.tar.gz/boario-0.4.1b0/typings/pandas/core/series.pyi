...
from typing import Any, Callable, Hashable, IO, Iterable, Literal, Mapping, Sequence, TYPE_CHECKING, overload
from pandas._libs import lib
from pandas._typing import AggFuncType, AnyArrayLike, ArrayLike, Axis, Dtype, DtypeObj, FilePath, FillnaOptions, Frequency, IgnoreRaise, IndexKeyFunc, IndexLabel, Level, NaPosition, NumpySorter, NumpyValueArrayLike, QuantileInterpolation, Renamer, SingleManager, SortKind, StorageOptions, Suffixes, TimedeltaConvertibleTypes, TimestampConvertibleTypes, ValueKeyFunc, WriteBuffer, npt
from pandas.util._decorators import Appender, Substitution, deprecate_kwarg, deprecate_nonkeyword_arguments, doc
...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    def take(self, indices, axis: Axis = ..., is_copy: bool | None = ..., **kwargs) -> Series:
        ...
    
    def __getitem__(self, key): # -> Self@Series | ndarray[Any, Unknown] | Any | Series | NDArray[Unknown | Any]:
        ...
    ...
    def reset_index(self, level: IndexLabel = ..., drop: bool = ..., name: Level = ..., inplace: bool = ..., allow_duplicates: bool = ...) -> DataFrame | Series | None:
        """
    ...
    def to_string(self, buf: FilePath | WriteBuffer[str] | None = ..., na_rep: str = ..., float_format: str | None = ..., header: bool = ..., index: bool = ..., length=..., dtype=..., name=..., max_rows: int | None = ..., min_rows: int | None = ...) -> str | None:
        """
...
""")
    ...
    def groupby(self, by=..., axis: Axis = ..., level: Level = ..., as_index: bool = ..., sort: bool = ..., group_keys: bool | lib.NoDefault = ..., squeeze: bool | lib.NoDefault = ..., observed: bool = ..., dropna: bool = ...) -> SeriesGroupBy:
        ...
    
    def count(self, level: Level = ...): # -> Any | Series:
        """
    ...
    @overload
    def drop_duplicates(self, keep: Literal["first", "last", False] = ..., *, inplace: bool = ...) -> Series | None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def drop_duplicates(self, keep: Literal["first", "last", False] = ..., inplace=...) -> Series | None:
        """
    ...
    def corr(self, other: Series, method: Literal["pearson", "kendall", "spearman"] | Callable[[np.ndarray, np.ndarray], float] = ..., min_periods: int | None = ...) -> float:
        """
    ...
    def __matmul__(self, other): # -> Series | ndarray[Unknown, Unknown]:
        """
        Matrix multiplication using binary `@` operator in Python>=3.5.
        """
        ...
    
    def __rmatmul__(self, other): # -> Series | ndarray[Unknown, Unknown]:
        """
        Matrix multiplication using binary `@` operator in Python>=3.5.
        """
        ...
...
""", klass=_shared_doc_kwargs["klass"])
    ...
    def combine(self, other: Series | Hashable, func: Callable[[Hashable, Hashable], Hashable], fill_value: Hashable = ...) -> Series:
        """
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def sort_values(self, axis: Axis = ..., ascending: bool | int | Sequence[bool] | Sequence[int] = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., ignore_index: bool = ..., key: ValueKeyFunc = ...) -> Series | None:
        """
        Sort by the values.
    ...
    def any(self, axis: Axis = ..., bool_only: bool | None = ..., skipna: bool = ..., level: Level | None = ..., **kwargs) -> Series | bool:
        ...
    ...
    def align(self, other: Series, join: Literal["outer", "inner", "left", "right"] = ..., axis: Axis | None = ..., level: Level = ..., copy: bool = ..., fill_value: Hashable = ..., method: FillnaOptions | None = ..., limit: int | None = ..., fill_axis: Axis = ..., broadcast_axis: Axis | None = ...) -> Series:
        ...
    ...
    @overload
    def set_axis(self, labels, *, axis: Axis = ..., inplace: Literal[False] | lib.NoDefault = ..., copy: bool | lib.NoDefault = ...) -> Series:
        ...
    ...
    @overload
    def set_axis(self, labels, *, axis: Axis = ..., inplace: bool | lib.NoDefault = ..., copy: bool | lib.NoDefault = ...) -> Series | None:
        ...
    ...
    def replace(self, to_replace=..., value=..., inplace: bool = ..., limit: int | None = ..., regex: bool = ..., method: Literal["pad", "ffill", "bfill"] | lib.NoDefault = ...) -> Series | None:
        ...
    ...
    def shift(self, periods: int = ..., freq=..., axis: Axis = ..., fill_value: Hashable = ...) -> Series:
        ...
    ...
    @overload
    def dropna(self, *, axis: Axis = ..., inplace: Literal[False] = ..., how: str | None = ...) -> Series:
        ...
    
    @overload
    def dropna(self, *, axis: Axis = ..., inplace: Literal[True], how: str | None = ...) -> None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def dropna(self, axis: Axis = ..., inplace: bool = ..., how: str | None = ...) -> Series | None:
        """
    ...
    def asfreq(self, freq: Frequency, method: FillnaOptions | None = ..., how: str | None = ..., normalize: bool = ..., fill_value: Hashable = ...) -> Series:
        ...
    
    @doc(NDFrame.resample, **_shared_doc_kwargs)
    def resample(self, rule, axis: Axis = ..., closed: str | None = ..., label: str | None = ..., convention: str = ..., kind: str | None = ..., loffset=..., base: int | None = ..., on: Level = ..., level: Level = ..., origin: str | TimestampConvertibleTypes = ..., offset: TimedeltaConvertibleTypes | None = ..., group_keys: bool | lib.NoDefault = ...) -> Resampler:
        ...
    
    def to_timestamp(self, freq=..., how: Literal["s", "e", "start", "end"] = ..., copy: bool = ...) -> Series:
        """
    ...
    def to_period(self, freq: str | None = ..., copy: bool = ...) -> Series:
        """
    ...
    @overload
    def where(self, cond, other=..., *, inplace: Literal[False] = ..., axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> Series:
        ...
    
    @overload
    def where(self, cond, other=..., *, inplace: Literal[True], axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> None:
        ...
    
    @overload
    def where(self, cond, other=..., *, inplace: bool = ..., axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> Series | None:
        ...
    ...
    @overload
    def mask(self, cond, other=..., *, inplace: Literal[False] = ..., axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> Series:
        ...
    
    @overload
    def mask(self, cond, other=..., *, inplace: Literal[True], axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> None:
        ...
    
    @overload
    def mask(self, cond, other=..., *, inplace: bool = ..., axis: Axis | None = ..., level: Level = ..., errors: IgnoreRaise | lib.NoDefault = ..., try_cast: bool | lib.NoDefault = ...) -> Series | None:
        ...
