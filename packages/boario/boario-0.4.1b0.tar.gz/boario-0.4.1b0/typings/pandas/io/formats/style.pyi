...
from pandas._typing import Axis, FilePath, IndexLabel, Level, QuantileInterpolation, Scalar, StorageOptions, WriteBuffer
...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    @Substitution(buf=buf, encoding=encoding)
    def to_string(self, buf: FilePath | WriteBuffer[str] | None = ..., *, encoding=..., sparse_index: bool | None = ..., sparse_columns: bool | None = ..., max_rows: int | None = ..., max_columns: int | None = ..., delimiter: str = ...) -> str | None:
        """
    ...
    def highlight_null(self, color: str | None = ..., subset: Subset | None = ..., props: str | None = ..., null_color: str | lib.NoDefault = ...) -> Styler:
        """
    ...
    @Substitution(subset=subset, color=color, props=props)
    def highlight_quantile(self, subset: Subset | None = ..., color: str = ..., axis: Axis | None = ..., q_left: float = ..., q_right: float = ..., interpolation: QuantileInterpolation = ..., inclusive: str = ..., props: str | None = ...) -> Styler:
        """
