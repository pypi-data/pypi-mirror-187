...
@Appender(_boxplot_doc)
def boxplot_frame(self, column=..., by=..., ax=..., fontsize=..., rot: int = ..., grid: bool = ..., figsize=..., layout=..., return_type=..., backend=..., **kwargs): # -> Any:
    ...

def boxplot_frame_groupby(grouped, subplots: bool = ..., column=..., fontsize=..., rot: int = ..., grid: bool = ..., ax=..., figsize=..., layout=..., sharex: bool = ..., sharey: bool = ..., backend=..., **kwargs): # -> Any:
    """
