...
def scatter_matrix(frame: DataFrame, alpha: float = ..., figsize: tuple[float, float] | None = ..., ax: Axes | None = ..., grid: bool = ..., diagonal: str = ..., marker: str = ..., density_kwds=..., hist_kwds=..., range_padding: float = ..., **kwargs) -> np.ndarray:
    """
...
def radviz(frame: DataFrame, class_column: str, ax: Axes | None = ..., color: list[str] | tuple[str, ...] | None = ..., colormap=..., **kwds) -> Axes:
    """
...
def andrews_curves(frame: DataFrame, class_column: str, ax: Axes | None = ..., samples: int = ..., color: list[str] | tuple[str, ...] | None = ..., colormap=..., **kwargs) -> Axes:
    """
...
def parallel_coordinates(frame: DataFrame, class_column: str, cols: list[str] | None = ..., ax: Axes | None = ..., color: list[str] | tuple[str, ...] | None = ..., use_columns: bool = ..., xticks: list | tuple | None = ..., colormap=..., axvlines: bool = ..., axvlines_kwds=..., sort_labels: bool = ..., **kwargs) -> Axes:
    """
