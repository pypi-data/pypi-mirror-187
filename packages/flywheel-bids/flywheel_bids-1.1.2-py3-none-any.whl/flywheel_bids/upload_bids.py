...
def handle_project(fw, group_id, project_label, assume_upload):
...
def fill_in_properties(context, path, local_properties, corrected_dir_name=None):
    """ """
...
def upload_bids_dir(
    ...
    for proj_label in bids_hierarchy:
        ...
        context["project"] = handle_project(fw, group_id, proj_label, assume_upload)
