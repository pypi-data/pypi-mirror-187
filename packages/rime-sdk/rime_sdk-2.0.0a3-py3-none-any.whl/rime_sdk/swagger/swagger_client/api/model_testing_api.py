...
class ModelTestingApi(object):
    ...
    def model_testing_start_stress_test_v2(self, body, **kwargs):  # noqa: E501
        """Current StartStressTest will be replaced by this endpoint in 2.0, this endpoint will be changed to new v1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_testing_start_stress_test_v2(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RimeStartStressTestV2Request body: (required)
        :return: RimeStartStressTestV2Response
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_testing_start_stress_test_v2_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.model_testing_start_stress_test_v2_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def model_testing_start_stress_test_v2_with_http_info(self, body, **kwargs):  # noqa: E501
        """Current StartStressTest will be replaced by this endpoint in 2.0, this endpoint will be changed to new v1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_testing_start_stress_test_v2_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method model_testing_start_stress_test_v2" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `model_testing_start_stress_test_v2`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RimeStartStressTestV2Response',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
