...
class TestrunresultTestRunDetail(object):
    ...
    def __init__(self, test_run_id=None, name=None, project_id=None, testing_type=None, data_type=None, model_task=None, upload_time=None, web_app_url=None, model_source_info=None, metrics=None, ct_info=None, status=None, progress=None, category_test_ids=None):  # noqa: E501
