...
class CliconfigTypedCLIConfig(object):
    ...
    def __init__(self, tabular_config=None, nlp_config=None, run_name=None, model_task=None, silent_errors=None, tests_config_path=None, tests_config=None, random_seed=None):  # noqa: E501
