...
class RimeStartFileScanRequest(object):
    ...
    def workspace_id(self):
        ...
        Specifies which workspace the file scanning job belongs to. If not specified, server will attempt to read the workspace from the request context.  # noqa: E501
    ...
    def agent_id(self):
        ...
        Specifies which agent this job should be run on. If not specified, the default agent for the workspace is used.  # noqa: E501
