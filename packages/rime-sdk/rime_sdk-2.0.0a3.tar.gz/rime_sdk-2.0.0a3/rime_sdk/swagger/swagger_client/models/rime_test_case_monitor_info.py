...
class RimeTestCaseMonitorInfo(object):
    ...
    def __init__(self, threshold=None, notify=None, is_subset_metric=None, rca_role=None):  # noqa: E501
    ...
    @property
    def notify(self):
        """Gets the notify of this RimeTestCaseMonitorInfo.  # noqa: E501

        Whether notifications should be sent for default monitors. Note: this should not override the value configured by the user. The backend will ignore this value if the monitor already exists.  # noqa: E501

        :return: The notify of this RimeTestCaseMonitorInfo.  # noqa: E501
        :rtype: bool
        """
        return self._notify
    ...
    def notify(self, notify):
        """Sets the notify of this RimeTestCaseMonitorInfo.

        Whether notifications should be sent for default monitors. Note: this should not override the value configured by the user. The backend will ignore this value if the monitor already exists.  # noqa: E501

        :param notify: The notify of this RimeTestCaseMonitorInfo.  # noqa: E501
        :type: bool
        """
