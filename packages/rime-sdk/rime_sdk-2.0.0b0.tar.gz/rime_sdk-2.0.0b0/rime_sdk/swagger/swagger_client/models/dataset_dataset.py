...
class DatasetDataset(object):
    ...
    swagger_types = {
        ...
        'integration_id': 'str',
        'data_info': 'CliconfigTabularSingleDataInfo',
    ...
    def integration_id(self):
        ...
        Information about where the data is stored and how to access said data. IntegrationID is the name of the integration used to identify  where the data resides. DataInfo defines more granular information about how to access the data and its properties.  # noqa: E501
