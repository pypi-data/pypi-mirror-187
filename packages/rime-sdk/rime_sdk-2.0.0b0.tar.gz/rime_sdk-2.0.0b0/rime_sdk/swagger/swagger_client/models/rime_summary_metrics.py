...
class RimeSummaryMetrics(object):
    ...
    def __init__(self, num_rows=None, num_failing_rows=None, robustness_score=None, model_performance=None, all_tests=None, duration=None, severity_counts=None, average_prediction=None, feature_summary_metrics=None, prediction_drift_stat=None, prediction_percentiles=None, sensitivity_score=None, issues=None):  # noqa: E501
