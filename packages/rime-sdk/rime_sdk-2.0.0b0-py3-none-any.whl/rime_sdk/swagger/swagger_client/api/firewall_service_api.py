...
class FirewallServiceApi(object):
    ...
    def firewall_service_list_ot_firewall_rules(self, **kwargs):  # noqa: E501
        """ListOTFirewallRules fetches a list of Stress Test Firewall Rules needed for Batch FW.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.firewall_service_list_ot_firewall_rules(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] firewall_ids:
        :return: StreamResultOfRimeListOTFirewallRulesResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.firewall_service_list_ot_firewall_rules_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.firewall_service_list_ot_firewall_rules_with_http_info(**kwargs)  # noqa: E501
            return data

    def firewall_service_list_ot_firewall_rules_with_http_info(self, **kwargs):  # noqa: E501
        """ListOTFirewallRules fetches a list of Stress Test Firewall Rules needed for Batch FW.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.firewall_service_list_ot_firewall_rules_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method firewall_service_list_ot_firewall_rules" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v1/firewall/firewall-rules', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StreamResultOfRimeListOTFirewallRulesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
