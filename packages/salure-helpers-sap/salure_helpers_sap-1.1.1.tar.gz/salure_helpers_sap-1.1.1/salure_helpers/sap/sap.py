...
from salure_helpers.sap.delimit_endpoints import DelimitEndpoints
from salure_helpers.sap.post_endpoints import PostEndpoints


class SAP(BaseFunctions, PostEndpoints, DelimitEndpoints):
