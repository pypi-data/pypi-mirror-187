...
class DelimitEndpoints:
    ...
    def delimit_master_action(self, employee_id, start_date, end_date):
        ...
        response = self.base_class.delete_data(uri='MasterActionDel', data_filter=data_filter)
    ...
    def delimit_org_unit(self, org_unit, start_date, end_date):
        ...
        response = self.base_class.delete_data(uri='OrgUnitDel', data_filter=data_filter)
        response.raise_for_status()
        return response
    ...
    def delimit_position(self, position_id, start_date, end_date):
        ...
        response = self.base_class.delete_data(uri="PositionDel", data_filter=data_filter)
        response.raise_for_status()
        return response
    ...
    def delete_workcenter(self, position_id, start_date, end_date, workcenter):
        ...
        response = self.base_class.delete_data(uri="WorkcenterDel", data_filter=data_filter)
        response.raise_for_status()
        return response
