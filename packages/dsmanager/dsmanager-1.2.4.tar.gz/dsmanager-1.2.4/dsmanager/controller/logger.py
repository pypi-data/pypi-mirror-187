    ...
    def log_func(logger_name: Any):
        ...
        def decorator(func: Any) -> Any:
            ...
            def wrapper(*args, **kwargs):
                ...
                msg = (
                    f"Ran '{func.__qualname__.replace('.', '__')}' in {time_taken}s; "
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    Logger.get_logger("datasource").warning(
                        "Failed to load data from %s(%s).", source_name, params
                    )
                    raise err
                Logger.get_logger("datasource").info(
                    "Load data from %s(%s).", source_name, params
                )
                return result
