    ...
    def __enrich(
        ...
        if len(eval_X_by_id) > 0 and EVAL_SET_INDEX in result_features.columns:
            ...
            for eval_set_index, eval_X in eval_X_by_id.items():
                ...
                result_eval = pd.concat([eval_X.reset_index(), result_eval_features], axis=1).set_index(
        ...
        result_train = pd.concat([X.reset_index(), result_train_features], axis=1).set_index(
            index_name or DEFAULT_INDEX
        )
