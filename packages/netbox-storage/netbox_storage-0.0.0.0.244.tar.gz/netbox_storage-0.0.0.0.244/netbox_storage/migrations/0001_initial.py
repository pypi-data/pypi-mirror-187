    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("id", models.BigAutoField(primary_key=True, serialize=False)),
                ("partition",
                 models.ForeignKey(on_delete=models.deletion.PROTECT, related_name="partition_physicalvolume",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("id", models.BigAutoField(primary_key=True, serialize=False)),
                ("physical_volume", models.ForeignKey(on_delete=models.deletion.CASCADE,
                                                      related_name="linux_physicalvolume",
                                                      to="netbox_storage.physicalvolume")),
