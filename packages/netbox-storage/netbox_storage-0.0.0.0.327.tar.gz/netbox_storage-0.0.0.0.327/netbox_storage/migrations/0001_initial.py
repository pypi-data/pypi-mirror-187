            ...
            fields=[
                ...
                ("partition",
                 models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="partition_physicalvolume",
                                   to="netbox_storage.partition", null=True)),
                ("vg",
                ...
                ("drive",
                 models.ForeignKey(on_delete=models.deletion.PROTECT, related_name="drive_physicalvolume",
                                   to="netbox_storage.drive", null=True)),
                ("description", models.CharField(max_length=255)),
            ],
            options={
                "ordering": ("pv_name", "id"),
