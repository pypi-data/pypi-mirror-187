...
from netbox_storage.views import (
    ...
    PartitionPhysicalVolumeListView,
    # VolumeGroup
    VolumeGroupListView,
    VolumeGroupEditView,
    ...
    LogicalVolumeView,
    LogicalVolumeDeleteView, VolumeGroupPhysicalVolumeListView, DrivePhysicalVolumeListView,
)
...
urlpatterns = [
    ...
    path("drive/<int:pk>/physicalvolume/", DrivePhysicalVolumeListView.as_view(), name="drive_physicalvolumes"),
    #
    # Filesystem urls
    #
    ...
    path("partition/<int:pk>/physicalvolume/",
         PartitionPhysicalVolumeListView.as_view(),
         name="partition_physicalvolumes"),
    #
    # PhysicalVolume urls
    #
    ...
    path("volumegroup/<int:pk>/physicalvolume/",
         VolumeGroupPhysicalVolumeListView.as_view(),
