...
from netbox_storage.api.serializers import (
    DriveSerializer,
    FilesystemSerializer, LinuxVolumeSerializer, PartitionSerializer, PhysicalVolumeSerializer,
)
from netbox_storage.filters import DriveFilter, FilesystemFilter, LinuxVolumeFilter, \
    PartitionFilter, PhysicalVolumeFilter
...
class PhysicalVolumeViewSet(NetBoxModelViewSet):
    ...
    def physicalvolume(self, request, pk=None):
        physicalvolume = PhysicalVolume.objects.filter(partition__id=pk)
