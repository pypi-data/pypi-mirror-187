...
class SettingsReal(SettingsValue):
    ...
    def create_from_dict(data: dict):
        s = SettingsReal(data["_value"], data["_min_value"], data["_max_value"], data["_allow_nan"],data["_read_only"], data["_visible"], data["_description"], data["_can_be_input"], data["_is_input"], data["_full_input_name"])
        s._id = data["_id"]
        return s

    def __eq__(self, other):
        return super(SettingsReal, self).__eq__(other) and self._value == other._value and self._min_value == other._min_value and self._max_value == other._max_value and self._allow_nan == other._allow_nan
    ...
    # Name of the type.
    _type_str = "SettingsReal"

    # Datatype attributes.
    _attributes = Attributes("SettingsReal", version=0, member_count=11, known_types=[])

    # Serialization.
    def serialize(self, writer_fun: Callable[[Any, str, str, Optional[CustomSerializer]], None]):
        super(SettingsReal, self).serialize(writer_fun)
    ...
    def deserialize(reader_fun: Callable[[str, Optional[CustomSerializer]], Any]):
        data = super(SettingsReal, SettingsReal).deserialize(reader_fun)
