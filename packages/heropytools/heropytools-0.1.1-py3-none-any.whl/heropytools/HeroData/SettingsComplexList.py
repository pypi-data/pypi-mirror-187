...
class SettingsComplexList(SettingsValueList):
    ...
    def create_from_dict(data: dict):
        s = SettingsComplexList(data["_value"], data["_min_real"], data["_max_real"], data["_min_imag"], data["_max_imag"], 
    ...
    def __eq__(self, other: SettingsComplexList):
        return super(SettingsComplexList, self).__eq__(other) and self._compare_lists(self._value, other._value) and self._min_real == other._min_real and \
    ...
    # Name of the type.
    _type_str = "SettingsComplexList"

    # Datatype attributes.
    _attributes = Attributes("SettingsComplexList", version=0, member_count=17, known_types=[])

    # Serialization.
    def serialize(self, writer_fun: Callable[[Any, str, str, Optional[CustomSerializer]], None]):
        super(SettingsComplexList, self).serialize(writer_fun)
    ...
    def deserialize(reader_fun: Callable[[str, Optional[CustomSerializer]], Any]):
        data = super(SettingsComplexList, SettingsComplexList).deserialize(reader_fun)
