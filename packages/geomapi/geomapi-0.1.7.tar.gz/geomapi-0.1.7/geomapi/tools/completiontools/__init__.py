...
import geomapi.utils.geometryutils as geout
...
def combine_geometry(ogGeometry: o3d.geometry.Geometry, newGeometry :o3d.geometry.Geometry, distanceTreshold : float = 0.05) -> o3d.geometry.Geometry:
    ...
    Args:
        ...
        newGeometry (o3d.geometry): The new geometry to be addad
    ...
    newGeoHull = geout.get_convex_hull(newGeometry)
    print("Covex hull created")
    # Step 2: Filter out the irrelevant points in the ogGeometry
    relevantOg, irrelevantOg = geout.get_points_in_hull(ogGeometry, newGeoHull)
    print("Irrelevant points filtered")
    # Step 3: Isolate the not covered points of the ogGeometry compared to the newGeometry
    newGeometryPoints = geout.mesh_to_pcd(newGeometry,distanceTreshold/2)
    coveredPoints, unCoveredPoints = geout.filter_pcd_by_distance(relevantOg, newGeometryPoints, distanceTreshold)
    ...
    existingNewGeo, newNewGeo = geout.filter_pcd_by_distance(newGeometryPoints, relevantOg, distanceTreshold)
