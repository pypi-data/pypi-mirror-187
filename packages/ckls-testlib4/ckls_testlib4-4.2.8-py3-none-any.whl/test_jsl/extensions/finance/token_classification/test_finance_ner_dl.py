...
class FinanceNerDlCase(unittest.TestCase):
    ...
    def buildAndFit(self, annoToFit) -> PipelineModel:
        ...
        embeddings = BertEmbeddings.pretrained("bert_embeddings_sec_bert_base", "en").setInputCols("document", "tokens").setOutputCol("embeddings")
    ...
    def test_pretrained_model(self):
        model = sparknlp_jsl.finance.FinanceNerModel\
            .pretrained("finner_financial_small", "en", "finance/models")\
