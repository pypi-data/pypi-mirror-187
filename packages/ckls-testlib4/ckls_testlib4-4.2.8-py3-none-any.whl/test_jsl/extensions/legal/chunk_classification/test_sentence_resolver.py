...
class LegalSentenceResolveCase(unittest.TestCase):
    ...
    def test_pretrained_model(self):
        ...
        model = sparknlp_jsl.legal.chunk_classification.SentenceEntityResolverModel.pretrained(
            "legel_crunchbase_companynames", "en", "legal/models").setInputCols("sentence_embeddings").setOutputCol("test_result")
