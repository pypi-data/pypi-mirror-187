...
class FinanceChunkMapperCase(unittest.TestCase):
    ...
    def test_pretrained_model(self):
        model = sparknlp_jsl.finance.chunk_classification.ChunkMapperModel.pretrained('finmapper_nasdaq_ticker','en','finance/models').setInputCols("chunk").setOutputCol("test_result")
