...
class LegalAssertCase(unittest.TestCase):
    ...
    def buildAndFit(self, annoToFit) -> PipelineModel:
        ...
        emb = BertEmbeddings.pretrained("bert_embeddings_sec_bert_base","en").setInputCols(
            "token",
    ...
    def test_pretrained_model(self):
        model = sparknlp_jsl.legal.AssertionDLModel \
            .pretrained("legassertion_time", "en", "legal/models") \
