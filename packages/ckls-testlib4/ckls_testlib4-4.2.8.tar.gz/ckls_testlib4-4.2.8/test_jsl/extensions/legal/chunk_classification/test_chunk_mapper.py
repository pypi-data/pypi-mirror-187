...
class LegalChunkMapperCase(unittest.TestCase):
    ...
    def test_pretrained_model(self):
        model = sparknlp_jsl.legal.chunk_classification.ChunkMapperModel.pretrained("legmapper_edgar_irs", "en", "legal/models").setInputCols("chunk").setOutputCol("test_result")
