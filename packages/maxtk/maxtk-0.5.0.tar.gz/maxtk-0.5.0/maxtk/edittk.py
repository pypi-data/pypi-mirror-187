...
#from this package:
from maxtk.core import mfnMeshGenerator, viewportMessage, undo
from maxtk.nodetk import Node
from maxtk.cmpttk import Cmpt
from maxtk.xformtk import Xform
...
class Edit():
	...
	def deleteAlongAxis(cls, obj, axis="-x"):
		...
		'''
		from maxtk import viewportMessage
	...
	def getOverlappingVertices(objects, threshold=0.0003):
		...
		from maxtk import mfnMeshGenerator
