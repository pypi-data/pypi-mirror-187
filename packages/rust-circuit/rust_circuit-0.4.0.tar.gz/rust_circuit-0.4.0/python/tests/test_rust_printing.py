...
0 Add
  ...
  2 Add
    ...
    # rc.PrintOptions(seen_children_same_line=True, bijection=False, arrows=True).print(P(open("/home/ubuntu/rrfs/adria/gpt2small/seq_len_4.txt").read()))
    # rc.PrintOptions(seen_children_same_line=False, bijection=False, arrows=True).print(P(open("/home/ubuntu/rrfs/adria/gpt2small/seq_len_4.txt").read()))
