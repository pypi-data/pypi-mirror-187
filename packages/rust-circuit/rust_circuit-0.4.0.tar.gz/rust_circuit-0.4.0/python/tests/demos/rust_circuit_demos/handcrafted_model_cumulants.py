...
# %%
print("Uncomment to have module autoreload (grr mypy)")
# %load_ext autoreload
# %autoreload 2
import os
...
from interp.circuit.algebric_rewrite import MUL_REST
...
from interp.circuit.constant import ArrayConstant, One
...
from interp.circuit.algebric_rewrite import rearrange_muls, residual_rewrite
from interp.circuit.circuit import Circuit
