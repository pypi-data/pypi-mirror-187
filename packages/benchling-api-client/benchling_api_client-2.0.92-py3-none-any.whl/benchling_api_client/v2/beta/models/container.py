...
from ..models.team_summary_with_type import TeamSummaryWithType
from ..models.user_summary import UserSummary
from ..models.user_summary_with_type import UserSummaryWithType
...
class Container:
    ...
    _restricted_sample_parties: Union[
        Unset, List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]
    ] = UNSET
    _restriction_status: Union[Unset, SampleRestrictionStatus] = UNSET
    _sample_owners: Union[Unset, List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._restricted_sample_parties, Unset):
            ...
            for restricted_sample_parties_item_data in self._restricted_sample_parties:
                ...
                elif isinstance(restricted_sample_parties_item_data, UserSummaryWithType):
        ...
        if not isinstance(self._sample_owners, Unset):
            ...
            for sample_owners_item_data in self._sample_owners:
                ...
                elif isinstance(sample_owners_item_data, UserSummaryWithType):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_restricted_sample_parties() -> Union[
            ...
            for restricted_sample_parties_item_data in _restricted_sample_parties or []:
                ...
                def _parse_restricted_sample_parties_item(
                ...
                ) -> Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]:
                    restricted_sample_parties_item: Union[
                        UserSummaryWithType, TeamSummaryWithType, UnknownType
                    ]
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        restricted_sample_parties_item = UserSummaryWithType.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        restricted_sample_parties_item = TeamSummaryWithType.from_dict(data, strict=True)
        ...
        try:
            ...
            restricted_sample_parties = cast(
                Union[Unset, List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]], UNSET
            )
        ...
        def get_sample_owners() -> Union[
            ...
            for sample_owners_item_data in _sample_owners or []:
                ...
                def _parse_sample_owners_item(
                    ...
                    sample_owners_item: Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        sample_owners_item = UserSummaryWithType.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        sample_owners_item = TeamSummaryWithType.from_dict(data, strict=True)
    ...
    @property
    def restricted_sample_parties(self) -> List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]:
    ...
    def restricted_sample_parties(
        self, value: List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]
    ) -> None:
    ...
    @property
    def sample_owners(self) -> List[Union[UserSummaryWithType, TeamSummaryWithType, UnknownType]]:
