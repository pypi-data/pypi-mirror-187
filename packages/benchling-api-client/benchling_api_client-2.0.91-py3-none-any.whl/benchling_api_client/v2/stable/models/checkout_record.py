...
class CheckoutRecord:
    ...
    *modifiedAt field* is the date and time when container was last checked out, checked in, or reserved
    ...
    _status: Union[Unset, CheckoutStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_status() -> Union[Unset, CheckoutStatus]:
            status = UNSET
            _status = d.pop("status")
            if _status is not None and _status is not UNSET:
                try:
                    status = CheckoutStatus(_status)
                except ValueError:
                    status = CheckoutStatus.of_unknown(_status)
        ...
        try:
            ...
            if strict:
                raise
            status = cast(Union[Unset, CheckoutStatus], UNSET)
    ...
    @status.setter
    def status(self, value: CheckoutStatus) -> None:
        self._status = value
