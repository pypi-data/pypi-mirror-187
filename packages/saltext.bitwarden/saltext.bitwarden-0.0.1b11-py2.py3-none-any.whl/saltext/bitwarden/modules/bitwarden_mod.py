...
def get_username(item_id=None, profile=None):
    ...
    Returns a string containing the username if successful or ``False`` if unsuccessful
    """
    opts = _get_config(profile=profile)
...
def get_uri(item_id=None, profile=None):
    ...
    Returns a string containing the URI if successful or ``False`` if unsuccessful
    """
    opts = _get_config(profile=profile)
...
def get_totp(item_id=None, profile=None):
    ...
    Returns a string containing the TOTP code if successful or ``False`` if unsuccessful
    """
    opts = _get_config(profile=profile)
...
def get_notes(item_id=None, profile=None):
    ...
    Returns a string containing the notes if successful or ``False`` if unsuccessful
    """
    opts = _get_config(profile=profile)
