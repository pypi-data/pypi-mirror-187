...
class Project(object):
    ...
    def __init__(self, name=None, cluster_config=None, description=None, id=None, creator_id=None, created_at=None, organization_id=None, active_sessions=None, last_activity_at=None, last_used_cloud_id=None, is_default=None, local_vars_configuration=None):  # noqa: E501
