...
class IMicroAppsSvcs(typing_extensions.Protocol):
    ...
    def router_func(self) -> typing.Optional[aws_cdk.aws_lambda.IFunction]:
...
class _IMicroAppsSvcsProxy:
    ...
    def router_func(self) -> typing.Optional[aws_cdk.aws_lambda.IFunction]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_lambda.IFunction], jsii.get(self, "routerFunc"))
