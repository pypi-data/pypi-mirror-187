...
def configure_starlette(context: MarshallerContext):
    try:
        ...
        if str(e) == "No module named 'starlette'":
            LOGGER.debug("Starlette module not found: skipping")
        else:
            raise e
...
def configure_strawberry(context: MarshallerContext):
    try:
        ...
        if str(e) == "No module named 'strawberry'":
            LOGGER.debug("Strawberry module not found: skipping")
        else:
            raise e
...
def configure_aws(context: MarshallerContext):
    try:
        ...
        if str(e) == "No module named 'boto3'":
            LOGGER.debug("AWS module not found: skipping")
        else:
            raise e
...
def configure_serverless(context: MarshallerContext):
    try:
        ...
        if str(e) == "No module named 'ruamel'":
            LOGGER.debug("Serverless module not found: skipping")
        else:
            raise e
...
def configure_celery(context: MarshallerContext):
    try:
        ...
        if str(e) == "No module named 'celery'":
            LOGGER.debug("Celery module not found: skipping")
        else:
            raise e
...
def configure_jinja2(context: MarshallerContext):
    try:
        ...
        try:
            ...
            pass  # AWS integraton not present.

    except ModuleNotFoundError as e:
        if str(e) == "No module named 'jinja2'":
            LOGGER.debug("Jinja2 module not found: skipping")
        else:
            raise e
