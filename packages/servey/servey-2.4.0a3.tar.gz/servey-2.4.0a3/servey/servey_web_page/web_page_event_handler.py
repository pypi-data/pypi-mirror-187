...
from servey.servey_aws.event_handler.api_gateway_event_handler import ApiGatewayEventHandler
...
class WebPageEventHandlerFactory(EventHandlerFactoryABC):
    ...
    def create(self, action: Action) -> Optional[EventHandlerABC]:
        trigger = next((t for t in action.triggers if isinstance(t, WebPageTrigger)), None)
