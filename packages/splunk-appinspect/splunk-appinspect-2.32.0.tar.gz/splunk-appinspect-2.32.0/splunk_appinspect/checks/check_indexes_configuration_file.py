...
@splunk_appinspect.cert_version(min="2.23.0")
@splunk_appinspect.tags("splunk_appinspect", "cloud", "private_app", "private_victoria", "private_classic")
def check_lower_cased_index_names(app, reporter):
    """Check that all index names contain lowercase characters. If index names have any upper
    case characters any attempts to edit the index in the UI will cause a duplicate
    index stanza creation which will cause many errors in Splunk."""
