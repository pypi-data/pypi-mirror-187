...
from .dyson_pure_humidify_cool import DysonPureHumidifyCool, DysonPurifierHumidifyCoolFormaldehyde, DysonPurifierHumidifyCoolCryptomic
...
def get_device(serial: str, credential: str, device_type: str) -> Optional[DysonDevice]:
    ...
    if device_type == DEVICE_TYPE_PURE_HUMIDIFY_COOL_CRYPTOMIC:
        return DysonPurifierHumidifyCoolCryptomic(serial, credential, device_type)
    return None
