...
# SET_TBB_MANUALLY: yes | no. Default is no
...
if ("${SET_TBB_MANUALLY}" STREQUAL "")
    set(SET_TBB_MANUALLY "no")
elseif (NOT "${SET_TBB_MANUALLY}" STREQUAL "yes" AND NOT "${SET_TBB_MANUALLY}" STREQUAL "no")
    message(FATAL_ERROR "SET_TBB_MANUALLY must be 'yes' or 'no'")
endif()

message(STATUS "TARGET_LINK:      ${TARGET_LINK}")
message(STATUS "USE_DPCPP:        ${USE_DPCPP}")
message(STATUS "USE_NEW_IFACES:   ${USE_NEW_IFACES}")
message(STATUS "SET_TBB_MANUALLY: ${SET_TBB_MANUALLY}")
...
if (SET_TBB_MANUALLY STREQUAL "no")
...
if(UNIX)
    if(APPLE)
        set(LIB_PREFIX "lib")
        set(LIB_EXT ".a")
        set(DLL_EXT ".${_dal_ver_major_bin}.${_dal_ver_minor_bin}.dylib")
    else()
        set(LIB_PREFIX "lib")
        set(LIB_EXT ".a")
