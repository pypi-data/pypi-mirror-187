#!/usr/bin/env python3
# -*- coding: utf-8 -*-
""" Module to allow user to make changes to Control Implementations in an excel spreadsheet for user friendly experience """
...
def data_load(regscale_id: int, regscale_module: str, path: Path):
    ...
    return logger.info(
        "Your data has beeen loaded into your excel workbook. Please open the all_implementations workbook and make your desired changes."
    )


# Save Spreadsheet if file changed, append Update API changes that were manually entered in excel worksheet
        ...
        updated_implementations.append(
            {
                ...
                "qiIssues": None,
                "qiOverall": None,
                "responsibility": i["Resposibility"],
