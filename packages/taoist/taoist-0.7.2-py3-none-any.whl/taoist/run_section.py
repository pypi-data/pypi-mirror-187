...
async def run_section(args: ArgumentParser) -> None:
    ...
    if args.subcommand == "list":
        project_id = args.project_id if args.project_id else int(
        ...
        section_name = args.section_name if args.section_name else input(
            "Enter new section name: ")
        project_id = args.project_id if args.project_id else int(
            input("Enter project ID: "))
        project_name = project_dict[project_id].name
        try:
            section = await api.add_section(
                name=section_name,
            ...
            raise error
        print(
            f"Successfully added section \"{section_name}\" to project \"{project_name}\"")
    elif args.subcommand == "delete":
        section_id = args.section_id if args.section_id else int(
            input("Enter section ID: "))
        try:
