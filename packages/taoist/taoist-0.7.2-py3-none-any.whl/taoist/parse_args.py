...
def parse_args() -> argparse.ArgumentParser:
    ...
    init_parser = subparsers.add_parser(
        "init", help="authenticate to Todoist API")
    ...
    # Parse project/list
    project_list_subparser = project_subparser.add_parser(
        "list", help="list projects")

    # Parse project/create
    project_create_subparser = project_subparser.add_parser(
    ...
    project_delete_subparser = project_subparser.add_parser(
        "delete", help="delete existing project")
    ...
    # Parse task/list
    task_list_subparser = task_subparser.add_parser(
        "list", help="list active tasks")
    ...
    # Parse task/view
    task_view_subparser = task_subparser.add_parser(
        "view", help="view task details")
    ...
    # Parse task/create
    task_create_subparser = task_subparser.add_parser(
        "create", help="create new task")
    ...
    # Parse task/delete
    task_delete_subparser = task_subparser.add_parser(
        "delete", help="delete existing task")
    ...
    # Parse task/label
    task_label_subparser = task_subparser.add_parser(
        "label", help="add label to existing task")
    ...
    # Parse task/done
    task_done_subparser = task_subparser.add_parser(
        "done", help="mark active task as done")
    ...
    # Parse label/list
    label_list_subparser = label_subparser.add_parser(
        "list", help="list existing labels")

    # Parse label/create
    label_create_subparser = label_subparser.add_parser(
        "create", help="create new label")
    ...
    # Parse label/delete
    label_delete_subparser = label_subparser.add_parser(
        "delete", help="delete existing label")
    ...
    # Parse section/list
    section_list_subparser = section_subparser.add_parser(
        "list", help="list sections")
    ...
    section_create_subparser = section_subparser.add_parser(
        "create", help="create new section")
    ...
    section_delete_subparser = section_subparser.add_parser(
        "delete", help="delete existing section")
