...
class VersionApi(object):
    ...
    def version_create_version(self, created_version, **kwargs):  # noqa: E501
        """Create a new version by importing a definition file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.version_create_version(created_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.version_create_version_with_http_info(created_version, **kwargs)  # noqa: E501
        else:
            (data) = self.version_create_version_with_http_info(created_version, **kwargs)  # noqa: E501
            return data

    def version_create_version_with_http_info(self, created_version, **kwargs):  # noqa: E501
        """Create a new version by importing a definition file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.version_create_version_with_http_info(created_version, async_req=True)
        >>> result = thread.get()
