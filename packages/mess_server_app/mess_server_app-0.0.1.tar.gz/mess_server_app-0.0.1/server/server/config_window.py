...
class ConfigWindow(QDialog):
    ...
    def open_file_dialog(self):
        """Метод обработчик открытия окна выбора пути до папки."""
        global dialog
    ...
    def save_server_config(self):
        ...
        # предоставляет модальный диалог для информирования или для того, чтобы задать вопрос и получить ответ
        message = QMessageBox()
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                dir_path = os.getcwd()
                dir_path = os.path.join(dir_path, '../../HW')
