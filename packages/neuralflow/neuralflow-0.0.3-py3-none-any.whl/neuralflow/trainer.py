    ...
    def train(self, train_dataloader, valid_dataloader=None, max_grad=None, iter_num=20):
        ...
        for epoch in range(self.n_epochs):
            ...
            for x, y in tqdm(train_dataloader):
                ...
                print(
                    f"train loss : {train_loss}    train perplexity : {train_perplexity}    iter : {count}/{iter_num}\r",
                    end="")
            ...
            print()
            print(
                f"epoch {epoch + 1} -- train loss : {epoch_train_loss}    train perplexity : {epoch_train_perplexity}")
