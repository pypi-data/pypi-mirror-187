...
class ConfigAgent():
    ...
    def __init__(self, log_info, log_error):
        ...
        self.file_name_topics = None
        self.file_name_vehicles = None
    ...
    def config_files(self):
        ...
        self.file_name_topics = join(package_path, "defaults.json")
        self.file_name_vehicles = join(package_path, "config.yaml")
    ...
    def config_vehicles(self):
        ...
        return vehicle_list, vehicles, vehicle_tokens
