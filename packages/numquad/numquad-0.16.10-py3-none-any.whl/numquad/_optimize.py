...
def _optimize_u3(content):
    ...
    return _optimize(
        ...
        expand_symmetries_points_only,
        _scheme_from_dict,
        get_evaluator=lambda points: orthogpoly.u3.EvalCartesian(
...
def _optimize_c2(content):
    ...
    return _optimize(
        ...
        expand_symmetries_points_only,
        _scheme_from_dict,
        get_evaluator=lambda points: orthogpoly.cn.Eval(points),
    )
...
def _optimize_s2(content):
    ...
    return _optimize(
        ...
        expand_symmetries_points_only,
        _scheme_from_dict,
        get_evaluator=lambda points: orthogpoly.s2.zernike.Eval(points, scaling="normal"),
    )
...
def _optimize_t2(content):
    ...
    return _optimize(
        ...
        expand_symmetries_points_only,
        _scheme_from_dict,
        get_evaluator=lambda points: orthogpoly.t2.Eval(points, scaling="normal"),
    )
