...
def dobrodeev_1978(n):
    ...
    I0 = multidim.nball.integrate_monomial(n * [0])
    I2 = multidim.nball.integrate_monomial([2] + (n - 1) * [0])
    I22 = multidim.nball.integrate_monomial([2, 2] + (n - 2) * [0])
    I4 = multidim.nball.integrate_monomial([4] + (n - 1) * [0])
