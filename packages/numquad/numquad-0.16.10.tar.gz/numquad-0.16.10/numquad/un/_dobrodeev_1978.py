...
def dobrodeev_1978(n: int):
    ...
    I0 = multidim.nsphere.integrate_monomial(n * [0], symbolic=True)
    ...
    if i is None:
        ...
        I2 = multidim.nsphere.integrate_monomial([2] + (n - 1) * [0], symbolic=True)
        I22 = multidim.nsphere.integrate_monomial([2, 2] + (n - 2) * [0], symbolic=True)
        I4 = multidim.nsphere.integrate_monomial([4] + (n - 1) * [0], symbolic=True)
