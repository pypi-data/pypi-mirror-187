...
class ConstrainedHartreeFock(HartreeFock):
    ...
    def __init__(
        ...
        super().__init__(
            system, bdiis, max_size, diis_convergence, E_convergence, D_convergence, maxiter
        )
...
def ConstrainedSCI(
    ...
    if result_HF is None:
        HF_solver = HartreeFock(molecule, bdiis, max_size, diis_convergence, E_convergence, D_convergence, maxiter)
