...
def SCI(molecule: Hubbard, excitations: list, result_HF=None, maxiter: int = 100, max_size: int = 5) -> pd.Series:
    """
    ...
    if result_HF is None:
        HF_solver = HartreeFock(molecule, bdiis=True, maxiter=maxiter, max_size=max_size)
