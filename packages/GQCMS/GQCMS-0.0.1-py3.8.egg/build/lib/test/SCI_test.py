...
def test_constrained_fci():
    ...
    # Perform Hartree-Fock computation
    result_HF = gqcms.HartreeFock(sys, D_convergence=1e-7, E_convergence=1e-10, max_size=10, maxiter=500).solve()
    
    # Perform constrained FCI via HF
    result_fci_hf = gqcms.ConstrainedSCI(sys, nr_op_site, 1, excitations=[1, 2], result_HF=result_HF)
