...
from validation_cifar100_gamma import save_pr_plot
...
file_name = 'keras_cifar-100_detailed.txt'
file_path= os.path.join(save_dir,file_name)    
file_ =open(file_path, 'w')
#print('Saved trained model at %s ' % model_path, file_path)

print("----------------epoch--------------(step: ", 0," )",file=file_)
#datagen = set_real_time(True)
#model.save_weights(weight_path)
file_ = save_pr_plot(model, 'keras', 0, save_dir, file_)
...
for i in range(int(iterations)):
    ...
    print("----------------epoch--------------(step: ", i+1," )",file=file_)
    file_ = save_pr_plot(model_s, 'keras', i+1, save_dir,file_)
    '''
