...
def execution( _number, _nameof_msg_rpt, _namespace, _sincelast, _lst_patterns, _lst_target=[], **kwargs):
    ...
    if ALLOW_PARAM == True:
        ...
        if len(lst_dtect_obj)!=0:
            ...
            count_deployment_success_restart = 0; lines_deploymeny_success_restart = ''
            count_deployment_fail_restart = 0; lines_deploymeny_fail_restart = ''
            ...
            if len(lst_event_result_rollout_restart_filter_fail)!=0:
                print("CHECK len lst_event_result_rollout_restart_filter_fail:", str(len(lst_event_result_rollout_restart_filter_fail)))
