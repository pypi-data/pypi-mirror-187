    ...
    if bparam == True:
        ...
        if bparam == True:
            ...
            if bparam == True: 
                ...
                print('CHECK ConstTypeProcessOfAirtable:', ConstTypeProcessOfAirtable.restart.value)
                ## - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                if bparam == True:
                    bAirtableReact = True
                        ...
                        ## - - - - - - - - - - - - - - - - - - - -
                            ...
                            for cont in dict_cont:
                                ...
                                if get_bStatus_complete_sshcmd == False:
                                    ...
                                    # if str(_type).strip()!='':
                                    #     if str(_type).strip() == ConstTypeProcessOfAirtable.restart.value or str(_type).strip() == 'Restart-pod':
                                    #         None
