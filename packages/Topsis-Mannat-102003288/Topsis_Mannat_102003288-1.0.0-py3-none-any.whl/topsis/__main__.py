...
def main():
    ...
    if(n!=5):
        print("The total number of parameters passed must be five")
        exit(0)
    ...
    try:
        ...
        print("Number of columns in the file are less than three!")
        exit(0)
    ...
    if(np.size(weight)!=np.size(impact)):
        print("Inconsistent number of weights and impacts")
        exit(0)
