...
modules = \
['hashwd', 'defaults', 'dictionary', '__main__', '__init__', 'LICENSE']
install_requires = \
['argparse>=1.4,<2.0', 'pyperclip>=1.8,<2.0', 'requests>=2.24,<3.0']

entry_points = \
{'console_scripts': ['hashwd = __main__:main']}

setup_kwargs = {
    'name': 'hashwd',
    'version': '0.4.68',
    'description': 'Quickly generate a strong, random password using uncommon words',
