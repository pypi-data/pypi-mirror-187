...
def main():
    ...
    if args.command == "generate":
        generate_password(defaults.DICTIONARY_FILE, word_quantity=defaults.WORDS_DEFAULT,
                          number_quantity=defaults.NUMBERS_DEFAULT, symbol_quantity=defaults.SYMBOLS_DEFAULT)

        password = generate_password(defaults.DICTIONARY_FILE, num_words, num_numbers, num_symbols)
