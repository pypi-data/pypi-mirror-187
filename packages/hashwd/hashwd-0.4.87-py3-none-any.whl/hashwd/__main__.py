...
def main():
    ...
    if args.command == "defaults":
        ...
        print("Enter new default value for number of words. The current value is {}:".format(pass_defaults.WORDS_DEFAULT))
        ...
        if new_default_words:
            ...
            defaults_contents = re.sub(r"WORDS_DEFAULT = \d+", "WORDS_DEFAULT = {}".format(pass_defaults.WORDS_DEFAULT),
                                       defaults_contents)
        else:
            new_default_words = pass_defaults.WORDS_DEFAULT

        print("Enter new default value for number of numbers. The current value is {}:".format(pass_defaults.NUMBERS_DEFAULT))
        ...
        if new_default_numbers:
            ...
            defaults_contents = re.sub(r"NUMBERS_DEFAULT = \d+", "NUMBERS_DEFAULT = {}".format(pass_defaults.NUMBERS_DEFAULT),
                                       defaults_contents)
        else:
            new_default_numbers = pass_defaults.NUMBERS_DEFAULT

        print("Enter new default value for number of symbols. The current value is {}:".format(pass_defaults.SYMBOLS_DEFAULT))
        ...
        if new_default_symbols:
            ...
            defaults_contents = re.sub(r"SYMBOLS_DEFAULT = \d+", "SYMBOLS_DEFAULT = {}".format(pass_defaults.SYMBOLS_DEFAULT),
                                       defaults_contents)
        else:
            new_default_numbers = pass_defaults.NUMBERS_DEFAULT
        ...
        if args.all:
            ...
            if new_max_symbols:
                ...
                defaults_contents = re.sub(r"MAX_SYMBOLS = \d+", "MAX_SYMBOLS = {}".format(pass_defaults.MAX_SYMBOLS),
                                           defaults_contents)
            else:
            ...
            if new_max_numbers:
                ...
                defaults_contents = re.sub(r"MAX_NUMBERS = \d+", "MAX_NUMBERS = {}".format(pass_defaults.MAX_NUMBERS),
                                           defaults_contents)
            else:
                new_max_numbers = MAX_NUMBERS
            print("Enter new filepath for dictionary file. The current path is {}:".format(pass_defaults.DICTIONARY_FILE))
            ...
            if new_dictionary_file:
                ...
                defaults_contents = re.sub(r"DICTIONARY_FILE = '.*?'", "DICTIONARY_FILE = '{}'".format(pass_defaults.DICTIONARY_FILE),
                                           defaults_contents)
        else:
