...
def new_requests_client(access_key: Optional[str] = None,
                        ...
                        allow_insecure: bool = False) -> HTTPClient:
    ...
    return HTTPClient(base_url=url, path_prefix=API_PREFIX, default_headers=headers, verify_ssl=verify_ssl, allow_insecure=allow_insecure)
