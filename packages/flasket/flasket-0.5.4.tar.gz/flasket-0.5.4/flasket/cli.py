...
The following example specifies the name of the configuration file to use.
...
def FlasketCLIHelper(klass: "FlasketCLI", pkgname: str, handlers: t.List = None) -> "FlasketCLI":
    cfgname = f"{pkgname}.yml"
    return klass(default_cfg={"cfgname": cfgname}, handlers=handlers)
