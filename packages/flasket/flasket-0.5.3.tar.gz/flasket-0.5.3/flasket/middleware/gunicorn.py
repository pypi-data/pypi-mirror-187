...
class GunicornApplication(BaseApplication):
    ...
    def __init__(self, *args, cfg: t.Dict, rootpath: str = None, handlers=None, **kwargs) -> None:
        """
        ...
        handlers: list
            ...
            List of handler classes to start
        """
        self._flasket = Application(*args, cfg=cfg, rootpath=rootpath, handlers=handlers, **kwargs)
...
class FlasketCLI(cli.ABCFlasketCli):
    ...
    _handlers: t.List = field(default=None)
    # fmt: on
    ...
    def _run(self, *args, cfg: t.Dict, rootpath: str = None, **kwargs) -> None:
        ...
        """
        GunicornApplication(*args, cfg=cfg, rootpath=rootpath, handlers=self._handlers, **kwargs).run()


def FlasketCLIHelper(pkgname: str, handlers: t.List = None) -> FlasketCLI:
    """
    ...
    .. code-block:: python
      ...
      if __name__ == "__main__":
          FlasketCLIHelper("my_package").run()
    """
    return cli.FlasketCLIHelper(FlasketCLI, pkgname, handlers)
