...
class GunicornApplication(BaseApplication):
    ...
    def __init__(self, *args, cfg: t.Dict, rootpath: str = None, options: t.Dict = None, **kwargs) -> None:
        """
        ...
        """
        self._flasket = Application(*args, cfg=cfg, rootpath=rootpath, options=options, **kwargs)
...
def FlasketCLIHelper(*, cfgname: str = None, description: str = None, options: t.Dict = None) -> FlasketCLI:
    """
