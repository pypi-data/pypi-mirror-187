...
class GoogleOAuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProviderLoginURLForAttach = channel.unary_unary(
                '/GoogleOAuth/GetProviderLoginURLForAttach',
...
class GoogleOAuth(object):
    ...
    def GetProviderLoginURLForAttach(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GoogleOAuth/GetProviderLoginURLForAttach',
...
class YandexOAuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProviderLoginURLForAttach = channel.unary_unary(
                '/YandexOAuth/GetProviderLoginURLForAttach',
                request_serializer=oauth__service__pb2.GetProviderLoginURLForAttachRequest.SerializeToString,
                response_deserializer=oauth__service__pb2.GetProviderLoginURLForAttachResponse.FromString,
                )
        self.AttachAccountToUser = channel.unary_unary(
...
class YandexOAuth(object):
    ...
    def GetProviderLoginURLForAttach(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/YandexOAuth/GetProviderLoginURLForAttach',
            oauth__service__pb2.GetProviderLoginURLForAttachRequest.SerializeToString,
            oauth__service__pb2.GetProviderLoginURLForAttachResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
