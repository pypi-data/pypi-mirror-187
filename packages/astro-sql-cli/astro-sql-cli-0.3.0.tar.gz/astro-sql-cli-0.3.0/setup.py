...
{'': ['*'],
 'sql_cli': ['include/base/*',
             ...
             'macros/build_dag.py.jinja2',
             'macros/build_dag.py.jinja2',
             'macros/build_dag.py.jinja2',
             'macros/load_file.py.jinja2',
             'macros/load_file.py.jinja2',
             'macros/load_file.py.jinja2',
             'macros/transform_file.py.jinja2',
             'macros/transform_file.py.jinja2',
             'macros/transform_file.py.jinja2',
             'templates/gen_tasks_dag.py.jinja2',
             'templates/gen_tasks_dag.py.jinja2',
             'templates/render_dag.py.jinja2',
             'templates/render_dag.py.jinja2']}
...
['Jinja2>=2.10.1,<=3.1',
 'PyYAML>=5.4.1',
 'apache-airflow>2.1',
 'astro-sdk-python[all]>=1.3.1,<2.0.0',
 'black',
