...
def fs_rmd_yml_parse(sfc_prj='R4Econ',
    ...
    if (sph_gitpages_root.lower() == ('https://' + sfc_prj + '/').lower()):
        # suppose sfc_prj is math4econ.github.io,
        # and sph_gitpages_root = https://math4econ.githuo.io
        # for html urls, we only need math4econ.github.io,
        # rather than math4econ.github.io/math4econ.github.io, this is
        # github pages for repo driving user or organizational account main page.
        sph_source_web_root = sph_gitpages_root + spt_rmd_path + '/'
    else:
