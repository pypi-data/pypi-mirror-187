...
def fs_yml2readme(sfc_usr='fanwangecon',
                  sfc_prj='R4Econ',
    ...
    ----------
    sfc_usr : string
        The individual account or organizational account name
    sfc_prj : string
        The git project name, if 'sfc_usr' is math4econ, and 'sfc_prj' is math4econ.github.io,
        Then the repo is driving the homepage for the organizational or user account, and
        for html urls, we only need math4econ.github.io,
        rather than math4econ.github.io/math4econ.github.io.
    sph_prj : string
        ...
        if sfc in ls_st_ignore:
            ...
            st_head_link, ls_desc_out, ls_code_out = \
                rmdparse.fs_rmd_yml_parse(
                    ...
                    sph_gitpages_root = 'https://' + sfc_usr + '.github.io/',
                    sph_github_root = 'https://github.com/' + sfc_usr + '/',
                    sph_pdf=sph_pdf,
                    sph_html=sph_html,
                    sph_r=sph_r,
...
if __name__ == '__main__':
    ...
    sfc_usr = 'Math4Econ'
    sfc_prj = 'Math4Econ.github.io'
    sph_prj = 'C:/Users/fan/repo_org/Math4Econ/Math4Econ.github.io/'
    spn_prj_bookdown_yml = '_bookdown.yml'
