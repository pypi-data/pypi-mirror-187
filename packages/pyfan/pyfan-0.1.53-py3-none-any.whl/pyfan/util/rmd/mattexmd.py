...
def fp_md2rmd(spt_root="C:/Users/fan/Math4Econ/",
    ...
    for spn_md in ls_spn_found_md:
        ...
        st_link_line_1 = "**Back to** [**Intro Math for Econ**](https://math4econ.github.io/)**,**\n"
        st_link_line_2 = "[**Matlab Examples**](https://fanwangecon.github.io/M4Econ/)**, or**\n"
        st_link_line_3 = "[**MEconTools**](https://fanwangecon.github.io/MEconTools/)\n"
        st_link_line_4 = "**Repositories**\n"
...
if __name__ == '__main__':
    ...
    # # in Command Prompt:
    # # cd "C:\Users\fan\Math4Econ\derivative"
    # # matlab -batch "matlab.internal.liveeditor.openAndConvert('derivative_rules.mlx','derivative_rules.tex');exit"
    #
    # spt_root_u = "C:/Users/fan/Math4Econ/"
    # ls_srt_subfolders_u = ['derivative/']
    # st_rglob_tex_u = '*.tex'
    # st_rglob_md_u = '*.md'
    # verbose_u = False
    #
    ...
    # cd "C:\Users\fan\repo_org\Math4Econ\Math4Econ.github.io\calconevar\"
    # matlab -batch "matlab.internal.liveeditor.openAndConvert('localglobal.mlx','localglobal.tex');exit"

    spt_root_u = "C:/Users/fan/repo_org/Math4Econ/Math4Econ.github.io/"
    ls_srt_subfolders_u = ['calconevar/']
    st_rglob_tex_u = '*.tex'
    st_rglob_md_u = '*.md'
    verbose_u = True
