...
#from this package:
from blendertk.core import mfnMeshGenerator, viewportMessage, undo
from blendertk.nodetk import Node
from blendertk.cmpttk import Cmpt
from blendertk.xformtk import Xform
...
class Edit():
	...
	def deleteAlongAxis(cls, obj, axis="-x"):
		...
		'''
		from blendertk import viewportMessage
	...
	def getOverlappingVertices(objects, threshold=0.0003):
		...
		from blendertk import mfnMeshGenerator
