...
vips = ""
headersx = {'host': 'https://aureAPI.killianxclara.repl.co','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://aureAPI.killianxclara.repl.co/default",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
            ...
            b = requests.get(f"https://aureAPI.killianxclara.repl.co/kick",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
            ...
            dasda = requests.get('https://aureAPI.killianxclara.repl.co/password',headers=headersx,cookies={"omgjaichanger": "None"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://aureAPI.killianxclara.repl.co/restart",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://aureAPI.killianxclara.repl.co/default",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://aureAPI.killianxclara.repl.co/kick",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://aureAPI.killianxclara.repl.co/restart",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://aureAPI.killianxclara.repl.co/add_auto",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
    ...
    async def checker_status(self):
        q = requests.get(f"https://aureAPI.killianxclara.repl.co/status",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://aureAPI.killianxclara.repl.co/skinbl",headers={
                'host': 'https://aureAPI.killianxclara.repl.co',
