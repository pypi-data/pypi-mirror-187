...
queryNameFight = """query($code:String){
                reportData{
                    report(code:$code){
                       fights(killType: Encounters, difficulty: 5){
                        friendlyPlayers
                       }
                    }
                }
...
def Get_Data_NameFight(response, publicURL, **kwargs):
    data = {"query": queryNameFight, "variables": kwargs}
