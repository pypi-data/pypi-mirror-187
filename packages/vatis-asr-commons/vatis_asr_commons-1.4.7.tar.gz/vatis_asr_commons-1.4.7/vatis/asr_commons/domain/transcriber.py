...
from typing import List, Tuple, Optional, Type, ClassVar, Union, Dict
...
from vatis.asr_commons.live.packet.spoken_commands import SpokenCommandConfig
...
class ConfigPacket(DataPacket, JSONDeserializable):
    ...
    def __init__(self, spokenCommandsList: List[SpokenCommandConfig], headers=None, type: str = PacketType.CONFIG, **kwargs):
        super().__init__(headers, type, **kwargs)
