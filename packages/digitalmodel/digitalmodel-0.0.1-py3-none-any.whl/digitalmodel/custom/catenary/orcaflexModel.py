    ...
    if cfg['default']['Analysis']['SLWR']:
        for LoadingIndex in range (0, len(cfg['EnvironmentLoad'][FEAType])):
            ...
            if cfg['default']['Analysis'][FEAType] == True:
                ...
                if FEAType == 'Extreme':
                    WriteOrcaflexModel([FEAmodel1, 'src/digitalmodel/tests/test_data/catenary_riser/VesselTypes_Extreme.yml', FEAmodel2], cfg)
                elif FEAType == 'Fatigue':
                    WriteOrcaflexModel([FEAmodel1, 'src/digitalmodel/tests/test_data/catenary_riser/VesselTypes_Fatigue.yml', FEAmodel2], cfg)
