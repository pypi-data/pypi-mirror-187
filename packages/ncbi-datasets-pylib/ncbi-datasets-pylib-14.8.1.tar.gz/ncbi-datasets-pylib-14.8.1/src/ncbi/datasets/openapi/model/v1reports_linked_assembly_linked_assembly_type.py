...
class V1reportsLinkedAssemblyLinkedAssemblyType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'PRINCIPAL_PSEUDOHAPLOTYPE': "principal_pseudohaplotype",
            'MATERNAL_HAPLOTYPE': "maternal_haplotype",
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "LINKED_ASSEMBLY_TYPE_UNKNOWN", must be one of ["LINKED_ASSEMBLY_TYPE_UNKNOWN", "alternate_pseudohaplotype", "haploid_principal_pseudohaplotype_of_diploid", "maternal_haplotype_of_diploid", "paternal_haplotype_of_diploid", "polyploid_member", "principal_pseudohaplotype", "maternal_haplotype", "paternal_haplotype", "haplotype_1", "haplotype_2", "haplotype_3", "haplotype_4", ]  # noqa: E501
