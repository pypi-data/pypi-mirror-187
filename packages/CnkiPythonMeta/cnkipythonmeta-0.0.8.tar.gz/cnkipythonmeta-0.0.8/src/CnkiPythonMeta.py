...
def get_year_paperNum_dict(result_list):
    ...
    return year_paperNum_dict, year_quations_dict, year_downloads_dict
...
def main():
    ...
    year_paperNum_dict, year_quations_dict, year_downloads_dict = get_year_paperNum_dict(result_list)
