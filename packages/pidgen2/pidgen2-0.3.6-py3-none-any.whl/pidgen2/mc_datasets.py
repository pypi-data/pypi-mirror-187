...
jpsimumu_run2sim09_datasets = {
  'MagDown_2018': [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc18_magdown.root" ], 
  'MagUp_2018':   [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc18_magup.root" ], 
  'MagDown_2017': [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc17_magdown.root" ], 
  'MagUp_2017':   [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc17_magup.root" ], 
  'MagDown_2016': [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc16_magdown.root" ], 
  'MagUp_2016':   [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc16_magup.root" ], 
  'MagDown_2015': [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc15_magdown.root" ], 
  'MagUp_2015':   [f"{run2sim09_dir}/tuple_jpsimumu_sim09_mc15_magup.root" ], 
}
