...
def main_impl():
    ...
    if args.config.get('polling_interval'):
        log_miner.POLLING_INTERVAL = int(args.config.get('polling_interval'))
    if args.discover:
    ...
    def get_config(integration: dict):
        try:
            config = {
                ...
                'scn_window_size': integration['scn_window_size'],
                'polling_interval': integration['polling_interval'],
                'filter_table': integration['filter_table'],
            }

            filter_schema = integration['filter_schemas']
