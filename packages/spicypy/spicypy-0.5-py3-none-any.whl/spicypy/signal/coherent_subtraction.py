...
Improvements to make:
 ...
 > Support for more than 1 dimension in <x> and <y> data, and more than 2
   dimensions for <ref> data - this was too hard for me to devise on the first
...
class CoherentSubtraction:  # pylint: disable=too-many-instance-attributes
    ...
    def check_inputs(self):
        """Check input arguments for coherent subtraction.
        Daniell-averaging-method-specific arguments are checked by `AveragingParameters` class.
        """
    ...
    def prepare_ffts(self):
        """Detrend time series and calculate FFTs.
        Then rearrange ffts for Daniell averaging methods using `daniell_rearrange_fft` function.
        """
