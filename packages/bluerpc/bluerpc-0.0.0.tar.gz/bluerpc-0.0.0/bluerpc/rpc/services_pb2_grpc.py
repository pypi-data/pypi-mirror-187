...
class BlueRPCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BLEScan = channel.unary_stream(
                '/rpc.BlueRPC/BLEScan',
...
class BlueRPCServicer(object):
    ...
    def BLEScan(self, request, context):
        ...
        start a scanner and stream the results
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_BlueRPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BLEScan': grpc.unary_stream_rpc_method_handler(
                    servicer.BLEScan,
...
class BlueRPC(object):
    ...
    def BLEScan(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/rpc.BlueRPC/BLEScan',
