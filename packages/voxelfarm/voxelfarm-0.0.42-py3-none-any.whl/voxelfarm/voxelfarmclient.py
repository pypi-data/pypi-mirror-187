...
class rest:
    ...
    def create_python_process_entity(self, project, name, code, fields=None, inputs=None, files=None, callback=None, update_type = None):
        result = self.creation_result()
    ...
    def create_program_process_entity(self, project, name, program, fields=None, inputs=None, callback=None, update_type = None):
        result = self.creation_result()
    ...
    def create_workflow_lambda(self, project, name, code, fields):
        result = self.creation_result()
        if fields == None:
            fields = {}
        fields['name'] = name
