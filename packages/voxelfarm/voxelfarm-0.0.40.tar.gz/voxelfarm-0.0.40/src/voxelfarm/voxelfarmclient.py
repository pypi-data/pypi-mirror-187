...
class rest:
    ...
    def create_python_process_entity(self, project, name, fields, inputs, crs, code, files, callback=None, update_type = None):
        result = self.creation_result()
    ...
    def create_program_process_entity(self, project, name, fields, inputs, crs, program, callback=None, update_type = None):
        result = self.creation_result()
