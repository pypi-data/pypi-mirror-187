...
class workflow_request:
    def __init__(self, framework):
        self.vf_api = voxelfarmclient.rest(framework.get_vf_api())
...
class workflow_lambda_host:
    ...
    def __init__(self, framework = None):  
        ...
        self.vf_api = voxelfarmclient.rest(self.lambda_framework.get_vf_api())
    ...
    def set_workflow_definition(self, workflow_definition):
        ...
        if product_definition:
            ...
            if request.update_type:
                ...
                product_definition['on_receive_data'](self.vf_api, request)
    ...
    def get_entity_file(self, vf : voxelfarmclient.rest, request : workflow_request, file_name:str, projectId:str, entityId:str):
    ...
    def publish_reports(self, vf : voxelfarmclient.rest, request : workflow_request, update_type : str, report_id:str, spatialId: str, objectId: str, propertyIds:tuple):
    ...
    def create_view(self, vf : voxelfarmclient.rest, request : workflow_request, name : str, view_type : str, view_lambda : str, inputs : dict, props:dict):
    ...
    def create_report(self, vf : voxelfarmclient.rest, request : workflow_request, update_type : str, name : str, report_lambda : str, region : str, lod : int, inputs : dict, fields : dict = None):
            script_dir = os.path.dirname(__file__)
    ...
    def create_lambda(self, vf : voxelfarmclient.rest, request : workflow_request, name : str, type : str, report_lambda : str):
            script_dir = os.path.dirname(__file__)
            lambda_file = open(os.path.join(script_dir, report_lambda))
            result = vf.create_lambda_python(
                project=request.project_id, 
    ...
    def create_export(self, vf : voxelfarmclient.rest, request : workflow_request, update_type : str, name : str, report_lambda : str, region : str, lod : int, inputs : dict):
            script_dir = os.path.dirname(__file__)
            lambda_file = open(os.path.join(script_dir, report_lambda))
            result = vf.create_lambda_python(
                project=request.project_id, 
    ...
    def get_meta_attributes(self, vf : voxelfarmclient.rest, request : workflow_request, projectId:str):
