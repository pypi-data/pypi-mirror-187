...
class request:
    ...
    def get_callback(self, update_type : str):
        return f'{self.product_id}/{update_type}'
    ...
    def set_workflow_definition(self, workflow_definition):
        ...
        if product_definition:
            ...
            if workflow_request.update_type:
                product_definition['on_stage_done'](self.vf_api, workflow_request, self)

                # Auto-activate version
                if not 'activated' in workflow_request.properties:
                ...
                product_definition['on_receive_data'](self.vf_api, workflow_request, self)
