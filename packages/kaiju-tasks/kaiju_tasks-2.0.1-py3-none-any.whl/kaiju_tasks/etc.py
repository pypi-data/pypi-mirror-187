...
__all__ = [
    'Permission', 'ErrorCodes', 'TaskStatus', 'TemplateKey', 'Task', 'RestartPolicy', 'Limit', 'Notification',
    'ExecutorTask', 'ExitCode'
]
...
class Task(TypedDict):
    ...
    job_id: Optional[UUID]  #: updated for each new run
