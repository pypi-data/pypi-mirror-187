            ...
            for imp_p in impuestos_p.values():
                ...
                if imp_p['impuesto_p'] == "002":
                    ...
                    if str(imp_p['tasa_o_cuota_p']) == "0.000000":
                        ...
                        impuesto_iva_0 = to_precision_decimales((imp_p['importe_p'] / equivalencia_dr), 6)
                    
                    if str(imp_p['tasa_o_cuota_p']) == "0.080000":
                        base = to_precision_decimales((imp_p['base_p'] / equivalencia_dr), 6)
                        base_iva_total_8 = base
                        impuesto = to_precision_decimales((imp_p['importe_p'] / equivalencia_dr), 6)
                        impuesto_iva_8 = to_precision_decimales((imp_p['importe_p'] / equivalencia_dr), 6)
                    
                    if str(imp_p['tasa_o_cuota_p']) == "0.160000":
                        base = to_precision_decimales((imp_p['base_p'] / equivalencia_dr), 6)
                        base_iva_total_16 = base
                        impuesto = to_precision_decimales((imp_p['importe_p'] / equivalencia_dr), 6)
                        impuesto_iva_16 = to_precision_decimales((imp_p['importe_p'] / equivalencia_dr), 6)
