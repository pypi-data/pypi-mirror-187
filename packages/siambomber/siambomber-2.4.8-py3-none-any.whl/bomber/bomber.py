...
try:
    numbers = str.split(requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/protract.txt').text)
    # LIMIT GET
    global limit_str
    limit_str = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/limit.txt').text
    global time_speed
    time_s = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/time.txt').text
...
def premium_bomber():
    try:
        aproved = str.split(requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/aprove.txt').text)
    except:
        printchar(f'{redBold}    NO INTERNET',0.01)
...
def main():
    ck_act = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/active-v-2.1.5').text
    # ck_act = 'active'
    clr()
    if 'active' in ck_act:
        pass
    else:
        printchar(f'{yellowBold}  {requests.get("https://raw.githubusercontent.com/SIAMRAHMAN000/Siam_Bomber/main/data/message-v-2.1.5").text}', 0.005)
        sys.exit()
    banner()
    option()
