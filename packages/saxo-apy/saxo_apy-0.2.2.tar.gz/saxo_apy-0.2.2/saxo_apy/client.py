...
class SaxoOpenAPIClient:
    ...
    def __init__(
        ...
        self._http_client: Client = Client(
            headers=make_default_session_headers(), base_url=self._app_config.api_base_url, timeout=REQUEST_TIMEOUT
        )
    ...
    def openapi_request(
        ...
        headers = {
            "x-request-id": f"saxo-apy/{self.client_session_id}/{request_id}",
